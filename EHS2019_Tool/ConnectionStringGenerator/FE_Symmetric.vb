...
Namespace FE_SymmetricNamespace
    ...
    Public Class EncryptionMethod
        Public Const OldMethod As String = "O" ' Key: SHA1, Data: DES
        Public Const NewMethod As String = "N" ' Key: SHA512, Data: AES256
    End Class
    ...
    Public Class FE_Symmetric
        ...
        Public Function EncryptData(ByVal strKey As String, ByVal strData As String, Optional ByVal strMethod As String = EncryptionMethod.NewMethod) As String
            ...
            '2. Generate the Keys
            If Not InitKey(strKey, strMethod) Then
            ...
            Try
                ...
                If strMethod = EncryptionMethod.NewMethod Then
                    ' AES256
        ...
        Public Function DecryptData(ByVal strKey As String, ByVal strData As String, Optional ByVal strMethod As String = EncryptionMethod.NewMethod) As String
        ...
        Private Function InitKey(ByVal strKey As String, ByVal strMethod As String) As Boolean
            ...
            Try
                ...
                If strMethod = EncryptionMethod.NewMethod Then
                    ...
                    Dim sha As SHA512CryptoServiceProvider = New SHA512CryptoServiceProvider
                    ...
                    ' use the low 256 bits for the key value
                    For i = 0 To 31
                        m_Key(i) = bpHash(i)
                    Next i
