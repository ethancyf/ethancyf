IF EXISTS (SELECT * FROM dbo.sysobjects WHERE id = OBJECT_ID(N'[dbo].[proc_PracticeSchemeInformation_get_bySPIDDisplySeq]') AND OBJECTPROPERTY(id, N'IsProcedure') = 1)
	DROP PROCEDURE [dbo].[proc_PracticeSchemeInformation_get_bySPIDDisplySeq]
GO
...
-- Modification History
-- Modified by:		Lawrence TSANG
-- Modified date:	29 May 2009
-- Description:		Removed the first P.Record_Status
-- =============================================
-- =============================================
-- Modification History
-- Modified by:		Kathy LEE
...
-- Modification History
-- Modified by:		Lawrence TSANG	
-- Modified date:	9 July 2009
-- Description:		Change the logic on getting Record_Status
-- =============================================
-- =============================================
-- Modification History
-- Modified by:		Lawrence TSANG	
-- Modified date:	3 August 2009
-- Description:		Change the logic on getting [Record_Status] (Again...)
-- =============================================
-- =============================================
-- Modification History
-- Modified by:		Kathy LEE
...
CREATE PROCEDURE [dbo].[proc_PracticeSchemeInformation_get_bySPIDDisplySeq]
	@sp_id			char(8),
...
GRANT EXECUTE ON [dbo].[proc_PracticeSchemeInformation_get_bySPIDDisplySeq] TO HCSP
GO

GRANT EXECUTE ON [dbo].[proc_PracticeSchemeInformation_get_bySPIDDisplySeq] TO HCVU
GO

GRANT EXECUTE ON [dbo].[proc_PracticeSchemeInformation_get_bySPIDDisplySeq] TO WSEXT
Go

GRANT EXECUTE ON [dbo].[proc_PracticeSchemeInformation_get_bySPIDDisplySeq] TO WSINT
GO