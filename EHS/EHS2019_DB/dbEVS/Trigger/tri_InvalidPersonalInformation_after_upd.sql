IF EXISTS (SELECT * FROM sysobjects WHERE type = 'TR' AND name = 'tri_InvalidPersonalInformation_after_upd')
	DROP TRIGGER [dbo].[tri_InvalidPersonalInformation_after_upd]
GO
...
-- Description:		Trigger an insert statement into InvalidPersonalInformationLOG when a row is inserted / updated into InvalidPersonalInformation
-- =============================================
-- =============================================
-- Modification History
...
CREATE TRIGGER [dbo].[tri_InvalidPersonalInformation_after_upd]
