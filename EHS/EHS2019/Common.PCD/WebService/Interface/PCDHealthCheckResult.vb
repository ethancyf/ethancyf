...
Namespace WebService.Interface
    ...
    <Serializable()> Public Class PCDHealthCheckResult

        Public Enum enumReturnCode

            ' Service is running Normally
            ServiceRunningNormally = 0

            ' Service is not availble
        ...
        Private _sysMsg As SystemMessage = Nothing
        ...
        Private Sub ReadXml(ByVal strPCDUploadEnrolInfoResultXml As String, ByVal strMessageID As String)
            ...
            Try
                ...
                Select Case dt.Rows(0)("return_code")
                    Case "0"
                        _enumReturnCode = enumReturnCode.ServiceRunningNormally
                    Case "1"
                        _enumReturnCode = enumReturnCode.ServiceIsNotAvailable
                    Case Else
        ...
        Public Function getReturnCodeDesc(ByVal enumN As enumReturnCode) As String
            ...
            ' TODO: Need to change CheckIsActiveSP_Return_Code to HealthCheck_Return_Code, after data preparation for HealthCheck_Return_Code is done
            Select Case enumN
                Case enumReturnCode.ServiceRunningNormally
                ...
                Case enumReturnCode.ServiceIsNotAvailable
                    ' assume service unavailable
