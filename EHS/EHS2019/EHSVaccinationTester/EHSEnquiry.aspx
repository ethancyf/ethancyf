<%@ Page Language="vb" AutoEventWireup="false" CodeBehind="EHSEnquiry.aspx.vb" Inherits="EHSVaccinationTester._Default"  ValidateRequest="false" %>

<!DOCTYPE html PUBLIC "-//W3C//DTD XHTML 1.0 Transitional//EN" "http://www.w3.org/TR/xhtml1/DTD/xhtml1-transitional.dtd">
<html xmlns="http://www.w3.org/1999/xhtml" >
<head runat="server">
    <title>EHSVaccinationTester Default</title>
</head>
<body>
                ...
                <tr>
                    ...
                    <td valign="top" >
                        <table width="100%">
                            <tr>
                                <td width="20%">
                                    <asp:Label ID="lblRequestSystem" runat="server" Text="RequestSystem:"></asp:Label>
                                </td>
                                <td>
                                    <asp:RadioButton ID="rbCMSRequest" checked="true" AutoPostBack="True" GroupName="rbgRequestSystem" runat="server" Text="CMS" Value="CMS"/>
                                    <asp:RadioButton ID="rbCIMSRequest" AutoPostBack="True" GroupName="rbgRequestSystem" runat="server" Text="CIMS"   Value="CIMS"/>
                                </td>
                            </tr>
                            <tr>
                                <td width="20%">
