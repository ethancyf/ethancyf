...
<script runat="server">
    Protected Sub Page_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Load
        ...
        lblDateTimeEng.Text = dtmNow.ToString("dd MMMM yyyy", New System.Globalization.CultureInfo("en-us")) + " &nbsp; 01:00 - 05:00"
...
<body>
    <table border="0" cellpadding="0" cellspacing="0" style="width: 990px">
        <tr>
            <td align="right" style="background-image: url(Common/Images/banner/banner_header.jpg);
                            ...
                            <table width="100%">
                                ...
                                <tr align="center">
                                    <td>
                                        ...
                                        <img src="Common/Images/others/bg.png" alt="" /><br />
                                        <br />
                                        <table style="width: 50%">
                                            <tr>
                                                <td class="tableText" style="text-align: left; font-size: large; color: #0000ff;">
                                                    Maintenance Period:</td>
                                                <td class="tableText" style="text-align: left; font-size: large; color: #0000ff;">
                                                    <asp:Label ID="lblDateTimeEng" runat="server"></asp:Label>
                                                </td>
                                            </tr>
                                            <tr>
                                                <td class="tableText" style="text-align: left; font-size: large; color: #0000ff;">
                                ...
                                <tr>
                                    <td align="center">
                                        <span style="font-size: 10pt; font-family: Arial">
                                            <br />
                                            <br />
                                            This page is optimised for viewing in 1024 x 768 resolution.</span>
                                    </td>
                                </tr>
                            </table>
                        </td>
