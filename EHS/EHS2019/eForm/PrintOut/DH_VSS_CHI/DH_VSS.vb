...
Namespace PrintOut.DH_VSS_CHI
    Public Class DH_VSS
        ...
        Public Sub New(ByVal udfSP As ServiceProviderModel)
            ...
            udtGeneralFunction.getSytemParameterByParameterName("VersionCodeApplicationFormAppendixAChi", strParmValue1, String.Empty)
            _strAppendixAVersionCode = strParmValue1.Trim

            udtGeneralFunction.getSytemParameterByParameterName("VersionCodeApplicationFormAppendixBChi", strParmValue1, String.Empty)
            ...
            'Footer
            Me.txtPrintDetail.Text = String.Format("¦C¦L©ó {0}", _udtFormatter.formatDateTime(DateTime.Now(), "zh-tw"))
        End Sub
        ...
        Private Sub detEHCVSP0004_Format(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles dtlHDVSS.Format
            ...
            Select Case Me.Fields.Item("FooterValue").Value
                Case _strAppendixAVersionCode
                    Dim subReportAppA As PrintOut.DH_VSS_CHI.DH_VSS002 = New PrintOut.DH_VSS_CHI.DH_VSS002(Me._udfSP)
                    ...
                    If strFooterValue.Contains(_strAppendixBVersionCode) Then
                        ...
                        For Each strKey As String In _practiceSameBankAccount.Keys
                            ...
                            If String.Format("{0}-{1}", _strAppendixBVersionCode, strKey) = strFooterValue Then
                                Dim subReportAppE As PrintOut.DH_VSS_CHI.DH_VSS006 = New PrintOut.DH_VSS_CHI.DH_VSS006(Me._practiceSameBankAccount(strKey), Me._udfSP)
