<%@ Control Language="vb" AutoEventWireup="false" Codebehind="ucReadOnlyReentryPermit.ascx.vb" Inherits="HCSP.UIControl.DocTypeText.ucReadOnlyReentryPermit" %>
<asp:Panel ID="panReadonlyVerticalReentryPermit" runat="server">
    ...
    <table id="tblREMPT" runat="server" cellpadding="0" cellspacing="0" class="textVersionTable">
        <tbody>
            <tr>
                <td valign="top">
            ...
            <tr>
                <td valign="top">
                    <asp:Label ID="lblReadonlyTravelDocNoText" runat="server" CssClass="tableTitle" ></asp:Label></td>
            </tr>
            <tr>
                <td valign="top">
