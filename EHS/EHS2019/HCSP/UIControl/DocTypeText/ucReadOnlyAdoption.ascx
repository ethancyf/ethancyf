<%@ Control Language="vb" AutoEventWireup="false" Codebehind="ucReadOnlyAdoption.ascx.vb" Inherits="HCSP.UIControl.DocTypeText.ucReadOnlyAdoption" %>
<asp:Panel ID="panReadonlyVerticalAdoption" runat="server">
    ...
    <table id="tblADOPC" runat="server" cellpadding="0" cellspacing="0" class="textVersionTable">
        <tbody>
            <tr>
                <td valign="top">
            ...
            <tr>
                <td valign="top">
                    <asp:Label ID="lblReadonlyEntryNoText" runat="server" CssClass="tableTitle" ></asp:Label></td>
            </tr>
            <tr>
                <td valign="top">
