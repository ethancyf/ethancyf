...
#Region "Overrides Mehtod"
    ...
    Public Overrides Sub SetupTableTitle(ByVal width As Integer)
        If width > 0 Then
            Me.lblCoPayment.Width = width
        Else
            Me.lblCoPayment.Width = 200
        End If
    End Sub
    'CRE13-018 Change Voucher Amount to 1 Dollar [End][Karl]
#End Region
...
#Region "Public Method"
    ...
    Public Function Validate(ByVal objMsgBox As CustomControls.MessageBox) As Boolean
        ...
        If Me.ddlCoPayment.SelectedValue = EHAPP_Copayment.VOUCHER Then
            objMsg = udtValidator.chkEHAPPHCVCopayment(Me.txtHCVInputAmount.Text, strMaxCopaymentFee, MyBase.ServiceDate, strParam)
...
#Region "Private Method"
    ...
    Private Sub BindCoPaymentDropDown()
        ...
        ddlCoPayment.Items.Insert(0, New ListItem(Me.GetGlobalResourceObject("Text", "EHSClaimPleaseSelect"), String.Empty))
    ...
    '        If Not udtEHSTransaction Is Nothing Then
    '            If Not udtEHSTransaction.TransactionAdditionFields Is Nothing Then
    '                If udtEHSTransaction.TransactionAdditionFields.Count = 1 Then
    '                    rdolCoPayment.SelectedValue = udtEHSTransaction.TransactionAdditionFields(0).AdditionalFieldValueCode
    '                End If
    '            End If
    '        End If
    '    End If

    '    rdolCoPayment.Enabled = Me.AvaliableForClaim
    'End Sub
