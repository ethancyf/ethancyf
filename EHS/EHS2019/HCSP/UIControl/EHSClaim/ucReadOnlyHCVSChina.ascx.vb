...
#Region "Must Override Function"
    ...
    Protected Overrides Sub RenderLanguage()
        ...
        If MyBase.Mode = ucReadOnlyEHSClaim.ReadOnlyEHSClaimMode.Complete Then
            ...
            'CRE13-019-02 Extend HCVS to China [Start][Winnie]
            'Me.lblClaimSummaryTitleRMB.Text = Me.GetGlobalResourceObject("Text", "Amount") & "(" & Me.GetGlobalResourceObject("Text", "RMBDollarSign") & ")"
        ...
        'CRE13-019-02 Extend HCVS to China [Start][Winnie]
        lblExchangeRateText.Text = Me.GetGlobalResourceObject("Text", "VoucherConversionRate")
        lblRedeemAmountText.Text = Me.GetGlobalResourceObject("Text", "RedeemAmount")
        'CRE13-019-02 Extend HCVS to China [End][Winnie]
    ...
    Protected Overrides Sub Setup()
        ...
        'CRE13-019-02 Extend HCVS to China [Start][Winnie]
        Dim udtExchangeRateBLL As New Common.Component.ExchangeRate.ExchangeRateBLL
        'CRE13-019-02 Extend HCVS to China [End][Winnie]
        ...
        If MyBase.EHSTransaction.ExchangeRate.HasValue Then
            decExchangeRate = MyBase.EHSTransaction.ExchangeRate.Value
        End If

        lblExchangeRate.Text = decExchangeRate.ToString("N3")
        'CRE13-019-02 Extend HCVS to China [End][Winnie]

        'CRE13-019-02 Extend HCVS to China [Start][Winnie]
        'If Not MyBase.EHSTransaction.TransactionAdditionFields.CoPaymentFee.HasValue Then
        If Not MyBase.EHSTransaction.TransactionAdditionFields.CoPaymentFeeRMB.HasValue Then
            'CRE13-019-02 Extend HCVS to China [End][Winnie]
        ...
        Else
            ...
            Me.lblCoPaymentFee.Text = String.Format("{0}",
                                                    udtFormatter.formatMoneyRMB(CStr(MyBase.EHSTransaction.TransactionAdditionFields.CoPaymentFeeRMB.Value), True))
        ...
        If String.IsNullOrEmpty(MyBase.EHSTransaction.TransactionAdditionFields.PaymentType) = False Then
            ...
            udtStaticDataModel = udtStaticDataBLL.GetStaticDataByColumnNameItemNo("HCVSCHN_PAYMENTTYPE", MyBase.EHSTransaction.TransactionAdditionFields.PaymentType)
            ...
            If Not udtStaticDataModel Is Nothing Then
                If MyBase.SessionHandler.Language = Common.Component.CultureLanguage.TradChinese Then
                    Me.lblPaymentType.Text = udtStaticDataModel.DataValueChi

                ElseIf MyBase.SessionHandler.Language = Common.Component.CultureLanguage.SimpChinese Then
                    Me.lblPaymentType.Text = udtStaticDataModel.DataValueCN
                Else
                    Me.lblPaymentType.Text = udtStaticDataModel.DataValue
                End If
            End If
        ...
        Else
            ...
            If MyBase.EHSTransaction.TransactionAdditionFields.ReasonForVisitL1(0) IsNot Nothing Then
                ...
                tdPrincipalTitle.Style.Item("Width") = "193px"
            ...
            If iReasonForVisitCount > 1 Then
                ...
                tdSecondaryTitle.Style.Item("Width") = "193px"
        ...
        If MyBase.Mode = ucReadOnlyEHSClaim.ReadOnlyEHSClaimMode.Complete Then
            ...
            'Me.lblTotalAmount.Text = String.Format("(${0})", MylblVoucherAvailTextBase.EHSTransaction.TransactionDetails(0).TotalAmount.ToString())
            ...
            'CRE13-019-02 Extend HCVS to China [Start][Winnie]
            'Not show RMB in grid
            'Me.lblVoucherAvailRMB.Text = String.Format("{0}",
            '                                        udtFormatter.formatMoneyRMB(CStr(udtExchangeRateBLL.CalculateHKDtoRMB(CInt(MyBase.EHSTransaction.VoucherBeforeRedeem * dblSubsidizeFee), decExchangeRate)), False))

            'Me.lblVoucherRemainRMB.Text = String.Format("{0}",
            '                                         udtFormatter.formatMoneyRMB(CStr(udtExchangeRateBLL.CalculateHKDtoRMB(CInt(MyBase.EHSTransaction.VoucherAfterRedeem * dblSubsidizeFee), decExchangeRate)), False))


            'Me.lblVoucherRedeemRMB.Text = String.Format("{0}",
            '                                         udtFormatter.formatMoneyRMB(CStr(MyBase.EHSTransaction.VoucherClaimRMB * dblSubsidizeFee), False))
            'CRE13-019-02 Extend HCVS to China [End][Winnie]

            Me.lblVoucherAvailHKD.Text = String.Format("{0}",
                                                 udtFormatter.formatMoney(CStr(CInt(MyBase.EHSTransaction.VoucherBeforeRedeem * dblSubsidizeFee)), False))

            Me.lblVoucherRemainHKD.Text = String.Format("{0}",
                                                     udtFormatter.formatMoney(CStr(CInt(MyBase.EHSTransaction.VoucherAfterRedeem * dblSubsidizeFee)), False))

            Me.lblVoucherRedeemHKD.Text = String.Format("{0}",
                                                     udtFormatter.formatMoney(CStr(CInt(MyBase.EHSTransaction.VoucherClaim * dblSubsidizeFee)), False))

            Me.imgExclaimLowProfile.ToolTip = String.Format("{0}{1}", Me.GetGlobalResourceObject("Text", "BeforeRedeemAmount"),
                                                    udtFormatter.formatMoneyRMB(CStr(udtExchangeRateBLL.CalculateHKDtoRMB(CInt(MyBase.EHSTransaction.VoucherBeforeRedeem * dblSubsidizeFee), decExchangeRate)), False))

            'CRE13-019-02 Extend HCVS to China [End][Karl]

            lblRedeemAmount.Text = udtFormatter.formatMoneyRMB(CStr(MyBase.EHSTransaction.VoucherClaimRMB * dblSubsidizeFee), True)
            'CRE13-019-02 Extend HCVS to China [End][Winnie]
        ...
        Else
            ...
            'CRE13-019-02 Extend HCVS to China [Start][Karl]
            'CRE13-019-02 Extend HCVS to China [Start][Winnie]
            lblRedeemAmount.Text = String.Format("{0} ({1})",
                                                 udtFormatter.formatMoneyRMB(CStr(MyBase.EHSTransaction.VoucherClaimRMB * dblSubsidizeFee), True),
                                                 udtFormatter.formatMoneyHKDInChina(CStr(CInt(MyBase.EHSTransaction.VoucherClaim * dblSubsidizeFee)), True))
            'CRE13-019-02 Extend HCVS to China [End][Winnie]
            'CRE13-019-02 Extend HCVS to China [End][Karl]
    ...
    Private Function BuildReasonForVisitTable(ByVal index As Integer, ByVal blnFirst As Boolean) As Table
        ...
        'dtResL2 = udtReasonForVisitBLL.getReasonForVisitL2(MyBase.EHSTransaction.ServiceType, intVisitL1, intVisitL2)
        'CRE13-019-02 Extend HCVS to China [End][Karl]
        If dtResL1.Rows.Count > 0 Then 'CRE13-019-02 Extend HCVS to China [Start][Karl] 'And dtResL2.Rows.Count > 0 Then 'CRE13-019-02 Extend HCVS to China [End][Karl]
            tbl = New Table
            tbl.CellPadding = 0
            tbl.CellSpacing = 0
    ...
    Public Overrides Sub SetupTableTitle(ByVal width As Integer)
        If width > 0 Then
            ...
            'CRE13-019-02 Extend HCVS to China [Start][Winnie]
            lblExchangeRateText.Width = width
            lblPaymentTypeTitle.Width = width
            'CRE13-019-02 Extend HCVS to China [End][Winnie]
        Else
            ...
            lblPaymentTypeTitle.Width = 200
            ' CRE13-018 - Change Voucher Amount to 1 Dollar [End][Tommy L]

            'CRE13-019-02 Extend HCVS to China [Start][Winnie]
            lblExchangeRateText.Width = 200
            'CRE13-019-02 Extend HCVS to China [End][Winnie]
        End If
    End Sub
