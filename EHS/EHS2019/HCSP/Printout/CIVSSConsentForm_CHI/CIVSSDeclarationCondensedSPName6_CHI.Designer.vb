Namespace PrintOut.CIVSSConsentForm_CHI
    ...
    Partial Public Class CIVSSDeclarationCondensedSPName6_CHI
        ...
        Private Sub InitializeComponent()
            Dim resources As System.Resources.ResourceManager = New System.Resources.ResourceManager(GetType(CIVSSDeclarationCondensedSPName6_CHI))
            ...
            Me.txtDocumentExplainedBy.Width = 1.22!
            '
            'TextBox3
            '
            ...
            Me.TextBox3.Text = "告知並解釋疫苗資助計劃之「同意轉交個人資料」內所載的承諾及聲明。"
            Me.TextBox3.Top = 0.0!
            Me.TextBox3.Width = 5.375!
            '
            'TextBox5
            '
            ...
            Me.TextBox5.Text = "本人明白和同意該等承諾及聲明的內容。"
            Me.TextBox5.Top = 0.21875!
            Me.TextBox5.Width = 7.375!
            '
            'CIVSSDeclarationCondensedSPName6_CHI
            '
