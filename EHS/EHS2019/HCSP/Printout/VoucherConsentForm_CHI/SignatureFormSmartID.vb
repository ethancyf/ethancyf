    ...
    Public Class SignatureFormSmartID
        ...
        Private Sub FillData()
            ...
            If Not Me.udtSP.ChineseName Is Nothing AndAlso Not Me.udtSP.ChineseName.Equals(String.Empty) Then
                ...
                Me.SubReport3.Report = New PrintOut.VoucherConsentForm_CHI.ClaimConsent3SPName_CHI(Me.udtSP.ChineseName)
            Else
                If Me.udtSP.EnglishName.Length <= 20 Then
                    ...
                    Me.SubReport3.Report = New PrintOut.VoucherConsentForm_CHI.ClaimConsent3SPName20(Me.udtSP.EnglishName)
                ElseIf Me.udtSP.EnglishName.Length <= 30 Then
                    ...
                    Me.SubReport3.Report = New PrintOut.VoucherConsentForm_CHI.ClaimConsent3SPName30(Me.udtSP.EnglishName)
                ElseIf Me.udtSP.EnglishName.Length <= 40 Then
                    ...
                    Me.SubReport3.Report = New PrintOut.VoucherConsentForm_CHI.ClaimConsent3SPName40(Me.udtSP.EnglishName)
                End If
            End If
