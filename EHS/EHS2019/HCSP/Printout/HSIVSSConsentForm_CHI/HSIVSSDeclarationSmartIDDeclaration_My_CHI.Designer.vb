Namespace PrintOut.HSIVSSConsentForm_CHI
    ...
    Partial Public Class HSIVSSDeclarationSmartIDDeclaration_My_CHI
        ...
        Private Sub InitializeComponent()
            Dim resources As System.Resources.ResourceManager = New System.Resources.ResourceManager(GetType(HSIVSSDeclarationSmartIDDeclaration_My_CHI))
            ...
            Me.TextBox1.Style = "ddo-char-set: 0; text-align: left; font-size: 10.5pt; font-family: HA_MingLiu; wh" & _
                "ite-space: inherit; "
            Me.TextBox1.Text = "本人同意授權醫生讀取儲存在本人智能身份證晶片內的個人資料（只限香港身份證號碼，中英文姓名，出生日期和香港身份證簽發日期），以供政府於「收集個人資料目的」所述的用途" & _
                "。"
            Me.TextBox1.Top = 0.0!
            Me.TextBox1.Width = 7.375!
            '
            'HSIVSSDeclarationSmartIDDeclaration_My_CHI
            '
