Namespace PrintOut.HSIVSSConsentForm_CHI
    ...
    Partial Public Class HSIVSSEligibilityStatement_CHI
        ...
        Private Sub InitializeComponent()
            Dim resources As System.Resources.ResourceManager = New System.Resources.ResourceManager(GetType(HSIVSSEligibilityStatement_CHI))
            ...
            Me.txtDeclarationTitle.Text = "資格聲明"
            ...
            Me.txtDeclaration.Left = 0.25!
            Me.txtDeclaration.MultiLine = False
            Me.txtDeclaration.Name = "txtDeclaration"
            Me.txtDeclaration.Style = "ddo-char-set: 1; text-align: justify; font-style: normal; font-size: 10.5pt; font" & _
                "-family: HA_MingLiu; white-space: nowrap; "
            Me.txtDeclaration.Text = "本人確認本人/本人的子女為香港居民及："
            Me.txtDeclaration.Top = 0.21875!
            Me.txtDeclaration.Width = 7.125!
            '
            'srEligibilityRole
            '
            ...
            Me.srEligibilityRole.Height = 0.15625!
            ...
            Me.srEligibilityRole.Top = 0.40625!
            ...
            Me.chkRole.CheckAlignment = System.Drawing.ContentAlignment.BottomRight
            Me.chkRole.Checked = True
            Me.chkRole.Height = 0.15625!
            Me.chkRole.Left = 0.5!
            Me.chkRole.Name = "chkRole"
            Me.chkRole.Style = "font-size: 10.5pt; font-family: HA_MingLiu; "
            Me.chkRole.Text = ""
            Me.chkRole.Top = 0.44!
            ...
            Me.txtDeclaration1.Height = 0.15625!
            Me.txtDeclaration1.Left = 0.0!
            Me.txtDeclaration1.Name = "txtDeclaration1"
            Me.txtDeclaration1.Style = "ddo-char-set: 0; text-align: left; font-size: 10.5pt; font-family: HA_MingLiu; "
            Me.txtDeclaration1.Text = "1."
            Me.txtDeclaration1.Top = 0.21875!
            Me.txtDeclaration1.Width = 0.21875!
            '
            'HSIVSSEligibilityStatement_CHI
            '
