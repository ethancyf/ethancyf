...
Namespace PrintOut.HSIVSSConsentForm_CHI
    Public Class HSIVSSDeclarationDoseInfo_CHI
        ...
        Private Sub LoadReport()
            ...
            Dim strPrefix As String = HttpContext.GetGlobalResourceObject("PrintoutText", "HSIVSS_DoseHeaderPrefix", New System.Globalization.CultureInfo(CultureLanguage.TradChinese))
            Dim strDescription As String
            If Not String.IsNullOrEmpty(strPrefix) Then
                strDescription = String.Format("{0}¦¹¤D¡G", strPrefix)
            Else
                strDescription = "¦¹¤D¡G"
            End If
        ...
        Private Function GetDoseDescription(ByVal udtEHSTransaction As EHSTransactionModel, ByVal udtSchemeClaim As SchemeClaimModel) As String
            ...
            For Each udtSubsidizeGroupClaim As SubsidizeGroupClaimModel In udtServiceSchemeClaimModel.SubsidizeGroupClaimList
                ...
                If udtTransactionDetail.Count > 0 Then
                    ...
                    Return udtPrintoutHelper.GetDoseDescription(udtSubsidizeGroupClaim.SchemeCode, udtSubsidizeGroupClaim.SchemeSeq, udtSubsidizeGroupClaim.SubsidizeItemCode, strVaccineCode, CultureLanguage.TradChinese)
                End If
            Next
