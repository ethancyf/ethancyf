...
Namespace PrintOut.HSIVSSConsentForm
    Public Class HSIVSSConsentCondensedFormAdult
        ...
        Private Sub LoadReport()
            ...
            ' Declaration
            srDeclaration.Report = New HSIVSSDeclarationCondensed(True, _udtSP, _udtEHSAccount, _udtEHSTransaction, _udtSchemeClaim)

            ' Document Explained By
            If Not _udtSmartIDContent Is Nothing AndAlso _udtSmartIDContent.IsReadSmartID Then
                srDeclarationExplainedBy.Report = New HSIVSSDeclarationCondensedDeclarationSmartID(True)
