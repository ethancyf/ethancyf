<%@ Page Language="vb" AutoEventWireup="false" Codebehind="sessiontimeout.aspx.vb"
    Inherits="VoucherBalanceEnquiry.Text.EN.sessiontimeout" %>
    ...
    <form id="form1" runat="server">
        <div>
            <table id="tblBanner" border="0" cellpadding="0" cellspacing="0" runat="server" style="width: 240px">
                ...
                <tr>
                    <td>
                        <span style="font-size: 12pt;">System timeout.
                            <br />
                            Please click <a href="../main.aspx">here</a> to back to login again.</span></td>
                </tr>
            </table>
        </div>
        <br />
