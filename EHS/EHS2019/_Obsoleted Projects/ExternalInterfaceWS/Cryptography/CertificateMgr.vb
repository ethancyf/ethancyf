...
Namespace Cryptography
    Public Class CertificateMgr
        ...
        Public Shared Function VerifyCert(ByVal objCertificate As X509Certificate2) As Boolean
            ...
            'Dim strCertChkTimeValidaity As String = AppConfigMgr.getCertChkTimeValidaity()
            'Dim strCertChkTrustChain As String = AppConfigMgr.getCertChkTrustChain()
            'Dim strCertChkCRL As String = AppConfigMgr.getCertChkCRL()

            'If strCertChkTimeValidaity.Trim().ToUpper() = "N" AndAlso strCertChkTrustChain.Trim().ToUpper() = "N" AndAlso strCertChkCRL.Trim().ToUpper() = "N" Then
            ...
            'If strCertChkTimeValidaity = "Y" Then
            'Else
            ...
            '    If strCertChkTrustChain.Trim().ToUpper() = "N" AndAlso (strChainStatus = "PARTIALCHAIN" OrElse strChainStatus = "UNTRUSTEDROOT") Then
