...
Namespace BLL
    ...
    Public Class VoucherAccountMaintenanceBLL
        ...
        Dim udtVRSchemeBLL As VoucherSchemeBLL = New VoucherSchemeBLL
        ...
        'Outdated Function. If use, please update it.
        'CRE13-019-02 Extend HCVS to China [Start][Chris YIM]
        '-----------------------------------------------------------------------------------------
        'Public Function loadRectifyList(ByVal strSPID As String, _
        '                        ByVal strDataEntry As String, ByVal strStatus As String) As DataTable
        '    Dim dt As DataTable
    ...
    ByVal strEnameSurname2 As String, ByVal strEnameFirstname2 As String) As Common.ComObject.SystemMessage
        ...
        'CRE13-019-02 Extend HCVS to China [Start][Chris YIM]
        '-----------------------------------------------------------------------------------------
        'Public Function getLevel1InboxCount(ByVal strSPID As String) As Integer
        '    Dim udtdb As Database = New Database
        ...
        '            udtdb.MakeInParam("@Scheme", SqlDbType.Char, 10, "EHCVS") _
        '        }
        ...
        'CRE13-019-02 Extend HCVS to China [Start][Chris YIM]
        '-----------------------------------------------------------------------------------------
        'Public Function getLevel2TaskListCount(ByVal strSPID As String) As Integer
        '    Dim udtdb As Database = New Database
        '    Dim intCount As Integer = 0
        '    Dim dt As New DataTable
        ...
        'CRE13-019-02 Extend HCVS to China [Start][Chris YIM]
        '-----------------------------------------------------------------------------------------
        'Public Function getLevel4PopupVoucherAccount(ByVal strSPID As String) As DataTable
        '    Dim udtdb As Database = New Database
        '    Dim dt As New DataTable
