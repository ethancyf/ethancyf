<%@ Control Language="vb" AutoEventWireup="false" Codebehind="ucReadOnlyReentryPermit.ascx.vb"
    Inherits="PrefillConsent.ucReadOnlyReentryPermit" %>
<asp:Panel ID="panReadonlyVerticalReentryPermit" runat="server">
    ...
    <table id="tblREMPT" runat="server" cellpadding="0" cellspacing="0">
        <tbody>
            <tr>
                <td valign="top">
            ...
            <tr>
                <td valign="top">
                    <asp:Label ID="lblReadonlyTravelDocNoText" runat="server" CssClass="tableTitle" Height="25px"
                        Width="150px"></asp:Label></td>
                <td valign="top">
            ...
            <tr>
                <td valign="top">
                    <asp:Label ID="lblReadonlyIssueDateText" runat="server" CssClass="tableTitle" Height="25px"
                        Width="150px"></asp:Label></td>
                <td valign="top">
...
<asp:Panel ID="panReadonlyHorizontalReentryPermit" runat="server">
