...
Partial Public Class EHSPrefilledClaimForm_CHI_RV
    ...
    Overrides Function GetReport() As GrapeCity.ActiveReports.SectionReport
        ...
        udtAuditLogEntry.WriteLog(LogID.LOG00023, "Print Consent Form Chinese")
        ...
        If Not String.IsNullOrEmpty(strPrefilledNumber) AndAlso _
           Not udtEHSAccount Is Nothing Then
            objReport = New CIVSSConsentForm_CHI.CIVSSConsentFormPrefilled_CHI(strPrefilledNumber, udtEHSAccount)
        End If
