Namespace PrintOut.VoucherConsentForm
    ...
    Partial Public Class ClaimConsentDecaraDeclaration2FullVersionSPName30
        ...
        Private Sub InitializeComponent()
            ...
            Me.txtConsent1c.Text = "including Hong Kong Identity Card No., name (in English and Chinese), gender, dat" & _
                "e of birth and date of issue of Hong Kong Identity Card"
            ...
            Me.txtConsent1SPName.Width = 4.4375!
            '
            'txtConsent1b
            '
