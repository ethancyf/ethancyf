<%@ Control Language="vb" AutoEventWireup="false" Codebehind="ucInputToken.ascx.vb"
    Inherits="HCVU.ucInputToken" %>
...
<table border="0" cellpadding="0" cellspacing="0" style="width: 500px">
                    ...
                    <tr>
                        ...
                        <td style="font-weight: bold; font-size: 14px; background-image: url(../Images/dialog/top-mid.png);
                            color: #ffffff; background-repeat: repeat-x; height: 35px">
                                <asp:Label ID="lblHeader" runat="server" Text="<%$ Resources: Text, ConfirmUnmaskIdentityDocumentNo %>"></asp:Label></td>
    ...
    <tr>
        ...
        <td>
            <asp:Panel ID="panContent" DefaultButton="ibtnTConfirm" runat="server" BackColor="white">
                            ...
                            <cc2:MessageBox ID="udcTMessageBox" runat="server" />
                                <table style="width: 100%" border="0">
                                    ...
                                    <tr style="vertical-align: top">
                                        ...
                                        <td>
                                            <asp:Image ID="imgTPasscodeHelp" runat="server" ImageUrl="<%$ Resources: ImageUrl, TokenPasscodeHelp %>"
                                                AlternateText="<%$ Resources: AlternateText, TokenPasscodeHelp %>" />
                                        </td>
                                    </tr>
                                    ...
                                    <tr>
                                        <td style="text-align: center" colspan="2">
                                            <asp:ImageButton ID="ibtnTConfirm" runat="server" ImageUrl="<%$ Resources: ImageUrl, ConfirmBtn %>"
                                                AlternateText="<%$ Resources: AlternateText, ConfirmBtn %>" OnClick="ibtnTConfirm_Click" />
                                            <asp:ImageButton ID="ibtnTCancel" runat="server" ImageUrl="<%$ Resources: ImageUrl, CancelBtn %>"
                                                AlternateText="<%$ Resources: AlternateText, CancelBtn %>" OnClick="ibtnTCancel_Click" />
                                        </td>
                                    </tr>
                                </table>
                        </td>
