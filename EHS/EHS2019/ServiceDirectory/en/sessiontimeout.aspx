<%@ Page Language="vb" AutoEventWireup="false" CodeBehind="sessiontimeout.aspx.vb" Inherits="ServiceDirectory.sessiontimeout1" %>
...
<body>
    <form id="form1" runat="server">
        ...
        <br />
        <span style="font-size: 16pt;">&nbsp;System timeout. Please click <a href="../main.aspx?lang=EN">here</a> to restart the search.</span>
    </form>
</body>
</html>
