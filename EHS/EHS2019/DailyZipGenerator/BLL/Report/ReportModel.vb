Namespace Report
    <Serializable()> Public Class ReportModel
        ...
        Private _intStartRowExt() As Integer
        ...
        Public Property StartRowNoExt() As Integer()
            Get
                Return _intStartRowExt
            End Get
            Set(ByVal value As Integer())
                _intStartRowExt = value
            End Set
        End Property
        ...
        ' CRE11-029 Add CMS health check log [Start][Tommy]
        Public Sub New(ByVal strReportID As String, ByVal strReportName As String, ByVal strReportDesc As String, ByVal strExecSP As String, ByVal strTemplateName As String, ByVal strReportFileExt As String, ByVal intStartRow() As Integer, ByVal intStartRowExt() As Integer, ByVal strFileNameFormat As String, ByVal intMinusDateForFileName As Integer, ByVal blnAuto As Boolean, ByVal strDBFlag As String)
            'Public Sub New(ByVal strReportID As String, ByVal strReportName As String, ByVal strReportDesc As String, ByVal strExecSP As String, ByVal strTemplateName As String, ByVal intStartRow() As Integer, ByVal intStartRowExt() As Integer, ByVal strFileNameFormat As String, ByVal intMinusDateForFileName As Integer, ByVal blnAuto As Boolean, ByVal strDBFlag As String)
            ...
            _intStartRowExt = intStartRowExt
        ...
        Public Sub New(ByVal udtReportModel As ReportModel)
            ...
            _intStartRowExt = udtReportModel.StartRowNoExt
