...
Public Class AuditLogBase
    ...
    Public Sub WriteSystemLog(ex As Exception, strFunctionCode As String, strUserID As String)
        Dim objDatabase As New Common.DataAccess.Database(Common.Component.DBFlagStr.DBFlagInterfaceLog)
        ...
        ErrorHandler.AddSystemInterfaceLog(objDatabase, MyBase.FunctionCode, strSeverityCode, "99999", String.Empty, _
