Namespace PrintOut.VoucherConsentForm
    ...
    Partial Public Class ClaimConsentDecaraDeclaration1FullVersionSPNameNA_v2
        ...
        Private Sub InitializeComponent()
            Dim resources As System.ComponentModel.ComponentResourceManager = New System.ComponentModel.ComponentResourceManager(GetType(ClaimConsentDecaraDeclaration1FullVersionSPNameNA_v2))
            ...
            Me.txtConsent1a.Text = "I hereby give consent to (Name of the Enrolled Health Care Provider)"
            Me.txtConsent1a.Top = 0.03125!
            Me.txtConsent1a.Width = 4.84375!
            '
            'txtConsent1c
            '
            ...
            Me.txtConsent1SPName.Left = 4.875!
            ...
            Me.txtConsent1SPName.Width = 2.28125!
            '
