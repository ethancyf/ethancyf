        ...
        Private Sub LoadReport(ByVal udtCFInfo As ConsentFormInformationModel)
            ...
            If udtCFInfo.SPName <> String.Empty Then
                ...
                If udtCFInfo.ReadSmartID = ConsentFormInformationModel.ReadSmartIDClass.Yes Then
                    Me.SubReport3.Report = New ClaimConsent3SPName30(udtCFInfo.SPName)
                ElseIf udtCFInfo.ReadSmartID = ConsentFormInformationModel.ReadSmartIDClass.Unknown Then
                    Me.SubReport3.Report = New ClaimConsent3SPName30UnknownSmartID(udtCFInfo.SPName)
                End If
            ...
            Else
                ...
                If udtCFInfo.ReadSmartID = ConsentFormInformationModel.ReadSmartIDClass.Yes Then
                    Me.SubReport3.Report = New ClaimConsent3SPNameNA
                ElseIf udtCFInfo.ReadSmartID = ConsentFormInformationModel.ReadSmartIDClass.Unknown Then
                    Me.SubReport3.Report = New ClaimConsent3SPNameNAUnknownSmartID
                End If
