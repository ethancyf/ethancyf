Public Class PPIEPRLogger
    ...
    Public Shared Sub Log(ByVal strAction As String, ByVal strStatus As String, ByVal strReturn As String, ByVal strDesc As String)
        ...
        Common.ComObject.ScheduleJobLogEntry.WriteLog(DateTime.Now, PPIEPRUtil.GetIPAddress(), Common.Component.ScheduleJobID.GetPPIEPRToken, strAction, strStatus, strReturn, strDesc)

    End Sub

    Public Shared Sub ErrorLog(ByVal ex As Exception)
        Dim strClientIP As String = PPIEPRUtil.GetIPAddress()
    ...
    Protected Shared Sub AddErrorSystemHCVULog(ByVal strSeverityCode As String, ByVal strClientIP As String, ByVal strUserDefinedMessage As String)
        ...
        params(0) = udtDB.MakeInParam("@function_code", SqlDbType.VarChar, 6, Common.Component.ScheduleJobFunctionCode.GetPPIEPRToken)
