Public Class ProgramLogger
    ...
    Public Shared Sub Log(ByVal strAction As String, ByVal strStatus As String, ByVal strReturn As String, ByVal strDesc As String)
        ...
        Common.ComObject.ScheduleJobLogEntry.WriteLog(DateTime.Now, ProgramUtil.GetIPAddress(), Common.Component.ScheduleJobID.TSWPatientList, strAction, strStatus, strReturn, strDesc)
    ...
    Protected Shared Sub AddErrorSystemHCVULog(ByVal strSeverityCode As String, ByVal strClientIP As String, ByVal strUserDefinedMessage As String)
        ...
        params(0) = udtDB.MakeInParam("@function_code", SqlDbType.VarChar, 6, Common.Component.ScheduleJobFunctionCode.GetTSWPatientList)
