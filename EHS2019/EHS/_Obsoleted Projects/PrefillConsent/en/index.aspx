<%@ Page Language="vb" AutoEventWireup="false" CodeBehind="index.aspx.vb" Inherits="PrefillConsent.en.index" %>
                                    ...
                                    <tr>
                                        <td align="center">
                                            <table width="75%">
                                                ...
                                                <tr>
                                                    <td colspan="2" align="center"><a href="javascript:void(0)" onclick="openNewHTML('../main.aspx?lang=EN')">
                                                        <img src="../Images/others/onlineprefillconsentform.png" alt="" border="0" /></a>
                                                    </td>
                                                </tr>
                                                <tr>
                                                    <td align="center"><a href="javascript:void(0)" onclick="openNewWin('../../en/FAQs.asp?view=Public')">
                                                        <img src="../Images/others/button_FAQs.png" alt="" border="0" /></a></td>
                                                    <td align="center"><a href="javascript:void(0)" onclick="openNewWin('../../en/ContactUs_VO.htm')">
