<%@ Page Language="vb" AutoEventWireup="false" CodeBehind="invalidlink.aspx.vb" Inherits="eForm.invalidlink" %>
...
<body onload=setTimeout("location.href='../en/index.aspx'",15000)>
    ...
    <br />
    <span style="font-size: 16pt;">Page not found. <br /> Please wait 15 seconds to return to <a href="../en/index.aspx">main page</a>.</span>
    </form>
</body>
</html>