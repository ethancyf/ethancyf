...
Namespace Component.EHSTransaction
    <Serializable()> Public Class TransactionDetailVaccineModel
        ...
        ' ---------------------------------------------------------------------------------------------------------
        Private _strRecipientType As String = String.Empty
...
#Region "Property"
        ...
        Public Property RecipientType() As String
            Get
                Return _strRecipientType
            End Get
            Set(ByVal value As String)
                _strRecipientType = value
            End Set
        End Property
        ' CRE20-0023 (Immu record) [End][Chris YIM]
...
#Region "Constructor"
        ...
        Public Sub New(ByVal udtTransactionDetailVaccine As TransactionDetailVaccineModel)
            ...
            Me.RecipientType = udtTransactionDetailVaccine.RecipientType
