...
Namespace Generator
    ...
    Public Class PostPaymentCheckReportGenerator
        Inherits PostPaymentCheckReportGeneratorBase
        ...
        Sub New(ByVal udtQueue As Common.Component.FileGeneration.FileGenerationQueueModel, ByVal udtFileGenerationModel As Common.Component.FileGeneration.FileGenerationModel, Optional ByVal blnReturnParm As Boolean = False)
        ...
        Public Overrides Function GetDataSet() As System.Data.DataSet
            ...
            If Me.ReturnParm AndAlso Not dsData Is Nothing AndAlso dsData.Tables.Count > 0 Then
                ...
                If dsData.Tables(0).Rows.Count > 0 Then
                    ...
                    For Each dcColumn As DataColumn In dsData.Tables(0).Columns
                        ...
                        ElseIf dcColumn.ColumnName = "HaveResult" Then
                            ...
                            Continue For
                        ElseIf dcColumn.ColumnName = "ExceedLimit" Then
                            SearchResultExceedLimit = IIf(dr(dcColumn).ToString() = "Y", True, False)
                            Continue For
                        Else
                ...
                If dsData.Tables(0).Columns.Contains("Sheet") Then
                    Me.dtWorksheetAction = dsData.Tables(0)
                End If
