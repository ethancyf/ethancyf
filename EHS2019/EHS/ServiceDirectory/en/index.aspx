<%@ Page Language="vb" AutoEventWireup="false" CodeBehind="index.aspx.vb" Inherits="ServiceDirectory.index1" %>
...
<head>
    ...
    <script language="javascript" type="text/javascript">
        window.location.replace("<%=ConfigurationManager.AppSettings("RedirectLinkEng")%>");
    </script>
                                ...
                                <%--                        <table style="border-right: #0000ff 1px solid; border-top: #0000ff 1px solid; border-left: #0000ff 1px solid;
                                            ...
                                            <tr>
                                                <td class="tableText" style="font-size: large; color: #0000ff;">
                                                    ...
                                                    There will be a scheduled maintenance on October 12, 2008(Sunday) from 1a.m. to 5
                                                    a.m..<br />
                                    ...
                                    <tr align="center">
                                        <td>
                                            <table width="75%">
                                                ...
                                                <tr>
                                                    <td colspan="2" align="center"><a href="javascript:void(0)" onclick="openNewWin('../main.aspx?lang=en')">
                                                        <img src="../Images/others/button_listofHealthcareSP.png" alt="" border="0" /></a>
                                                    </td>
                                                </tr>
                                                <tr>
                                                    <td align="center"><a href="javascript:void(0)" onclick="openNewWin('../../Documents/FAQs_e.pdf#Public')">
                                                        <img src="../Images/others/button_FAQs.png" alt="" border="0" /></a></td>
                                                    <td align="center"><a href="javascript:void(0)" onclick="openNewWin('../../en/ContactUs.htm')">
