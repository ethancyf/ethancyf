    ...
    Protected Sub Page_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Load
        ...
        If Not Me.IsPostBack Then
            ...
            If IDEASCombo.SessIdeasTokenResponse IsNot Nothing AndAlso _
                ((IDEASCombo.SessIdeasVersion <> IDEASCombo.EnumIdeasVersion.Combo And IDEASCombo.SessIdeasTokenResponse.IdeasMAURL IsNot Nothing) Or _
                 (IDEASCombo.SessIdeasVersion = IDEASCombo.EnumIdeasVersion.Combo And IDEASCombo.SessIdeasTokenResponse.BrokerURL IsNot Nothing)) _
                ...
                Try
                    ...
                    If Request.QueryString("status") Is Nothing Then
                        Logger.Log("IDEAS Version: " + IDEASCombo.ConvertIdeasVersion(IDEASCombo.SessIdeasVersion))
                        ...
                        Select Case IDEASCombo.SessIdeasVersion
                            Case IDEASCombo.EnumIdeasVersion.One, IDEASCombo.EnumIdeasVersion.Two, IDEASCombo.EnumIdeasVersion.TwoGender
                                ideasSamlResponse = ideasHelper.getCardFaceData(IDEASCombo.SessIdeasTokenResponse, Artifact, IDEASCombo.ConvertIdeasVersion(IDEASCombo.SessIdeasVersion))
                            Case IDEASCombo.EnumIdeasVersion.Combo
