...
#End Region
    ...
    Protected Sub Page_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Load
        ...
        Me.ModalPopupExclamationErrorBox.PopupDragHandleControlID = Me.ucNoticePopUpExclamationError.Header.ClientID
        Me.ModalPopupExclamationDemographicReminder.PopupDragHandleControlID = Me.ucNoticePopUpExclamationDemographicReminder.Header.ClientID
...
#Region "Popup box events"
    ...
    Private Sub ucNoticePopUpConfirmSelectPractice_ButtonClick(ByVal e As ucNoticePopUp.enumButtonClick) Handles ucNoticePopUpConfirmSelectPractice.ButtonClick
        Select Case e
            Case ucNoticePopUp.enumButtonClick.OK
                ...
                If (ucNoticePopUpConfirmSelectPractice.ButtonOK.Attributes("PopupCallFrom") = PracticeRadioButtonGroup.ClientID) Then
                    PracticeRadioButtonGroup.btnPracticeSelection_click(imageButton, Nothing)
                ElseIf (ucNoticePopUpConfirmSelectPractice.ButtonOK.Attributes("PopupCallFrom") = udcPopupPracticeRadioButtonGroup.ClientID) Then
                    udcPopupPracticeRadioButtonGroup.btnPracticeSelection_click(imageButton, Nothing)
                End If

            Case Else
                If (ucNoticePopUpConfirmSelectPractice.ButtonOK.Attributes("PopupCallFrom") = udcPopupPracticeRadioButtonGroup.ClientID) Then
    ...
    Private Sub udcPopupPracticeRadioButtonGroup_PracticeSelected(ByVal strPracticeName As String, ByVal strBankAcctNo As String, ByVal intBankAccountDisplaySeq As Integer, ByVal strSchemeCode As String, ByVal sender As Object, ByVal e As System.Web.UI.ImageClickEventArgs) Handles udcPopupPracticeRadioButtonGroup.PracticeSelected
        ...
        If (Me.ClaimMode = Common.Component.ClaimMode.COVID19 AndAlso Not _udtSessionHandler.ConfirmedPracticePopUpGetFromSession AndAlso IsContainCovid19Scheme) Then
            panPopupPracticeSelection.Visible = True
            ...
            ucNoticePopUpConfirmSelectPractice.ButtonOK.Attributes("PopupCallFrom") = udcPopupPracticeRadioButtonGroup.ClientID
                ...
                Case ActiveViewIndex.Step2a
                    ...
                    If isValid Then
                        ...
                        If Not udtOldPracticeDisplay.PracticeID.Equals(intBankAccountDisplaySeq) Then
                            ...
                            ' ---------------------------------------------------------------------------------------------------------
                            If Me.ClaimMode = ClaimMode.COVID19 Then
                                If Me.ddlStep2aScheme.Visible AndAlso udtSchemeClaim IsNot Nothing Then
    ...
    Private Sub ucNoticePopUpExclamationError_ButtonClick(ByVal e As ucNoticePopUp.enumButtonClick) Handles ucNoticePopUpExclamationError.ButtonClick
        Select Case e
            Case ucNoticePopUp.enumButtonClick.OK
                ' Do Nothing

            Case ucNoticePopUp.enumButtonClick.Cancel
                ModalPopupExclamationErrorBox.Hide()
    ...
    Private Sub ucNoticePopUpExclamationDemographicReminder_ButtonClick(ByVal e As ucNoticePopUp.enumButtonClick) Handles ucNoticePopUpExclamationDemographicReminder.ButtonClick
        Select Case e
            Case ucNoticePopUp.enumButtonClick.OK
                ' Do Nothing

            Case ucNoticePopUp.enumButtonClick.Cancel
                _udtSessionHandler.ClaimCOVID19DischargeDemographicReminderSaveToSession(True, FunctionCode)
                ModalPopupExclamationDemographicReminder.Hide()
    ...
    Private Sub ucNoticePopUpExclamationImportantReminder_ButtonClick(ByVal e As ucNoticePopUp.enumButtonClick) Handles ucNoticePopUpExclamationImportantReminder.ButtonClick
        Select Case e
            Case ucNoticePopUp.enumButtonClick.OK
                ' Do Nothing

            Case ucNoticePopUp.enumButtonClick.Cancel
                _udtSessionHandler.ClaimCOVID19DischargeReminderSaveToSession(True, FunctionCode)
                ModalPopupExclamationImportantReminder.Hide()
        ...
        Select Case e
            Case ucNoticePopUp.enumButtonClick.OK
                ...
                If ucNoticePopUpExclamationImportantReminderWithReason.OverrideReason.Trim = String.Empty Then
                    ...
                    udcReasonMsgBoxErr.AddMessage("990000", "E", "00028", "%s", ucNoticePopUpExclamationImportantReminderWithReason.OverrideReasonText)
...
#Region "Step 1 Search Account Events"
    ...
    Private Sub udcClaimSearch_ReadSmartIDButtonClick(ByVal sender As Object, ByVal e As System.Web.UI.ImageClickEventArgs) Handles udcClaimSearch.ReadSmartIDButtonClick
        ...
        If ClaimMode = Common.Component.ClaimMode.COVID19 Then
            ...
            _udtSessionHandler.ClaimCOVID19VaccineLotNoRemoveFromSession(FunctCode)
            COVID19.COVID19BLL.ClearVaccineLotListSession()
...
#Region "Step 2a Setup"
    ...
    Private Sub SetupStep2aSchemeAvailableForClaim(ByVal isAvailable As Boolean, ByVal udtEHSAccount As EHSAccountModel, ByVal udtSchemeClaim As SchemeClaimModel, ByVal createPopupPractice As Boolean)
        ...
        Else
            ...
            ' CRE20-0023 (Immu record) [Start][Chris YIM]
            ' ---------------------------------------------------------------------------------------------------------
            Me.panStep2aC19VaccinationRecord.Visible = False
            Me.panStep2aOtherVaccinationRecord.Visible = False
    ...
    Private Sub SetupStep2aClaimContent(ByVal udtSchemeClaim As SchemeClaimModel, ByVal udtEHSAccount As EHSAccountModel)
        ...
        If Not udtSchemeClaim Is Nothing Then
                            ...
                            Case SchemeClaimModel.EnumControlType.HSIVSS, SchemeClaimModel.EnumControlType.RVP, _
                                ...
                                If udtSchemeClaim.ControlType.Equals(SchemeClaimModel.EnumControlType.COVID19) OrElse _
                                   ...
                                   Then     ' CRE20-0022 (Immu record) [End][Winnie SUEN]
                                    ...
                                    'Main/Sub Category History
                                    dicC19Category = udtC19VaccineList.FilterFindNearestCategary
                                    ...
                                    If udtLatestC19Vaccine IsNot Nothing AndAlso udtLatestC19Vaccine.TransactionID <> String.Empty Then
                                        Dim udtTAF As TransactionAdditionalFieldModel = Nothing

                                        udtLatestC19Transaction = _udtEHSTransactionBLL.LoadClaimTran(udtLatestC19Vaccine.TransactionID.Trim)

                                        'Main Category
                                        If dicC19Category.ContainsKey(TransactionDetailVaccineModelCollection.COVID19Category.MainCategory) Then
                                            udtTAF = udtLatestC19Transaction.TransactionAdditionFields.FilterByAdditionFieldID(TransactionAdditionalFieldModel.AdditionalFieldType.MainCategory)
                                            If udtTAF IsNot Nothing Then
                                                udtTAF.AdditionalFieldValueCode = dicC19Category(TransactionDetailVaccineModelCollection.COVID19Category.MainCategory)
                                            Else
                                                ...
                                                udtTransactAdditionfield.AdditionalFieldValueCode = dicC19Category(TransactionDetailVaccineModelCollection.COVID19Category.MainCategory)
                                        ...
                                        'Sub Category
                                        If dicC19Category.ContainsKey(TransactionDetailVaccineModelCollection.COVID19Category.SubCategory) Then
                                            udtTAF = udtLatestC19Transaction.TransactionAdditionFields.FilterByAdditionFieldID(TransactionAdditionalFieldModel.AdditionalFieldType.SubCategory)
                                            If udtTAF IsNot Nothing Then
                                                udtTAF.AdditionalFieldValueCode = dicC19Category(TransactionDetailVaccineModelCollection.COVID19Category.SubCategory)
                                            Else
                                                Dim udtTransactAdditionfield As New TransactionAdditionalFieldModel()
                                                udtTransactAdditionfield.AdditionalFieldID = TransactionAdditionalFieldModel.AdditionalFieldType.SubCategory
                                                udtTransactAdditionfield.AdditionalFieldValueCode = dicC19Category(TransactionDetailVaccineModelCollection.COVID19Category.SubCategory)
                                                udtTransactAdditionfield.AdditionalFieldValueDesc = Nothing
                                                udtTransactAdditionfield.SchemeCode = udtLatestC19Transaction.TransactionDetails(0).SchemeCode
                                                udtTransactAdditionfield.SchemeSeq = udtLatestC19Transaction.TransactionDetails(0).SchemeSeq
                                                udtTransactAdditionfield.SubsidizeCode = udtLatestC19Transaction.TransactionDetails(0).SubsidizeCode
                                        ...
                                        'Contact No
                                        If strContactNo <> String.Empty Then
                                            udtTAF = udtLatestC19Transaction.TransactionAdditionFields.FilterByAdditionFieldID(TransactionAdditionalFieldModel.AdditionalFieldType.ContactNo)
                                            If udtTAF IsNot Nothing Then
                                                udtTAF.AdditionalFieldValueCode = strContactNo
                                            Else
                                                Dim udtTransactAdditionfield As New TransactionAdditionalFieldModel()
                                    ...
                                    Dim udtFilterSubsidizeDetailList As New EHSClaimVaccineModel.EHSClaimSubidizeDetailModelCollection
                                    ...
                                    If udtDischargeResult.DemographicResult = COVID19.DischargeResultModel.Result.ExactMatch OrElse _
                                        ...
                                        Me._udtSessionHandler.ClaimCOVID19DischargeRecordSaveToSession(udtDischargeResult, FunctionCode)
                                    End If
                ...
                Case SchemeClaimModel.EnumControlType.HSIVSS, SchemeClaimModel.EnumControlType.RVP, SchemeClaimModel.EnumControlType.VSS, _
                    ...
                    If Me.ClaimMode = ClaimMode.COVID19 Then
                        ...
                        If _udtSessionHandler.ClaimCOVID19DischargeDemographicReminderGetFromSession(FunctionCode) = False Then
                            If udtDischargeResult IsNot Nothing AndAlso udtDischargeResult.DemographicResult = DischargeResultModel.Result.PartialMatch Then
                                ucNoticePopUpExclamationDemographicReminder.HeaderText = GetGlobalResourceObject("Text", "RecoveredPatientPartiallyMatchedHeading")
                                ucNoticePopUpExclamationDemographicReminder.MessageText = GetGlobalResourceObject("Text", "RecoveredPatientPartiallyMatchedContent")
                                ModalPopupExclamationDemographicReminder.Show()
                            End If
                        End If
            ...
            ' ---------------------------------------------------------------------------------------------------------
            If Me.ClaimMode = ClaimMode.COVID19 Then
                panStep2aC19VaccinationRecord.Visible = True
                panStep2aOtherVaccinationRecord.Visible = True
                ...
                Dim dtC19VaccineRecord As DataTable = TransactionDetailListToCOVID19DataTable(GetVaccinationRecordFromSession(udtEHSAccount, udtSchemeClaim.SchemeCode))
                BuildCOVID19VaccinationRecordGrid(dtC19VaccineRecord)

                'Bind the discharge record table in enter claim page, if necessary.
                BuildCOVID19DischargeRecordGrid(_udtSessionHandler.ClaimCOVID19DischargeRecordGetFromSession(FunctionCode))
            ...
            Else
                panStep2aC19VaccinationRecord.Visible = False
                panStep2aOtherVaccinationRecord.Visible = False
    ...
    Protected Sub Step2aClaimSubmit(ByVal blnIsConfirmed As Boolean)
        ...
        If Not blnIsConfirmed Then
            Me._udtSessionHandler.ClaimCOVID19DischargeOverrideReasonRemoveFromSession(FunctionCode)
        End If
...
#Region "Step 2a Validation for Enter Claim detail"
    ...
    Private Function Step2aRVPCOVID19Validation(ByVal checkByConfirmationBox As Boolean, ByRef udtEHSTransaction As EHSTransactionModel) As Boolean
        ...
        If isValid Then
            ...
            Me.SaveDischargeResult(Me._udtEHSTransaction)
    ...
    Private Function Step2aPromptClaimRule(ByVal udtClaimRuleResult As ClaimRuleResult, _
                                           Optional ByRef arrRemark As List(Of String) = Nothing, _
                                           Optional ByVal enumHandleMethod As HandleMethodENum = HandleMethodENum.Warning) As String
        ...
        If Not udtClaimRuleResult.RelatedClaimRule Is Nothing Then
            Select Case enumHandleMethod
                Case HandleMethodENum.Warning
                ...
                Case HandleMethodENum.WarningReason
                    Dim udtPopupSystemMessageList As List(Of SystemMessage) = TryCast(udtClaimRuleResult.ResultParam("SystemMessage"), List(Of SystemMessage))

                    If udtPopupSystemMessageList IsNot Nothing Then
                        For Each udtPopupSystemMessage As SystemMessage In udtPopupSystemMessageList
                            If strText = String.Empty Then
                                strText = udtPopupSystemMessage.GetMessage
                            Else
...
#Region "Step 2b Confirm Claim detail"
    ...
    Private Sub SetupStep2b(ByVal udtEHSAccount As EHSAccountModel, ByVal blnInitAll As Boolean)
        ...
        If blnCOVID19 Then
            ...
            'Remarks
            lblStep2bRemark.Text = String.Empty
            ...
            If udtEHSTransaction.TransactionAdditionFields.Remarks IsNot Nothing And udtEHSTransaction.TransactionAdditionFields.Remarks <> String.Empty Then
                ...
                If _udtSessionHandler.ClaimCOVID19DischargeOverrideReasonGetFromSession(FunctCode) <> String.Empty Then
                    lblStep2bRemark.Text = lblStep2bRemark.Text + " (" + CStr(_udtSessionHandler.ClaimCOVID19DischargeOverrideReasonGetFromSession(FunctCode)) + ")"
                End If
            Else
                If _udtSessionHandler.ClaimCOVID19DischargeOverrideReasonGetFromSession(FunctCode) <> String.Empty Then
                    lblStep2bRemark.Text = "(" + CStr(_udtSessionHandler.ClaimCOVID19DischargeOverrideReasonGetFromSession(FunctCode)) + ")"
                Else
    ...
    Protected Sub Step2bClaimSubmit()
        ...
        If isValid Then
            ...
            ' CRE20-0023 (Immu record) [Start][Chris YIM]
            ' ---------------------------------------------------------------------------------------------------------
            If _udtSessionHandler.ClaimCOVID19DischargeOverrideReasonGetFromSession(FunctCode) <> String.Empty AndAlso _
                udtEHSTransaction.TransactionAdditionFields IsNot Nothing AndAlso _
                udtEHSTransaction.TransactionAdditionFields.Remarks IsNot Nothing Then

                Dim strRemark As String = udtEHSTransaction.TransactionAdditionFields.Remarks

                strRemark = strRemark + " (" + CStr(_udtSessionHandler.ClaimCOVID19DischargeOverrideReasonGetFromSession(FunctCode)) + ")"

                strRemark = strRemark.Trim

                udtEHSTransaction.TransactionAdditionFields.FilterByAdditionFieldID(TransactionAdditionalFieldModel.AdditionalFieldType.Remarks).AdditionalFieldValueDesc = strRemark
...
#Region "Step of Select Practice"
    ...
    Protected Sub PracticeRadioButtonGroup_PracticeSelected(ByVal strPracticeName As String, ByVal strBankAcctNo As String, ByVal intBankAccountDisplaySeq As Integer, ByVal strSchemeCode As String, ByVal sender As Object, ByVal e As System.Web.UI.ImageClickEventArgs) Handles PracticeRadioButtonGroup.PracticeSelected
        ...
        If (Me.ClaimMode = Common.Component.ClaimMode.COVID19 AndAlso Not _udtSessionHandler.ConfirmedPracticePopUpGetFromSession AndAlso IsContainCovid19Scheme) Then
            ...
            ucNoticePopUpConfirmSelectPractice.ButtonOK.Attributes("PracticeDisplayText") = selectPracticeImageButton.Attributes("PracticeDisplayText")
            ucNoticePopUpConfirmSelectPractice.ButtonOK.Attributes("blnShowPopUp") = selectPracticeImageButton.Attributes("blnShowPopUp")
            ucNoticePopUpConfirmSelectPractice.ButtonOK.Attributes("PopupCallFrom") = PracticeRadioButtonGroup.ClientID
            ucNoticePopUpConfirmSelectPractice.MessageText = String.Format(HttpContext.GetGlobalResourceObject("Text", "SelectPracticePopup"), selectPracticeImageButton.Attributes("PracticeDisplayText"))
...
#Region "Vaccination Record"
    ...
    Private Sub BuildOtherVaccinationRecordGrid(ByRef dtVaccineRecord As DataTable)

        Me._udtSessionHandler.ClaimCOVID19OtherVaccineRecordSaveToSession(dtVaccineRecord)

        If dtVaccineRecord.Rows.Count > 0 Then
            gvCOtherVaccinationRecord.Style.Add("border-width", "0px")
            gvCOtherVaccinationRecord.Style.Add("border-spacing", "2px")
            gvCOtherVaccinationRecord.Style.Add("border-collapse", "separate")
            gvCOtherVaccinationRecord.DataSource = dtVaccineRecord
            gvCOtherVaccinationRecord.DataBind()
            panNoOtherVaccinationRecord.Visible = False
            gvCOtherVaccinationRecord.Visible = True
        Else
            panNoOtherVaccinationRecord.Visible = True
            gvCOtherVaccinationRecord.Visible = False
            gvCOtherVaccinationRecord.Dispose()
        End If
    ...
    Private Sub BuildCOVID19VaccinationRecordGrid(ByRef dtVaccineRecord As DataTable)
        ...
        Me._udtSessionHandler.ClaimCOVID19C19VaccineRecordSaveToSession(dtVaccineRecord)
        If dtVaccineRecord.Rows.Count > 0 Then
            gvCC19VaccinationRecord.DataSource = dtVaccineRecord
            gvCC19VaccinationRecord.DataBind()
            panNoC19VaccinationRecord.Visible = False
            gvCC19VaccinationRecord.Visible = True
        Else
            panNoC19VaccinationRecord.Visible = True
            gvCC19VaccinationRecord.Visible = False
            gvCC19VaccinationRecord.Dispose()
        End If
    ...
    Protected Sub gvCC19VaccinationRecord_RowDataBound(ByVal sender As Object, ByVal e As System.Web.UI.WebControls.GridViewRowEventArgs)
    ...
    Protected Sub gvCC19VaccinationRecord_PreRender(ByVal sender As Object, ByVal e As System.EventArgs)
        Me.GridViewPreRenderHandler(sender, e, SessionHandler.SessionName.SESS_ClaimCOVID19_C19VaccineRecord)
    End Sub

    Protected Sub gvCC19VaccinationRecord_Sorting(ByVal sender As Object, ByVal e As System.Web.UI.WebControls.GridViewSortEventArgs)
        Me.GridViewSortingHandler(sender, e, SessionHandler.SessionName.SESS_ClaimCOVID19_C19VaccineRecord)
    End Sub
    ...
    Protected Sub gvCOtherVaccinationRecord_RowDataBound(ByVal sender As Object, ByVal e As System.Web.UI.WebControls.GridViewRowEventArgs)
        If e.Row.RowType = DataControlRowType.DataRow Then
            Dim dr As DataRow = CType(e.Row.DataItem, System.Data.DataRowView).Row
            Dim udtFormatter As New Formatter
            Dim blnIsChinese As Boolean = (LCase(Session("language")) = CultureLanguage.TradChinese)
            ...
            ' Injection Date
            Dim lblOtherInjectionDate As Label = e.Row.FindControl("lblCOtherInjectionDate")
            Dim dtmOtherInjectionDate As DateTime = Nothing

            DateTime.TryParse(e.Row.DataItem("ServiceReceiveDtm").ToString().Trim, dtmOtherInjectionDate)

            Select Case strLanguage
                Case CultureLanguage.TradChinese
                    lblOtherInjectionDate.Text = udtFormatter.formatDisplayDate(dtmOtherInjectionDate.Date, CultureLanguage.TradChinese)
                Case CultureLanguage.SimpChinese
                    lblOtherInjectionDate.Text = udtFormatter.formatDisplayDate(dtmOtherInjectionDate.Date, CultureLanguage.SimpChinese)
                Case CultureLanguage.English
                    lblOtherInjectionDate.Text = udtFormatter.formatDisplayDate(dtmOtherInjectionDate.Date, CultureLanguage.English)
                Case Else
                    lblOtherInjectionDate.Text = udtFormatter.formatDisplayDate(dtmOtherInjectionDate.Date, CultureLanguage.English)
            End Select

            ' Vaccination
            Dim lblCOtherVaccination As Label = e.Row.FindControl("lblCOtherVaccination")
            Dim lblCOtherVaccinationChi As Label = e.Row.FindControl("lblCOtherVaccinationChi")

            lblCOtherVaccination.Visible = Not blnIsChinese
            lblCOtherVaccinationChi.Visible = blnIsChinese

            ' Background colour
            If (e.Row.RowIndex Mod 2) = 1 Then
                'Odd row (1,3,5...)
                e.Row.Style.Add("background-color", "#eaeff7")
            Else
                'Even row (0,2,4...)
                e.Row.Style.Add("background-color", "#d2deef")
            End If
    ...
    Protected Sub gvCOtherVaccinationRecord_PreRender(ByVal sender As Object, ByVal e As System.EventArgs)
        Me.GridViewPreRenderHandler(sender, e, SessionHandler.SessionName.SESS_ClaimCOVID19_OtherVaccineRecord)
    End Sub

    Protected Sub gvCOtherVaccinationRecord_Sorting(ByVal sender As Object, ByVal e As System.Web.UI.WebControls.GridViewSortEventArgs)
        Me.GridViewSortingHandler(sender, e, SessionHandler.SessionName.SESS_ClaimCOVID19_OtherVaccineRecord)
    End Sub

    Private Function TransactionDetailListToNonCOVID19DataTable(ByVal udtTranDetailVaccineList As TransactionDetailVaccineModelCollection) As DataTable
        Dim dtVaccineRecord As New DataTable
        ...
        ' Convert each TransactionDetailModel to datarow
        For Each udtTranDetailVaccine As TransactionDetailVaccineModel In udtTranDetailVaccineList
            If udtTranDetailVaccine.SubsidizeItemCode <> SubsidizeGroupClaimModel.SubsidizeItemCodeClass.C19 AndAlso _
                DateDiff(DateInterval.Day, udtTranDetailVaccine.ServiceReceiveDtm, dtmToday) < DateDiff(DateInterval.Day, DateAdd(DateInterval.Year, -1, dtmToday), dtmToday) Then
...
#End Region
    ...
    Private Function GetCOVID19VaccineLotMappingForRCH(ByVal dtmServiceDate As Date) As DataRow()
        ...
        Dim udtCOVID19BLL As New COVID19.COVID19BLL
        'CRE20-023 Fix the Lot Mapping table filter [Start][Nichole]
        Dim dtVaccineLotNo As DataTable = udtCOVID19BLL.GetCOVID19VaccineLotMappingForRCH(dtmServiceDate, COVID19.COVID19BLL.Source.GetFromSession)
        Dim drVaccineLotNo() As DataRow = Nothing
    ...
    Private Function GetCOVID19VaccineLotMappingForCentre(ByVal strSPID As String, ByVal intPracticeID As Integer, ByVal dtmServiceDate As Date) As DataRow()
        ...
        Dim udtCOVID19BLL As New COVID19.COVID19BLL
        'CRE20-023 Fix the Lot Mapping table filter [Start][Nichole]
        Dim dtVaccineLotNo As DataTable = udtCOVID19BLL.GetCOVID19VaccineLotMappingForCentre(strSPID, intPracticeID, dtmServiceDate, COVID19.COVID19BLL.Source.GetFromSession)
        Dim drVaccineLotNo() As DataRow = Nothing
