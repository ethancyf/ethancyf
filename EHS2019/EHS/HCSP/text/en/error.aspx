<%@ Page Language="vb" AutoEventWireup="false" MasterPageFile="~/CSRFMasterPage.Master" CodeBehind="error.aspx.vb" Inherits="HCSP.Text.EN._error" %>
        ...
        <ContentTemplate>
            ...
            <div>
                <table id="tblBanner" border="0" cellpadding="0" cellspacing="0" runat="server" style="width: 100%">
                    ...
                    <tr>
                        <td>
                            <span style="font-size: 12pt;">System error.<br />
                                Please click <a href="../login.aspx">here</a>
                                to back to login again.
                            </span>
                        </td>
                    </tr>
                </table>
