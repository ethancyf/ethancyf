<%@ Page Language="vb" AutoEventWireup="false" MasterPageFile="~/CSRFMasterPage.Master" CodeBehind="sessiontimeout.aspx.vb" Inherits="HCSP.sessiontimeout" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    <asp:UpdatePanel ID="UpdatePanel1" runat="server">
        <ContentTemplate>
            ...
            <br />
            <span style="font-size: 16pt;">&nbsp;系統逾時，請按 <a href="../login.aspx">此處</a> 重新登入。</span>
        </ContentTemplate>
    </asp:UpdatePanel>
</asp:Content>
