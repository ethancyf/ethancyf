...
Namespace PrintOut.VoucherConsentForm_CHI
    Public Class VoucherNotice_v2
        ...
        Private Sub LoadReport(ByVal udtCFInfo As ConsentFormInformationModel)
            ...
            Formatter.SetSPNameFontSize(Formatter.EnumLang.Chi, udtCFInfo.SPDisplayName, txtNoticeSPName, True)
            ...
            strNoticeClaimedBeforeNo = Formatter.FormatMoney(strNoticeClaimedBeforeNo, Formatter.EnumLang.Chi)
            ...
            strNoticeClaimedNo = Formatter.FormatMoney(strNoticeClaimedNo, Formatter.EnumLang.Chi)
            ...
            strNoticeClaimedAfterNo = Formatter.FormatMoney(strNoticeClaimedAfterNo, Formatter.EnumLang.Chi)
