...
#End Region
        ...
        Private Sub LoadReport()
            ...
            ' Personal Info
            srPersonalInfo.Report = New Common.PersonalInfo(_udtEHSAccount.getPersonalInformation(_udtEHSAccount.SearchDocCode))
            ...
            If Not Me._udtSmartIDContent Is Nothing AndAlso Me._udtSmartIDContent.IsReadSmartID Then
                srDeclaration.Report = New CIVSSDeclarationCondensedSmartID(_udtSP)
                ' txtPageName.Text = "DH_CIVSS(02/10)"
                txtPageName.Text = _udtPrintoutHelper.GetPrintoutVersionCode(Scheme.SchemeClaimModel.CIVSS, Common.PrintoutHelper.PrintoutVersion.CondensedEnglishSmartID)
            Else
                srDeclaration.Report = New CIVSSDeclarationCondensed(_udtSP)
                ' txtPageName.Text = "DH_CIVSS(06/09)"
                txtPageName.Text = _udtPrintoutHelper.GetPrintoutVersionCode(Scheme.SchemeClaimModel.CIVSS, Common.PrintoutHelper.PrintoutVersion.CondensedEnglish)
            End If
