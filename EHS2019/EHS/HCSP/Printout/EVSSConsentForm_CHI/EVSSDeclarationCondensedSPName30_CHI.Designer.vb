Namespace PrintOut.EVSSConsentForm_CHI
    ...
    Partial Public Class EVSSDeclarationCondensedSPName30_CHI
        ...
        Private Sub InitializeComponent()
            ...
            'Detail
            '
            Me.Detail.Controls.AddRange(New GrapeCity.ActiveReports.SectionReportModel.ARControl() {Me.txtDeclaration4Value, Me.TextBox48, Me.TextBox1, Me.TextBox13, Me.txtDocumentExplainedBy})
            Me.Detail.Height = 0.45!
            Me.Detail.Name = "Detail"
            '
            'txtDeclaration4Value
            '
            Me.txtDeclaration4Value.Height = 0.188!
            Me.txtDeclaration4Value.Left = 1.875!
            ...
            Me.txtDeclaration4Value.Text = "已獲"
            Me.txtDeclaration4Value.Top = 0.0!
            Me.txtDeclaration4Value.Width = 0.38!
            '
            'TextBox48
            '
            Me.TextBox48.Height = 0.188!
            Me.TextBox48.Left = 4.98!
            Me.TextBox48.Name = "TextBox48"
            Me.TextBox48.Style = "font-family: HA_MingLiu; font-size: 12pt; text-align: justify; white-space: inher" & _
        "it; ddo-char-set: 0"
            Me.TextBox48.Text = "告知並解釋疫苗資助計劃之「同"
            Me.TextBox48.Top = 0.0!
            Me.TextBox48.Width = 2.38!
            '
            'TextBox1
            '
        ...
        "; ddo-char-set: 136"
            Me.TextBox1.Text = "本人 / 以下服務使用者*"
            Me.TextBox1.Top = 0.0!
            Me.TextBox1.Width = 1.87!
            '
            'TextBox13
            '
            ...
            Me.TextBox13.Text = "意轉交個人資料」內所載的承諾及聲明。本人明白和同意該等承諾及聲明的內容。"
            ...
            Me.txtDocumentExplainedBy.Left = 2.23!
