Namespace PrintOut.EVSSConsentForm_CHI
    ...
    Partial Public Class EVSSDeclarationCondensedSmartIDSPName20_CHI
        ...
        Private Sub InitializeComponent()
            Dim resources As System.Resources.ResourceManager = New System.Resources.ResourceManager(GetType(EVSSDeclarationCondensedSmartIDSPName20_CHI))
            ...
            'Detail
            '
            Me.Detail.Controls.AddRange(New GrapeCity.ActiveReports.SectionReportModel.ARControl() {Me.TextBox48, Me.txtDeclaration4Value, Me.TextBox13, Me.txtDocumentExplainedBy, Me.TextBox1})
            ...
            Me.TextBox48.Text = "告知並解釋疫苗資助計劃之「同意轉交個"
            ...
            Me.TextBox13.Text = "人資料」內所載的承諾及聲明。本人明白和同意該等承諾及聲明的內容。"
        ...
        "; ddo-char-set: 136"
            ...
            '
            'EVSSDeclarationCondensedSmartIDSPName20_CHI
            '
