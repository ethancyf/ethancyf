Namespace PrintOut.HSIVSSConsentForm
    ...
    Partial Public Class HSIVSSEligibilityRoleMedicalCondition
        ...
        Private Sub InitializeComponent()
            Dim resources As System.Resources.ResourceManager = New System.Resources.ResourceManager(GetType(HSIVSSEligibilityRoleMedicalCondition))
            ...
            Me.txtDescription.Style = "ddo-char-set: 0; text-align: justify; font-size: 10pt; "
            Me.txtDescription.Text = Nothing
            Me.txtDescription.Top = 0.1875!
            Me.txtDescription.Width = 6.4375!
            '
            'txtDoctor
            '
            ...
            Me.txtDoctor.Left = 0.15625!
            Me.txtDoctor.MultiLine = False
            Me.txtDoctor.Name = "txtDoctor"
            Me.txtDoctor.Style = "ddo-char-set: 0; text-align: right; font-size: 10pt; white-space: nowrap; "
            Me.txtDoctor.Text = "Certification by attending enrolled doctor:"
            Me.txtDoctor.Top = 0.46875!
            Me.txtDoctor.Width = 3.53125!
            '
            'txtDoctorSignature
            '
            ...
            Me.txtDoctorSignature.Left = 3.71875!
            Me.txtDoctorSignature.MultiLine = False
            Me.txtDoctorSignature.Name = "txtDoctorSignature"
            Me.txtDoctorSignature.Style = "ddo-char-set: 0; text-align: center; font-size: 9pt; white-space: nowrap; "
            Me.txtDoctorSignature.Text = "(Attending Enrolled Doctor's Signature)"
            Me.txtDoctorSignature.Top = 0.625!
            Me.txtDoctorSignature.Width = 2.90625!
            '
            'txtDoctorValue
            '
            ...
            Me.txtDoctorValue.Left = 3.71875!
            Me.txtDoctorValue.MultiLine = False
            Me.txtDoctorValue.Name = "txtDoctorValue"
            Me.txtDoctorValue.Style = "ddo-char-set: 0; text-align: justify; font-size: 10pt; white-space: nowrap; "
            Me.txtDoctorValue.Text = Nothing
            Me.txtDoctorValue.Top = 0.46875!
            Me.txtDoctorValue.Width = 2.90625!
            '
            'txtHeader
            '
            ...
            Me.txtHeader.Style = "ddo-char-set: 0; text-align: justify; font-size: 10pt; "
            Me.txtHeader.Text = "I am/My child has the following medical condition:"
            Me.txtHeader.Top = 0.0!
            Me.txtHeader.Width = 6.65625!
            '
            'CheckBox1
            '
            ...
            Me.CheckBox1.CheckAlignment = System.Drawing.ContentAlignment.MiddleRight
            Me.CheckBox1.Checked = True
            Me.CheckBox1.Height = 0.188!
            Me.CheckBox1.Left = 0.0!
            Me.CheckBox1.Name = "CheckBox1"
            Me.CheckBox1.Style = "ddo-char-set: 0; font-size: 10pt; "
            Me.CheckBox1.Text = ""
            Me.CheckBox1.Top = 0.1875!
            Me.CheckBox1.Width = 0.188!
            '
            'HSIVSSEligibilityRoleMedicalCondition
            '
