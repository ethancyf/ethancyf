...
Namespace PrintOut.HSIVSSConsentForm
    ...
    Public Class HSIVSSEligibility
        ...
        Private Sub LoadReport()
            ...
            If _blnIsAdult Then
                Me.txtDeclaration.Text = "I confirm that I am a Hong Kong resident and that:"
            Else
                Me.txtDeclaration.Text = "I confirm that my child is a Hong Kong resident and that:"
            End If

            If IsMedicalCondition() Then
                srEligibilityRole.Report = New HSIVSSEligibilityRoleMedicalCondition(_udtEHSTransaction, _udtSchemeCategoryDescriptionSystemResource)
            Else
                srEligibilityRole.Report = New HSIVSSEligibilityRole(_udtSchemeCategoryDescriptionSystemResource)
            End If
