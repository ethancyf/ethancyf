...
Namespace PrintOut.Common.Lite
    ...
    Public Class PersonalInfo
        ...
        Private _udtPrintoutHelper As PrintoutHelper
        ...
        Private Sub New()
            ...
            _udtPrintoutHelper = New PrintoutHelper
        ...
        Private Sub LoadReport()
            ...
            _udtReportFunction.formatUnderLineTextBox(String.Format("({0})", strChineseNameDisplay), txtNameChi)
            If strChineseNameDisplay Is Nothing OrElse strChineseNameDisplay.Trim().Length = 0 Then
                txtNameChi.Visible = False
            End If

            ' Adjust Chinese Name TextBox Location
            txtNameChi.Location = New System.Drawing.PointF(_udtPrintoutHelper.MeasureStringSize(strEnglishNameDisplay, txtNameEng.Font).Width + txtNameEng.Location.X, txtNameChi.Location.Y)
