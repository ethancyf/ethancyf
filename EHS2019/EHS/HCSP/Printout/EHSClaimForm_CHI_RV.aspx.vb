...
Partial Public Class EHSClaimForm_CHI_RV
        ...
        Select Case udtSchemeClaim.SchemeCode
            Case SchemeClaimModel.CIVSS
                If Not udtSP Is Nothing AndAlso _
                   ...
                   Not udtSchemeClaim Is Nothing Then
                    objReport = New CIVSSConsentForm_CHI.CIVSSConsentForm_CHI(udtEHSTransaction, udtSchemeClaim, udtEHSAccount, udtSP, udtSmartIDContent)
                End If
            ...
            Case SchemeClaimModel.EVSS
                If Not udtSP Is Nothing AndAlso _
                   ...
                   Not udtEHSAccount Is Nothing AndAlso _
                   Not udtSchemeClaim Is Nothing Then
                    objReport = New EVSSConsentForm_CHI.EVSSConsentForm_CHI(udtEHSTransaction, udtSchemeClaim, udtEHSAccount, udtSP, udtSmartIDContent)
                End If
                ...
                '        objReport = New VoucherConsentForm_CHI.VoucherConsentForm_CHI(udtEHSTransaction, udtEHSAccount, udtSP, udtSmartIDContent)

                '        'objReport = New VoucherConsentForm_CHI.VoucherConsentForm_CHI(udtEHSTransaction, udtEHSAccount, udtSP)
                '    End If
                ...
                If Not udtSP Is Nothing AndAlso _
                   ...
                   Not udtSchemeClaim Is Nothing Then
                    ...
                    If udtSchemeCategoryDescriptionMapping.IsAdult Then
                        objReport = New HSIVSSConsentForm_CHI.HSIVSSConsentFormAdult_CHI(udtEHSTransaction, udtSchemeClaim, udtEHSAccount, udtSP, udtSchemeCategoryDescriptionMapping.SystemResource, udtSmartIDContent)
                    Else
                        objReport = New HSIVSSConsentForm_CHI.HSIVSSConsentFormChild_CHI(udtEHSTransaction, udtSchemeClaim, udtEHSAccount, udtSP, udtSchemeCategoryDescriptionMapping.SystemResource, udtSmartIDContent)
                    End If
                ...
                Else
                    If Not IsNothing(udtSP) _
                        ...
                        If udtEHSTransaction.CategoryCode = CategoryCode.VSS_CHILD Then
                            objReport = New VSSConsentForm_CHI.VSSConsentForm_C_CHI(udtEHSTransaction, udtSchemeClaim, udtEHSAccount, udtSP, udtSmartIDContent)
                        Else
                            objReport = New VSSConsentForm_CHI.VSSConsentForm_CHI(udtEHSTransaction, udtSchemeClaim, udtEHSAccount, udtSP, udtSmartIDContent)
                        End If
