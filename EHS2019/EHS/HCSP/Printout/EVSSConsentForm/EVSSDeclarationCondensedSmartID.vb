...
#End Region
        ...
        Private Sub FillSPName()
            ...
            If strSPName.Length <= 20 Then
                srDeclaration.Report = New EVSSDeclarationCondensedSmartIDSPName20(_udtSP)
            ElseIf strSPName.Length <= 30 Then
                srDeclaration.Report = New EVSSDeclarationCondensedSmartIDSPName30(_udtSP)
            Else
                srDeclaration.Report = New EVSSDeclarationCondensedSmartIDSPName40(_udtSP)
            End If
