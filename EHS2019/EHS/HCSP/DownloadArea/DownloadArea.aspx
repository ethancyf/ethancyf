<%@ Page Language="vb" AutoEventWireup="false" MasterPageFile="~/CSRFMasterPage.Master" Codebehind="DownloadArea.aspx.vb" Inherits="HCSP.DownloadArea" %>
                                                                            ...
                                                                            <table style="width:700px;border-spacing:1px;border-collapse:separate;background-color: silver">
                                                                                ...
                                                                                <tr id="trEngSmartIDCardReader" runat="server">
                                                                                    ...
                                                                                    <td style="vertical-align:top;background-color: #ffffff;padding:5px;">
                                                                                        ...
                                                                                        <a style="font-weight:bold;" href="javascript:void(0);" onclick="JavaScript:showUpdateNow('en-us');">
