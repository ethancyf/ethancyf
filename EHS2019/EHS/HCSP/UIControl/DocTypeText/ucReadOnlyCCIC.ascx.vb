...
Namespace UIControl.DocTypeText
    ...
    Partial Public Class ucReadOnlyCCIC
        ...
        Protected Overrides Sub Setup(ByVal mode As ucInputDocTypeBase.BuildMode)
            ...
            If udtSessionHandler.Language = Common.Component.CultureLanguage.TradChinese Then
                strDocumentTypeFullName = udtDocTypeModelList.Filter(DocTypeCode.CCIC).DocNameChi
            Else
                strDocumentTypeFullName = udtDocTypeModelList.Filter(DocTypeCode.CCIC).DocName
            End If
