<%@ Control Language="vb" AutoEventWireup="false" CodeBehind="ucReadOnlyCCIC.ascx.vb" Inherits="HCSP.UIControl.DocTypeText.ucReadOnlyCCIC" %>
<asp:Panel ID="panReadonlyVerticalCCIC" runat="server">
    ...
    <table id="tblCCIC" runat="server" cellpadding="0" cellspacing="0" class="textVersionTable">
        <tbody>
            <tr>
                <td valign="top">
