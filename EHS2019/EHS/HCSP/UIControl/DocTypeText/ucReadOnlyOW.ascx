<%@ Control Language="vb" AutoEventWireup="false" CodeBehind="ucReadOnlyOW.ascx.vb" Inherits="HCSP.UIControl.DocTypeText.ucReadOnlyOW" %>
<asp:Panel ID="panReadonlyVerticalOW" runat="server">
    ...
    <table id="tblOW" runat="server" cellpadding="0" cellspacing="0" class="textVersionTable">
        <tbody>
            <tr>
                <td valign="top">
