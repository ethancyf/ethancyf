...
Namespace UIControl.DocTypeText
    ...
    Partial Public Class ucReadOnlyTW
        ...
        Protected Overrides Sub Setup(ByVal mode As ucInputDocTypeBase.BuildMode)
            ...
            If udtSessionHandler.Language = Common.Component.CultureLanguage.TradChinese Then
                strDocumentTypeFullName = udtDocTypeModelList.Filter(DocTypeCode.TW).DocNameChi
            Else
                strDocumentTypeFullName = udtDocTypeModelList.Filter(DocTypeCode.TW).DocName
            End If
            ...
            Me.lblReadonlyTravelDocNo.Text = formatter.FormatDocIdentityNoForDisplay(DocTypeCode.TW, MyBase.EHSAccountPersonalInfo.IdentityNum, MyBase.MaskIdentityNumber)
        ...
        Protected Overrides Sub RenderLanguage()
            ...
            Dim udtDocTypeModel As DocTypeModel = udtDocTypeBLL.getAllDocType.Filter(DocTypeCode.TW)
