    ...
    Partial Public Class ucReadOnlyOW
        ...
        Protected Overrides Sub Setup(ByVal mode As ucInputDocTypeBase.BuildMode)
            ...
            If udtSessionHandler.Language = Common.Component.CultureLanguage.TradChinese Then
                strDocumentTypeFullName = udtDocTypeModelList.Filter(DocTypeCode.OW).DocNameChi
            Else
                strDocumentTypeFullName = udtDocTypeModelList.Filter(DocTypeCode.OW).DocName
            End If
            ...
            Me.lblReadonlyTravelDocNo.Text = formatter.FormatDocIdentityNoForDisplay(DocTypeCode.OW, MyBase.EHSAccountPersonalInfo.IdentityNum, MyBase.MaskIdentityNumber)
            ...
            'Me.lblReadonlyIssueDate.Text = formatter.formatDOI(DocTypeCode.OW, MyBase.EHSAccountPersonalInfo.DateofIssue)
