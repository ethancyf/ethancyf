<%@ Control Language="vb" AutoEventWireup="false" CodeBehind="ucReadOnlyPASS.ascx.vb" Inherits="HCSP.UIControl.DocTypeText.ucReadOnlyPASS" %>
<asp:Panel ID="panReadonlyVerticalPASS" runat="server">
    ...
    <table id="tblPASS" runat="server" cellpadding="0" cellspacing="0" class="textVersionTable">
        <tbody>
            <tr>
                <td valign="top">
