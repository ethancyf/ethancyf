<%@ Control Language="vb" AutoEventWireup="false" CodeBehind="ucReadOnlyTW.ascx.vb" Inherits="HCSP.UIControl.DocTypeText.ucReadOnlyTW" %>
<asp:Panel ID="panReadonlyVerticalTW" runat="server">
    ...
    <table id="tblTW" runat="server" cellpadding="0" cellspacing="0" class="textVersionTable">
        <tbody>
            <tr>
                <td valign="top">
