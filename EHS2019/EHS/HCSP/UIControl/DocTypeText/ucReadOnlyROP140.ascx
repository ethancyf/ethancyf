<%@ Control Language="vb" AutoEventWireup="false" CodeBehind="ucReadOnlyROP140.ascx.vb" Inherits="HCSP.UIControl.DocTypeText.ucReadOnlyROP140" %>
<asp:Panel ID="panReadonlyVerticalROP140" runat="server">
    ...
    <table id="tblROP140" runat="server" cellpadding="0" cellspacing="0" class="textVersionTable">
        <tbody>
            <tr>
                <td valign="top">
