<%@ Control Language="vb" AutoEventWireup="false" Codebehind="ucReadOnlyDI.ascx.vb" Inherits="HCSP.UIControl.DocTypeText.ucReadOnlyDI" %>
<asp:Panel ID="panReadonlyVerticalDI" runat="server">
    ...
    <table id="tblDI" runat="server" cellpadding="0" cellspacing="0" class="textVersionTable">
        <tbody>
            <tr>
                <td valign="top">
