...
Partial Public Class ChooseCCCode
    ...
    Protected Sub Page_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Load
        ...
        Dim strCCCLinkCN As String = String.Empty
        ...
        If LCase(Session("language")) = Common.Component.CultureLanguage.TradChinese Then
            generalFunction.getSystemParameter("CheckCCCodeLink_ZH", strCCCLinkCHI, String.Empty)
        ...
        ElseIf LCase(Session("language")) = Common.Component.CultureLanguage.SimpChinese Then
            generalFunction.getSystemParameter("CheckCCCodeLink_CN", strCCCLinkCN, String.Empty)
            Me.lnkHere.OnClientClick = String.Format("javascript:openNewWin('{0}'); return false;", strCCCLinkCN)
            'CRE13-019-02 Extend HCVS to China [End][Winnie]
        Else
            generalFunction.getSystemParameter("CheckCCCodeLink_EN", strCCCLinkENG, String.Empty)
    ...
    Public Function GetChineseName(ByVal strFunctionCode As String, ByVal blnSaveCCCodeToSession As Boolean) As String
        ...
        strCName += Me.GetChineseWord(Me._strCCCode1, Me.ddlCCCode1, blnSaveCCCodeToSession, strFunctionCode, BLL.SessionHandler.SessionName.SESS_CCCode1)
        strCName += Me.GetChineseWord(Me._strCCCode2, Me.ddlCCCode2, blnSaveCCCodeToSession, strFunctionCode, BLL.SessionHandler.SessionName.SESS_CCCode2)
        strCName += Me.GetChineseWord(Me._strCCCode3, Me.ddlCCCode3, blnSaveCCCodeToSession, strFunctionCode, BLL.SessionHandler.SessionName.SESS_CCCode3)
        strCName += Me.GetChineseWord(Me._strCCCode4, Me.ddlCCCode4, blnSaveCCCodeToSession, strFunctionCode, BLL.SessionHandler.SessionName.SESS_CCCode4)
        strCName += Me.GetChineseWord(Me._strCCCode5, Me.ddlCCCode5, blnSaveCCCodeToSession, strFunctionCode, BLL.SessionHandler.SessionName.SESS_CCCode5)
        strCName += Me.GetChineseWord(Me._strCCCode6, Me.ddlCCCode6, blnSaveCCCodeToSession, strFunctionCode, BLL.SessionHandler.SessionName.SESS_CCCode6)
    ...
    Private Function GetChineseWord(ByVal strCCCode As String, ByVal ddlCCCode As DropDownList, ByVal blnSaveCCCodeToSession As Boolean, ByVal strfunctionCode As String, ByVal sessionName As String) As String
        ...
        If strCCCode Is Nothing OrElse strCCCode.Equals(String.Empty) Then
            ...
            Me.udtSessionHandler.CCCodeRemoveFromSession(strfunctionCode, sessionName)
        Else
            ...
            Else
                ...
                If blnSaveCCCodeToSession Then
                    If strCCCode.Length = 4 Then
                        Me.udtSessionHandler.CCCodeSaveToSession(strfunctionCode, sessionName, String.Format("{0}{1}", strCCCode, ddlCCCode.SelectedValue.Trim()))
                    ElseIf strCCCode.Length = 5 Then
                        Me.udtSessionHandler.CCCodeSaveToSession(strfunctionCode, sessionName, strCCCode)
                    End If
    ...
    Public Function CCCodeDiff(ByVal strCurrentCCCode As String, ByVal strFunctionCode As String, ByVal intCCCodeIndex As Integer) As Boolean
        ...
        Select Case intCCCodeIndex
            Case 1
                isDiff = Me.CCCodeDiff(strCurrentCCCode, strFunctionCode, BLL.SessionHandler.SessionName.SESS_CCCode1, Me.ddlCCCode1)
            Case 2
                isDiff = Me.CCCodeDiff(strCurrentCCCode, strFunctionCode, BLL.SessionHandler.SessionName.SESS_CCCode2, Me.ddlCCCode2)
            Case 3
                isDiff = Me.CCCodeDiff(strCurrentCCCode, strFunctionCode, BLL.SessionHandler.SessionName.SESS_CCCode3, Me.ddlCCCode3)
            Case 4
                isDiff = Me.CCCodeDiff(strCurrentCCCode, strFunctionCode, BLL.SessionHandler.SessionName.SESS_CCCode4, Me.ddlCCCode4)
            Case 5
                isDiff = Me.CCCodeDiff(strCurrentCCCode, strFunctionCode, BLL.SessionHandler.SessionName.SESS_CCCode5, Me.ddlCCCode5)
            Case 6
                isDiff = Me.CCCodeDiff(strCurrentCCCode, strFunctionCode, BLL.SessionHandler.SessionName.SESS_CCCode6, Me.ddlCCCode6)
        End Select
        Return isDiff
    End Function
    ...
    Private Function CCCodeDiff(ByVal strCurrentCCCode As String, ByVal strFunctionCode As String, ByVal strCCCodeSessionName As String, ByVal ddlCCCode As DropDownList) As Boolean
        ...
        strSessionCCCode = Me.udtSessionHandler.CCCodeGetFormSession(strFunctionCode, strCCCodeSessionName)
        ...
        If String.IsNullOrEmpty(strCurrentCCCode) AndAlso Not strSessionCCCode.Equals(String.Empty) Then
            'Session have value but user didn't input CCCode 
            'Need User Confirm CCCode again
            ddlCCCode.Items.Clear()
            'Me.udtSessionHandler.CCCodeRemoveFromSession(strFunctionCode, strCCCodeSessionName)
            isDiff = True
        Else
    ...
    Public Sub CleanSeesion(ByVal strFunctionCode As String)
        Me.udtSessionHandler.CCCodeRemoveFromSession(strFunctionCode)
    End Sub
    ...
    Public Function getCCCodeFromSession(ByVal intCCCodeIndex As Integer, ByVal strFunctionCode As String) As String
        ...
        Select Case intCCCodeIndex
            Case 1
                CCCode = Me.udtSessionHandler.CCCodeGetFormSession(strFunctionCode, BLL.SessionHandler.SessionName.SESS_CCCode1)
            Case 2
                CCCode = Me.udtSessionHandler.CCCodeGetFormSession(strFunctionCode, BLL.SessionHandler.SessionName.SESS_CCCode2)
            Case 3
                CCCode = Me.udtSessionHandler.CCCodeGetFormSession(strFunctionCode, BLL.SessionHandler.SessionName.SESS_CCCode3)
            Case 4
                CCCode = Me.udtSessionHandler.CCCodeGetFormSession(strFunctionCode, BLL.SessionHandler.SessionName.SESS_CCCode4)
            Case 5
                CCCode = Me.udtSessionHandler.CCCodeGetFormSession(strFunctionCode, BLL.SessionHandler.SessionName.SESS_CCCode5)
            Case 6
                CCCode = Me.udtSessionHandler.CCCodeGetFormSession(strFunctionCode, BLL.SessionHandler.SessionName.SESS_CCCode6)
        End Select
