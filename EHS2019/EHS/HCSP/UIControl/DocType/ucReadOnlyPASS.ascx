<%@ Control Language="vb" AutoEventWireup="false" CodeBehind="ucReadOnlyPASS.ascx.vb" Inherits="HCSP.ucReadOnlyPASS" %>
<asp:Panel ID="panReadonlyVerticalPASS" runat="server">
    ...
    <table id="tblPASS" runat="server" cellpadding="0" cellspacing="0">
        <tbody>
            <tr>
...
<asp:Panel ID="panReadonlyHorizontalPASS" runat="server">
