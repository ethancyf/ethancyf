<%@ Control Language="vb" AutoEventWireup="false" CodeBehind="ucReadOnlyROP140.ascx.vb" Inherits="HCSP.ucReadOnlyROP140" %>
<asp:Panel ID="panReadonlyVerticalROP140" runat="server">
    ...
    <table id="tblROP140" runat="server" cellpadding="0" cellspacing="0">
        <tbody>
            <tr>
            ...
            <tr>
                <td style="vertical-align:top" runat="server" id="cellReadonlyIssueDateText" class="tableCellStyle">
...
<asp:Panel ID="panReadonlyHorizontalROP140" runat="server">
        ...
        <tr>
            <td style="vertical-align:top" runat="server" id="cellReadonlyHorizontalNameText" class="tableCellStyleLite">
                <asp:Label ID="lblReadonlyHorizontalNameText" runat="server" CssClass="tableTitle"
                    Width="160px"></asp:Label></td>
            <td style="width: 300px;vertical-align:top" class="tableCellStyleLite">
        ...
        <tr>
            <td style="vertical-align:top;padding-bottom: 10px" runat="server" id="cellReadonlyHorizontalTravelDocNoText" class="tableCellStyleLite">
                <asp:Label ID="lblReadonlyHorizontalTravelDocNoText" runat="server" CssClass="tableTitle"
                    Width="160px"></asp:Label></td>
            <td style="padding-bottom: 10px; width: 300px;vertical-align:top" class="tableCellStyleLite">
                <asp:Label ID="lblReadonlyHorizontalTravelDocNo" runat="server" CssClass="tableText"
                    Width="300px"></asp:Label></td>
            <td style="vertical-align:top;padding-bottom: 10px" runat="server" id="cellReadonlyHorizontalIssueDateText" class="tableCellStyleLite">
