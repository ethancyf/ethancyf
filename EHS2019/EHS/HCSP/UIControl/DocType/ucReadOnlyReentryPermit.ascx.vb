...
Partial Public Class ucReadOnlyReentryPermit
    ...
    Protected Overrides Sub Setup(ByVal mode As ucInputDocTypeBase.BuildMode)
        ...
        Dim strDocumentTypeFullName As String = udtDocTypeModelList.Filter(DocTypeCode.REPMT).DocName(udtSessionHandler.Language)
        ...
        If MyBase.IsVertical Then
            ...
            Me.lblReadonlyIssueDate.Text = formatter.formatDOI(DocTypeCode.REPMT, MyBase.EHSAccountPersonalInfo.DateofIssue)
        ...
        Else
            ...
            Me.lblReadonlyHorizontalIssueDate.Text = formatter.formatDOI(DocTypeCode.REPMT, MyBase.EHSAccountPersonalInfo.DateofIssue)
            'Me.lblReadonlyHorizontalTravelDocNoText.Text = strDocumentTypeIdentityNoName
        End If

        '' Control the width of the table
        'tblREMPT.Rows(0).Cells(0).Width = MyBase.Width
