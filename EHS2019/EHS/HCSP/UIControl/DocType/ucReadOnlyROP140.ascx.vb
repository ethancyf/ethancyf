...
Public Class ucReadOnlyROP140
    ...
    Protected Overrides Sub Setup(ByVal mode As ucInputDocTypeBase.BuildMode)
        ...
        Dim strDocumentTypeFullName As String = udtDocTypeModelList.Filter(DocTypeCode.ROP140).DocName(udtSessionHandler.Language)
        ...
        If MyBase.IsVertical Then
            Me.panReadonlyVerticalROP140.Visible = True
            Me.panReadonlyHorizontalROP140.Visible = False
            ...
            Me.lblReadonlyTravelDocNo.Text = formatter.FormatDocIdentityNoForDisplay(DocTypeCode.ROP140, MyBase.EHSAccountPersonalInfo.IdentityNum, MyBase.MaskIdentityNumber)
        ...
        Else
            ...
            Me.panReadonlyVerticalROP140.Visible = False
            Me.panReadonlyHorizontalROP140.Visible = True
            ...
            Me.lblReadonlyHorizontalTravelDocNo.Text = formatter.FormatDocIdentityNoForDisplay(DocTypeCode.ROP140, MyBase.EHSAccountPersonalInfo.IdentityNum, MyBase.MaskIdentityNumber)
