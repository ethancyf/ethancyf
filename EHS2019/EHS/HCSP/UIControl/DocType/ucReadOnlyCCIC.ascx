<%@ Control Language="vb" AutoEventWireup="false" CodeBehind="ucReadOnlyCCIC.ascx.vb" Inherits="HCSP.ucReadOnlyCCIC" %>
<asp:Panel ID="panReadonlyVerticalCCIC" runat="server">
    ...
    <table id="tblCCIC" runat="server" cellpadding="0" cellspacing="0">
        <tbody>
            <tr>
...
<asp:Panel ID="panReadonlyHorizontalCCIC" runat="server">
