...
Public Class ucInputCCIC
    ...
    Protected Overrides Sub Setup(ByVal modeType As ucInputDocTypeBase.BuildMode)
        ...
        Me._strTDNumber = MyBase.Formatter.FormatDocIdentityNoForDisplay(DocTypeCode.CCIC, MyBase.EHSPersonalInfo.IdentityNum, False)
        ...
        If MyBase.EHSPersonalInfo.DateofIssue.HasValue Then
            Me._strDOI = MyBase.Formatter.formatHKIDIssueDate(MyBase.EHSPersonalInfo.DateofIssue)
        Else
