<%@ Control Language="vb" AutoEventWireup="false" CodeBehind="ucInputCOVID19MEC.ascx.vb" Inherits="HCSP.ucInputCOVID19MEC" %>
...
<table style="border:0px;padding:0px;border-spacing:0px;border-collapse:collapse">
    ...
    <tr>
        <td style="width:205px;vertical-align:top">
            <asp:Label ID="lblP1MedicalReasonText" runat="server" CssClass="tableTitle" Height="25px" Width="160px" Text ="<%$ Resources:Text, MedicalReason%>" />
        </td>
            ...
            <table style="border:0px;padding:0px;border-spacing:0px;border-collapse:collapse">
                <tr>
                    <td style="vertical-align:top">
                        ...
                        <table style="width:680px;position:relative;top:-3px;left:-5px;font-size:16px">
                            <tr>
                                <td style="width:10px;vertical-align:top">
                                    <asp:checkbox ID="chkP1ProceedToPart2" AutoPostBack ="false" runat="server" style="position:relative;left:0px" 
                                        Text ="" onclientclick="" /> 
                                </td>
                                <td style="vertical-align:middle">     
                                    <asp:Label ID="lblP1ProceedToPart2" runat="server" AssociatedControlID ="chkP1ProceedToPart2" style="position:relative;left:0px;top:0px;font-size:16px"
...
<%--    <tr>
    ...
    <tr id="trP2MedicalReasonBioNTech" runat="server">
        <td style="width:205px;vertical-align:top">
            <asp:Label ID="lblP2MedicalReasonBioNTechText" runat="server" CssClass="tableTitle" Height="25px" Width="160px" Text ="<%$ Resources:Text, MedicalReason%>" />
        </td>
        <td style="vertical-align:top">
            <table style="border:0px;padding:0px;border-spacing:0px;border-collapse:collapse">
                <tr>
    ...
    <tr id="trP2MedicalReasonSinovac" runat="server">
        <td style="width:205px;vertical-align:top">
            <asp:Label ID="lblP2MedicalReasonSinovacText" runat="server" CssClass="tableTitle" Height="25px" Width="160px" Text ="<%$ Resources:Text, MedicalReason%>" />
        </td>
        <td style="vertical-align:top">
            <table style="border:0px;padding:0px;border-spacing:0px;border-collapse:collapse">
                <tr>
                ...
                <tr>
                    <td style="vertical-align: top; padding-left: 0px">
                        <asp:TextBox ID="txtValidUntil" runat="server" Width="100px" Height="16" 
                            ...
                            onblur="filterDateInput(this);" style="position:relative;left:-4px;top:-1px" />
                        <cc2:CalendarExtender runat="server" ID="ceValidUntil" CssClass="ajax_cal" PopupPosition="BottomLeft" TargetControlID="txtValidUntil"
                            ...
                            OnClientShown ="MECValidUntilCalendarShown" OnClientHidden="MECValidUntilCalendarHidden"
                            />
