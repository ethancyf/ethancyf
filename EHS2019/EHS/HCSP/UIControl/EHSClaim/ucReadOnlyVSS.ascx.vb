...
#Region "Must Override Function"
    ...
    Protected Overrides Sub RenderLanguage()
        ...
        lblContactNoText.Text = Me.GetGlobalResourceObject("Text", "ContactNo2")
        lblRemarksText.Text = Me.GetGlobalResourceObject("Text", "Remarks")
    ...
    Protected Overrides Sub Setup()
        ...
        'ContactNo
        Dim strContactNo As String = MyBase.EHSTransaction.TransactionAdditionFields.ContactNo
        If strContactNo IsNot Nothing AndAlso strContactNo <> String.Empty Then
            ...
            If MyBase.ShowSMSWarning = True Then
        ...
        'Remarks
        Dim strRemarks As String = MyBase.EHSTransaction.TransactionAdditionFields.Remarks
