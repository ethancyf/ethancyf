...
Partial Public Class ucInputCOVID19MEC
    ...
    Dim _udtSubPlatformBLL As New SubPlatformBLL
    ...
    Public Function Validate(ByVal blnShowErrorImage As Boolean, ByVal objMsgBox As CustomControls.MessageBox) As Boolean
        ...
        If blnValid Then
            ...
            If rgx.IsMatch(Me.txtValidUntil.Text) Then
                'Format: dd-MMM-yyyy
                strValidUntilDate = _udtFormatter.formatInputDateDDMMMYYYY(Me.txtValidUntil.Text, _udtSubPlatformBLL.GetDateFormatLocale())
            ...
            Else
                'Format: dd-MM-yyyy
                strValidUntilDate = _udtFormatter.formatInputDate(Me.txtValidUntil.Text, _udtSubPlatformBLL.GetDateFormatLocale())
...
#Region "Save"
    ...
    Public Sub Save(ByRef udtEHSTransaction As EHSTransactionModel)
        ...
        Else
            ...
            strValidUntil = _udtFormatter.formatInputDate(Me.txtValidUntil.Text, udtSubPlatformBLL.GetDateFormatLocale())
