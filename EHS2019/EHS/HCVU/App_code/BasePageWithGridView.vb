...
Public MustInherit Class BasePageWithGridView
    ...
    Public Sub GridViewDataBind(ByRef gvSort As GridView, ByRef dt As Object, ByVal strSortExpression As String, ByVal strSortDirection As String, ByVal blnKeepPageIndex As Boolean, Optional intPageSize As Nullable(Of Integer) = Nothing)
        ...
        gvSort.PageSize = (New GeneralFunction).GetPageSizeHCVU()

        If intPageSize.HasValue Then
            gvSort.PageSize = intPageSize.Value
        End If
    ...
    Private Sub SetPageInfo(ByRef gvSort As GridView, ByVal strDataSource As String)
        If gvSort.Rows.Count > 0 Then
            ...
            lblPageInfo.Style.Add("white-space", "nowrap")
