            ...
            <td align="center" >
                ...
                <table width = "200px" id="tbCCCode" runat="server">
                    <tbody>
                        <tr >
                            <td>
                                <asp:DropDownList ID="ddlCCCode1" runat="server" Width="50px" CssClass="TextChineseName" Font-Size="18px">
                                </asp:DropDownList>
            
                                <asp:DropDownList ID="ddlCCCode2" runat="server" Width="50px" CssClass="TextChineseName" Font-Size="18px">
                                </asp:DropDownList>
               
                                <asp:DropDownList ID="ddlCCCode3" runat="server" Width="50px" CssClass="TextChineseName" Font-Size="18px">
                                </asp:DropDownList>
                           
                                <asp:DropDownList ID="ddlCCCode4" runat="server" Width="50px" CssClass="TextChineseName" Font-Size="18px">
                                </asp:DropDownList>
                            
                                <asp:DropDownList ID="ddlCCCode5" runat="server" Width="50px" CssClass="TextChineseName" Font-Size="18px">
                                </asp:DropDownList>
                          
                                <asp:DropDownList ID="ddlCCCode6" runat="server" Width="50px" CssClass="TextChineseName" Font-Size="18px">
                                </asp:DropDownList>
                            </td>
                       </tr>
                    </tbody>
