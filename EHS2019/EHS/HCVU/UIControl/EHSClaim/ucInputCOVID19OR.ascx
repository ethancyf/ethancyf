<%@ Control Language="vb" AutoEventWireup="false" CodeBehind="ucInputCOVID19OR.ascx.vb" Inherits="HCVU.ucInputCOVID19OR" %>
...
<asp:Panel ID="panCOVID19Detail" runat="server">
    <table style="border:0px;padding:0px;border-spacing:0px;border-collapse:collapse">
        ...
        <tr>
            <td style="width:205px;vertical-align:top">
                <asp:Label ID="lblCMainCategoryText" runat="server" Height="25px" Text ="<%$ Resources:Text, Category%>" />
                <asp:Imagebutton ID="imgCCategoryInfo" runat="server" AlternateText="<%$ Resources:Text, Category%>" ImageAlign="Top" 
                    ImageUrl="<%$ Resources:ImageUrl, Infobtn %>" style="position:relative;top:0px" OnClientClick="" visible="false" />
            </td>
            <td style="vertical-align:top">
                <table style="border:0px;padding:0px;border-spacing:0px;border-collapse:collapse">
                    <tr>
                        <td style="vertical-align:top">
                            <asp:dropdownlist ID="ddlCMainCategory" runat="server" CssClass="selectpicker1" AutoPostBack="true" Style="width:660px;position:relative;top:-3px;left:-6px" />
        ...
        <tr>
            ...
            <td style="vertical-align:top">
                <table style="border:0px;padding:0px;border-spacing:0px;border-collapse:collapse">
                    <tr>
                        <td style="vertical-align:top">
                            <asp:dropdownlist ID="ddlCSubCategory" runat="server" CssClass="selectpicker2" AutoPostBack="false" Style="width:660px;position:relative;top:-3px;left:-6px" />
        ...
        <tr>
            ...
            <td style="vertical-align:top">
                <table style="border:0px;padding:0px;border-spacing:0px;border-collapse:collapse">
                    <tr>
                        <td style="vertical-align:top">
                            <asp:dropdownlist ID="ddlCDoseCovid19" runat="server" AutoPostBack="false" Style="width:300px;position:relative;top:-3px;left:-6px" />
                        </td>
                        <td style="vertical-align:top">
        ...
        <tr id="trCContactNo" runat="server">
            ...
            <td style="height:25px;vertical-align:top">
                ...
                <asp:Label ID="lblStep2aContactNoRecommendation" runat="server" Text="<%$ Resources:Text, ProvideContactNoWithSMS%>" style="font-size:14px;top:-2px" />
        ...
        <tr>
            ...
            <td style="height:25px;vertical-align:top;padding-bottom:5px">
                <asp:textbox ID="txtCRemark" runat="server" MaxLength="200" style="position:relative;left:-6px" Width="660px"/>
        ...
        <tr id="trJoinEHRSS" runat="server">
            ...
            <td style="height:25px;vertical-align:top;padding-bottom:5px">
                <asp:checkbox ID="chkCJoinEHRSS" runat="server" AutoPostBack="false" style="position:relative;left:-10px"/>
            </td>
        </tr>
        <tr id="trNonLocalRecoveredHistory" runat="server">
            ...
            <td style="height:25px;vertical-align:top;padding-bottom:5px">
                <asp:checkbox ID="chkCNonLocalRecoveredHistory" runat="server" AutoPostBack="false" style="position:relative;left:-10px"/>
            </td>
        </tr>
    </table>
</asp:Panel>
