<%@ Control Language="vb" AutoEventWireup="false" CodeBehind="ucInputHSIVSS.ascx.vb" Inherits="HCVU.ucInputHSIVSS" %>
...
<asp:Panel ID="panPreConditions" runat="server">
 <table border="0" cellpadding="0" cellspacing="0">
    <tr>
        <td style="width: 200px" valign="top"> <asp:Label ID="lblPreConditionsText" runat="server" CssClass="tableTitle" Width="160px"
                    Height="25px"></asp:Label>
        </td>
        <td><asp:DropDownList ID="ddlPreConditionSelection" runat="server"></asp:DropDownList>
        <asp:Image ID="imgPreConditionsError" runat="server" AlternateText="<%$ Resources:AlternateText, ErrorBtn%>" ImageAlign="Top" ImageUrl="<%$ Resources:ImageUrl, ErrorBtn%>" Visible="false" />
        </td>
    </tr>
 </table>
</asp:Panel>
