    ...
    Protected Overrides Sub Setup(ByVal blnPostbackRebuild As Boolean)
        ...
        If Not noCategory Then
            ...
            If dtVaccineLotNo.Rows.Count > 0 Then
                ...
                'jsBindingddlCVaccineLotNoCovid19 += "var $lotNo = $(""[id$='ddlCVaccineLotNoCovid19']"");"
                ''When the ddlCVaccineBrandCovid19 is changed, it focus to rerender the ddlCVaccineLotNoCovid19.
                'jsBindingddlCVaccineLotNoCovid19 += "$(""[id$='ddlCVaccineBrandCovid19']"").change(function () {"
                ...
                'jsBindingddlCVaccineLotNoCovid19 += "});"
                'ScriptManager.RegisterStartupScript(Me, Me.GetType(), "script", jsBindingddlCVaccineLotNoCovid19, True)
