    ...
    <table style="border-collapse: collapse; border-spacing:0px">
          <tr id="trDocumentaryProof" runat="server">
                ...
                <td style="vertical-align:top;padding: 0px 0px 0px 0px;">
                      ...
                      <asp:DropDownList ID="ddlDocumentaryProof" runat="server" Width="430px" AutoPostBack="true" Visible="false" Style="position:relative;left:-7px"></asp:DropDownList>
                </td>   
    ...
    <asp:Panel ID="panVSSDAConfirm" runat="server" visible="false" >
        <table border="0"  style="border-collapse: collapse; border-spacing:0px">
            <tr id="tr1" runat="server">
                <td class="tableCellStyle" style="vertical-align:top ; width: 197px; height: 22px;">
                    &nbsp;
                </td>
                <td style="vertical-align:top;padding: 0px 0px 0px 0px;">
                    <table border="0" style="border-collapse: collapse; border-spacing:0px">
