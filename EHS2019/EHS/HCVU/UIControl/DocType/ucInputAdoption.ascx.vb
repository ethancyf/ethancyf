...
Partial Public Class ucInputAdoption
    ...
    Protected Overrides Sub RenderLanguage(ByVal strErrorImageURL As String, ByVal strErrorImageALT As String)
        ...
        If Session("Language").ToString().ToUpper.Equals(Common.Component.CultureLanguage.TradChinese) Then
            ...
            Me.lblNoOfEntryOriginalText.Text = udtDocTypeModelList.Filter(DocTypeCode.ADOPC).DocIdentityDescChi
        Else
            strDocumentTypeFullName = udtDocTypeModelList.Filter(DocTypeCode.ADOPC).DocName
            Me.lblNoOfEntryOriginalText.Text = udtDocTypeModelList.Filter(DocTypeCode.ADOPC).DocIdentityDesc
        End If
        'lblDocumentType.Text = strDocumentTypeFullName
        lblDocumentTypeOriginal.Text = strDocumentTypeFullName


        ' -------------------------- Creation / Modification One Side Mode------------------------------
        If Session("Language").ToString().ToUpper.Equals(Common.Component.CultureLanguage.TradChinese) Then
            Me.lblNewNoOfEntryText.Text = udtDocTypeModelList.Filter(DocTypeCode.ADOPC).DocIdentityDescChi
        Else
            Me.lblNewNoOfEntryText.Text = udtDocTypeModelList.Filter(DocTypeCode.ADOPC).DocIdentityDesc
        End If
        ...
        'error message
        Me.imgNewNoOfEntryErr.ImageUrl = strErrorImageURL
        Me.imgNewNoOfEntryErr.AlternateText = strErrorImageALT
    ...
    Protected Overrides Sub Setup(ByVal mode As BuildMode)
        ...
        If Me.Mode = BuildMode.Creation Then
            ...
            If Not IsNothing(MyBase.EHSPersonalInfoAmend) Then
                ...
                Me._strIdentityNo = MyBase.EHSPersonalInfoAmend.IdentityNum
                ...
                Me.txtNewNoOfEntry.Enabled = False
        ...
        ElseIf Me.Mode = BuildMode.Modification_OneSide Then
            ...
            '--------------------------------------------------------
            Me.pnlNew.Visible = True
            Me.lblEntryNo_ModifyOneSide.Visible = True
            Me.txtNewPrefix.Visible = False
            Me.lblNewSymbol.Visible = False
            Me.txtNewNoOfEntry.Visible = False
    ...
    Private Sub ChangeDOBOption(ByVal enable As Boolean)
        'Enable (Whether the radio button for DOB is checked)
        If enable Then
            If Me.Mode = BuildMode.Creation Then
                Me.txtNewDOB.Enabled = True
...
#Region "Set Up Text Box Value"
    ...
    Public Sub SetEntryNo()

        If Mode = BuildMode.Creation Then
            Me.txtNewPrefix.Text = Me._strPrefixNo
            Me.txtNewNoOfEntry.Text = Me._strIdentityNo

        ElseIf Mode = BuildMode.Modification_OneSide Then
            Me.txtNewPrefix.Text = String.Empty
            Me.txtNewNoOfEntry.Text = String.Empty
            Me.lblEntryNo_ModifyOneSide.Text = MyBase.Formatter.FormatDocIdentityNoForDisplay(DocTypeCode.ADOPC, MyBase.EHSPersonalInfoOriginal.IdentityNum, False, MyBase.EHSPersonalInfoOriginal.AdoptionPrefixNum)

        Else
            'Amend
            Me.lblEntryNo.Text = Me._strIdentityNo
            Me.txtPerfixNo.Text = Me._strPrefixNo

            'Original
            Me.lblNoOfEntryOriginal.Text = MyBase.Formatter.FormatDocIdentityNoForDisplay(DocTypeCode.ADOPC, MyBase.EHSPersonalInfoOriginal.IdentityNum, False, MyBase.EHSPersonalInfoOriginal.AdoptionPrefixNum)
        End If
    ...
    Public Sub SetDOB()
        ...
        Else
            ...
            'Original Record
            lblDOBOriginal.Text = MyBase.Formatter.formatDOB(MyBase.EHSPersonalInfoOriginal.DOB, MyBase.EHSPersonalInfoOriginal.ExactDOB, String.Empty, Nothing, Nothing)

            If MyBase.EHSPersonalInfoOriginal.ExactDOB.Trim = "T" _
                    OrElse MyBase.EHSPersonalInfoOriginal.ExactDOB.Trim = "U" _
                    OrElse MyBase.EHSPersonalInfoOriginal.ExactDOB.Trim = "V" Then
                Dim udtStaticData As StaticDataModel = udtStaticDataBLL.GetStaticDataByColumnNameItemNo("DOBInWordType", MyBase.EHSPersonalInfoOriginal.OtherInfo.Trim)

                lblDOBOriginal.Text = udtStaticData.DataValue.ToString.Trim + " " + lblDOBOriginal.Text
            End If
        End If
...
#Region "Set Up Error Image"
    ...
    Public Sub SetEntryNoError(ByVal blnVisible As Boolean)
        ...
        If Me.Mode = BuildMode.Creation Or Me.Mode = BuildMode.Modification_OneSide Then
            Me.imgNewNoOfEntryErr.Visible = blnVisible
        Else
    ...
    Public Sub SetDOBInWordError(ByVal blnVisible As Boolean)
        If Me.Mode = BuildMode.Creation Or Me.Mode = BuildMode.Modification_OneSide Then
            Me.imgNewDOBInWordErr.Visible = blnVisible
        Else
            Me.imgDOBInWordError.Visible = blnVisible
        End If
    ...
    Public Sub SetDOBError(ByVal blnVisible As Boolean)
        ...
        Else
            Me.imgDOBError.Visible = blnVisible
        End If
...
#Region "Property"
    ...
    Public Overrides Sub SetProperty(ByVal mode As BuildMode)
        ...
        If mode = BuildMode.Creation Or mode = BuildMode.Modification_OneSide Then
            ...
            If mode = BuildMode.Creation Then
                Me._strPrefixNo = Me.txtNewPrefix.Text.Trim
                Me._strIdentityNo = Me.txtNewNoOfEntry.Text.Trim
            ElseIf mode = BuildMode.Modification_OneSide Then
                Me._strPrefixNo = MyBase.EHSPersonalInfoOriginal.AdoptionPrefixNum
                Me._strIdentityNo = MyBase.EHSPersonalInfoOriginal.IdentityNum
            End If
