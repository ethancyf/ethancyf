<%@ Control Language="vb" AutoEventWireup="false" CodeBehind="ucReadOnlyISSHK.ascx.vb" Inherits="HCVU.ucReadOnlyISSHK" %>
<asp:MultiView ID="MultiViewISSHK" runat="server">
