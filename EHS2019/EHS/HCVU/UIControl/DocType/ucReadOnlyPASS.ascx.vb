...
#End Region
    ...
    Public Sub Build(ByVal udtEHSPersonalInformation As EHSPersonalInformationModel, ByVal blnMaskTravelDocNo As Boolean, ByVal blnVertical As Boolean, ByVal intWidth As Integer, ByVal intWidth2 As Integer, Optional ByVal blnAlternateRow As Boolean = False)
        If blnVertical Then
            MultiViewPASS.ActiveViewIndex = ViewIndex.Vertical

            ' Document Type 
            lblVDocumentType.Text = udtDocTypeBLL.getAllDocType().Filter(DocTypeCode.PASS).DocName

            ' Travel Document No.
            lblVTravelDocNo.Text = udtFormatter.FormatDocIdentityNoForDisplay(DocTypeCode.PASS, udtEHSPersonalInformation.IdentityNum, blnMaskTravelDocNo)
            ...
            ' Date of Issue
            'lblVDateOfIssue.Text = udtFormatter.formatDOI(DocTypeCode.PASS, udtEHSPersonalInformation.DateofIssue)
        ...
        Else
            ...
            ' Document Type 
            lblHDocumentType.Text = udtDocTypeBLL.getAllDocType().Filter(DocTypeCode.PASS).DocName
