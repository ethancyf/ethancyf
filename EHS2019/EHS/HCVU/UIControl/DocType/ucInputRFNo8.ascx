<%@ Control Language="vb" AutoEventWireup="false" Codebehind="ucInputRFNo8.ascx.vb"
    Inherits="HCVU.ucInputRFNo8" %>
    ...
    <table>
        <tr>
            ...
            <td style="width: 470px;">
                ...
                <asp:Label ID="lblNewDocNo_ModifyOneSide" runat="server"  Visible="False" CssClass="tableText"></asp:Label>  <asp:Image
