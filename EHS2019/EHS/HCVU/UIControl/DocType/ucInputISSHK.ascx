<%@ Control Language="vb" AutoEventWireup="false" CodeBehind="ucInputISSHK.ascx.vb" Inherits="HCVU.ucInputISSHK" %>
            ...
            <td valign="top">
                <table>
                    ...
                    <tr>
                        ...
                        <td style="width: 350px">
                            <asp:TextBox ID="txtTDNo" runat="server" MaxLength="20" onChange="convertToUpper(this);"
                    ...
                    <tr>
                        ...
                        <td style="width: 350px">
                            <asp:TextBox ID="txtENameSurname" runat="server" MaxLength="80" onChange="convertToUpper(this);"
                                Width="105px"></asp:TextBox><asp:Label ID="lblENameComma" runat="server" CssClass="largeText"></asp:Label>
                            <asp:TextBox ID="txtENameFirstname" runat="server" MaxLength="80" onChange="convertToUpper(this);"></asp:TextBox>
    ...
    <table>
        <tr>
            ...
            <td style="width: 470px">
                ...
                <asp:TextBox ID="txtNewTravelDocNo" runat="server" MaxLength="20" onChange="convertToUpper(this);"
        ...
        <tr>
            ...
            <td style="width: 470px;">
                <table border="0" cellpadding="0" cellspacing="0">
                    <tr>
                        <td>
                            <asp:TextBox ID="txtNewSurname" runat="server" MaxLength="80" onChange="convertToUpper(this);"
                                Width="105px"></asp:TextBox></td>
                        <td>
                            <asp:Label ID="lblNewEnameComma" runat="server" CssClass="tableText"></asp:Label>&nbsp;</td>
                        <td>
                            <asp:TextBox ID="txtNewGivenName" runat="server" MaxLength="80" onChange="convertToUpper(this);"></asp:TextBox></td>
                        <td>
