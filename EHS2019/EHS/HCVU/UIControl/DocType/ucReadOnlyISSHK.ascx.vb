...
#End Region
    ...
    Public Sub Build(ByVal udtEHSPersonalInformation As EHSPersonalInformationModel, ByVal blnMaskTravelDocNo As Boolean, ByVal blnVertical As Boolean, ByVal intWidth As Integer, ByVal intWidth2 As Integer, Optional ByVal blnAlternateRow As Boolean = False)
        If blnVertical Then
            MultiViewISSHK.ActiveViewIndex = ViewIndex.Vertical

            ' Document Type 
            lblVDocumentType.Text = udtDocTypeBLL.getAllDocType().Filter(udtEHSPersonalInformation.DocCode).DocName

            ' Travel Document No.
            lblVTravelDocNo.Text = udtFormatter.FormatDocIdentityNoForDisplay(udtEHSPersonalInformation.DocCode, udtEHSPersonalInformation.IdentityNum, blnMaskTravelDocNo)
            ...
            ' Date of Issue
            'lblVDateOfIssue.Text = udtFormatter.formatDOI(udtEHSPersonalInformation.DocCode, udtEHSPersonalInformation.DateofIssue)
        ...
        Else
            MultiViewISSHK.ActiveViewIndex = ViewIndex.Horizontal
            ...
            ' Travel Document No.
            lblHTravelDocNo.Text = udtFormatter.FormatDocIdentityNoForDisplay(udtEHSPersonalInformation.DocCode, udtEHSPersonalInformation.IdentityNum, blnMaskTravelDocNo)

            ' Date of Issue
            'lblHDateOfIssue.Text = udtFormatter.formatDOI(udtEHSPersonalInformation.DocCode, udtEHSPersonalInformation.DateofIssue)
