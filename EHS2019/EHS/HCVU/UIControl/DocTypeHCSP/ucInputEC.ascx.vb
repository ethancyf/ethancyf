        ...
        Private Sub SetupFieldsStatus(ByVal modeType As ucInputDocTypeBase.BuildMode)
            ...
            Else
                ...
                If modeType = ucInputDocTypeBase.BuildMode.ModifyReadOnly Then
                    Me.txtECHKICModification.Enabled = False
                ...
                Else
                    Me.txtECHKICModification.Enabled = True
                    Me.txtECSerialNo.Enabled = True
...
#Region "Property"
        ...
        Public Property DOBField() As String
            Get
                Return Me.txtDOBDate_M.Text.Trim
            End Get
            Set(ByVal value As String)
                Me.txtDOBDate_M.Text = value
            End Set
        End Property

        Public Property DOBTypeSelected() As Boolean
            Get
                Return Me._blnDOBTypeSelected
            End Get
            Set(ByVal value As Boolean)
                Me._blnDOBTypeSelected = value
            End Set
        End Property
