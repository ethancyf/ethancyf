<%@ Page Language="vb" AutoEventWireup="false" CodeBehind="SPlogin.aspx.vb" Inherits="HCVU.SPlogin" %>
                        ...
                        <asp:UpdatePanel ID="UpdatePanel" runat="server">
                            <ContentTemplate>
                                ...
                                <table style="background-position: center center; background-image: url(Images/login/login_background.jpg); width: 750px; background-repeat: no-repeat; height: 280px"
                                            ...
                                            <table style="width: 100%" border="0">
                                                <tr>
                                                    <td align="left" style="padding-left:250px">
                                                        <asp:Label ID="lblReprintVaccinationRecord" runat="server" CssClass="loginTitleText" style="font-size:24px;position:relative;top:-10px" Text="Reprint Vaccination Record"></asp:Label>
                                                    </td>
                                                </tr>
                                            </table>
                                        </td>
                                    ...
                                    <tr>
                                        <td style="width: 125px" rowspan="5"></td>
                                        <td id="tdAccTypeText" runat="server" style="width: 157px"  class="loginLableText" valign="top">
                                            <asp:Label ID="lblRoleText" runat="server" CssClass="loginLableText" Text="Account Type"></asp:Label>
                                        </td>
                                        <td id="tdAccType" style="width: 480px" runat="server" colspan="2" valign="top">
                                            <asp:RadioButtonList ID="rbLoginRole" runat="server" AutoPostBack="True" RepeatDirection="Horizontal"
                                                TabIndex="1" CellPadding="0" CellSpacing="0" CssClass="tableTitle" Width="305px" OnSelectedIndexChanged="rbLoginRole_SelectedIndexChanged">
                                    ...
                                    <tr id="trSPUsername" runat="server">
                                    ...
                                    <tr id="trSPPassword" runat="server">
                                        <td class="loginLableText" align="left">
                                    ...
                                    <tr  id="trSPPinCode" runat="server">
                                        <td class="loginLableText" align="left">
                                    ...
                                    <tr id="trDEUsername" runat="server" visible ="false">
                                        <td class="loginLableText" align="left">
                                            <asp:Label ID="lblDEUsername" runat="server" Text="Username" CssClass="loginLableText"></asp:Label></td>
                                        <td align="left">
                                            <asp:TextBox ID="txtDEUsername" runat="server" CssClass="loginLableText" Width="200px" onblur="convertToUpper(this)" MaxLength="20" TabIndex="1"></asp:TextBox>
                                            <asp:Image ID="imgDEUsernameAlert" runat="server" Visible="false" ImageUrl="~/Images/others/icon_caution.gif" Style="position: absolute" AlternateText="<%$ Resources:AlternateText, ErrorImg %>" />
                                        </td>
                                        <td rowspan="3">
                                            <table width="217px" height="104" cellpadding="0" cellspacing="0" border="0">
                                                <tr>
                                                    <td>
                                                        &nbsp;
                                                    </td>
                                    ...
                                    <tr id="trDEPassword" runat="server" visible ="false">
                                        <td class="loginLableText" align="left">
                                            <asp:Label ID="lblDEPassword" runat="server" Text="<%$Resources:Text, Password%>" CssClass="loginLableText"></asp:Label></td>
                                        <td align="left">
                                            <asp:TextBox ID="txtDEPassword" runat="server" TextMode="Password" CssClass="loginLableText" Width="200px" MaxLength="20" TabIndex="2"></asp:TextBox>
                                            <asp:Image ID="imgDEPasswordAlert" runat="server" Visible="false" ImageUrl="~/Images/others/icon_caution.gif" Style="position: absolute" AlternateText="<%$ Resources:AlternateText, ErrorImg %>" />
                                        </td>
                                    </tr>
                                    <tr  id="trDESPUsername" runat="server" visible ="false">
                                        <td class="loginLableText" align="left">
                                            <asp:Label ID="lblDESPUsername" runat="server" Text="Service Provider ID / Username" CssClass="loginLableText"></asp:Label></td>
                                        <td align="left" style="vertical-align:middle">
                                            <asp:TextBox ID="txtDESPUsername" runat="server" CssClass="loginLableText" Width="200px" MaxLength="20" TabIndex="3"></asp:TextBox>
                                            <asp:Image ID="imgDESPUsernameAlert" runat="server" Visible="false" ImageUrl="~/Images/others/icon_caution.gif" Style="position: absolute" AlternateText="<%$ Resources:AlternateText, ErrorImg %>" />
                                        </td>
                                    </tr>
                                    <tr>
                                        ...
                                        <td style="height: 30px" align="left">
                                            ...
                                            <asp:ImageButton ID="btnExit" runat="server" ImageUrl="~/Images/button/btn_exit.png" AlternateText="Exit" OnClientClick="javascript:window.opener='X';window.open('','_parent','');window.close(); return false;" />
                                        </td>
                                        <td>&nbsp;</td>                                      
                                    </tr>
                                </table>
