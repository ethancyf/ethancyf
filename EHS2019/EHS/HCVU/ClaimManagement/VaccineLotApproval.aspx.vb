...
Partial Public Class VaccineLotApproval
...
#Region "Fields"
    ...
    Private Const SESS_SearchResultList As String = FunctCode.FUNT010423 & "VaccineLotList_SearchResultList"
    Private Const SESS_VaccineLotListModal As String = FunctCode.FUNT010423 & "VaccineLotList_Modal"
#End Region
...
#End Region
    ...
    Protected Sub Page_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Load
        ...
        If Not Page.IsPostBack Then
            FunctionCode = FunctCode.FUNT010423
            ...
            If centreDataTable IsNot Nothing AndAlso centreDataTable.Rows.Count > 0 Then
                ddlVaccCentre.Items.Clear()
                ddlVaccCentre.DataSource = centreDataTable
                ddlVaccCentre.DataTextField = "Centre_Name"
                ddlVaccCentre.DataValueField = "Centre_ID"
                ddlVaccCentre.DataBind()

                If centreDataTable.Rows.Count > 1 Then
                    ddlVaccCentre.Items.Insert(0, New ListItem(Me.GetGlobalResourceObject("Text", "Any"), ""))
                    ddlVaccCentre.SelectedIndex = 0
                Else
                    ddlVaccCentre.SelectedIndex = 0
...
#End Region
    ...
    Protected Sub ibtnSearch_Click(ByVal sender As System.Object, ByVal e As System.Web.UI.ImageClickEventArgs)
        ...
        Try
            ' Write Audit Log
            udtAuditLogEntry.AddDescripton("Vaccine Centre ID", ddlVaccCentre.SelectedValue)
            udtAuditLogEntry.WriteStartLog(LogID.LOG00001, AuditMsg00001)
    ...
    Private Sub FillSearchCriteria()
        If ddlVaccCentre.SelectedValue.Trim.Equals(String.Empty) Then
            lblResultCentreNo.Text = Me.GetGlobalResourceObject("Text", "Any")
        Else
            lblResultCentreNo.Text = ddlVaccCentre.SelectedItem.Text.Trim
        End If
    ...
    Private Sub BindVaccineLotDetail(ByVal udtVaccineLotList As VaccineLotRequestModel)
        ...
        lblDetailVaccineCentre.Text = udtVaccineLotList.CentreName
...
#End Region
    ...
    Private Sub ResetSearchCriteria()
        ...
        ddlVaccCentre.SelectedValue = String.Empty
    ...
    Private Sub gvResult_RowDataBound(ByVal sender As Object, ByVal e As System.Web.UI.WebControls.GridViewRowEventArgs) Handles gvResult.RowDataBound
        If e.Row.RowType = DataControlRowType.DataRow Then
            ...
            Dim udtStaticDataBLL As StaticData.StaticDataBLL = New StaticData.StaticDataBLL
            Dim udtStaticDataModel As StaticData.StaticDataModel
            Dim lblVLBooth As Label = CType(e.Row.FindControl("lblVLBooth"), Label)

            Dim strBoothID As String() = lblVLBooth.Text.Split(",")
            Dim strBoothName As String = String.Empty
            Dim strBoothValue As String = String.Empty

            For i As Integer = 0 To strBoothID.Length - 1
                udtStaticDataModel = udtStaticDataBLL.GetStaticDataByColumnNameItemNo("VaccineCentreBooth", strBoothID(i).Trim)
                strBoothValue = strBoothID(i).Trim
                strBoothName += strBoothValue.Replace(strBoothID(i).Trim, udtStaticDataModel.DataValue.ToString.Trim()) + ","

            Next
            strBoothName = strBoothName.Remove(strBoothName.Length - 1)
            lblVLBooth.Text = strBoothName
        End If
