            ...
            Case Aspect.ServiceProvider
                ...
                If Not blnTextFieldInputted Then
                    If Not blnSPTextFieldInputted And Not blnDateTextFieldInputted Then 'No Date and any SP criteria input
                        udtSystemMessage = New SystemMessage("990000", SeverityCode.SEVE, MsgCode.MSG00478)
                    ElseIf Not blnSPTextFieldInputted And blnDateTextFieldInputted Then 'Date has input but haven't any SP criteria
                        udtSystemMessage = New SystemMessage("990000", SeverityCode.SEVE, MsgCode.MSG00480)
                    Else
                        udtSystemMessage = New SystemMessage("990000", SeverityCode.SEVE, MsgCode.MSG00481) 'Any SP criteria has input but haven't Date input
                    End If
