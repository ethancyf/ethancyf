<%@ Page Language="vb" AutoEventWireup="false" MasterPageFile="~/MasterPage.Master"
    CodeBehind="PrivateClinicalVaccineLotManagement.aspx.vb" Inherits="HCVU.PrivateClinicalVaccineLotManagement" Title="<%$ Resources:Title, VaccineLotManagement %>" %>
    ...
    <asp:UpdatePanel ID="UpdatePanel1" runat="server">
        <ContentTemplate>
            <table style="width: 100%">
                <tr>
                    <td>
                        <asp:Image ID="imgHeader" runat="server" AlternateText="<%$ Resources:AlternateText, PrivateClinicalVaccineLotManagementBanner %>"
                            ImageUrl="<%$ Resources:ImageUrl, PrivateClinicalVaccineLotManagementBanner %>" /></td>
                </tr>
            </table>
            ...
            <asp:Panel ID="pnlEnquiry" runat="server">
                <asp:MultiView ID="MultiViewEnquiry" runat="server" ActiveViewIndex="0">
                    <asp:View ID="ViewSummary" runat="server">
                        ...
                        <table>
                            <tr style="height: 25px;">
                                <td style="width: 80px">
                                    <asp:Label ID="lblSearchVaccScheme" runat="server" Text="<%$ Resources:Text, Scheme %>"></asp:Label></td>
                                <td style="width: 350px">

                                    <asp:DropDownList ID="ddlSearchVaccScheme" runat="server" AppendDataBoundItems="True" AutoPostBack="True" OnSelectedIndexChanged="ddlSearchVaccScheme_SelectedIndexChanged">
                                    </asp:DropDownList>
                                </td>
                            </tr>
                        </table>
                        ...
                        <table>
                               <tr>
                                <td style="padding-top: 15px;">
                                    <asp:ImageButton ID="btnAssign" runat="server" ImageUrl="<%$ Resources:ImageUrl, AssignBtn %>"
                                        AlternateText="<%$ Resources:AlternateText, AssignBtn %>" OnClick="ibtnAssign_Click" />
                                </td>
                              <%--  <td style="padding-top: 15px;">
                        ...
                        <table style="width: 100%; padding-left: 22px" cellpadding="1" cellspacing="0">
                            <tr>
                                <td class="fieldCaption" style="width: 200px; height: 25px; padding-top: 8px; vertical-align: top">
                                    <asp:Label runat="server" Text="<%$ Resources:Text, Scheme %>" Style="position: relative; top: 2px" />
                                </td>
                                <td class="fontBold" style="height: 25px; padding-top: 8px; vertical-align: top">
                                    <asp:Label ID="lblConVaccineScheme" runat="server" Text="" Style="position: relative; top: 2px" CssClass="tableText" />
                                    <asp:Label ID="hflblEConVaccineSchemeCode" runat="server"  Text="" Visible="false" />
                    ...
                    <asp:View ID="ViewNewEditLotRecord" runat="server">
                        <div class="headingText">
                            <asp:Label ID="lblNewEditRecordHeading" runat="server" Text="<%$ Resources: Text, VaccineLotRecordAssign%>"></asp:Label>
                        </div>
                        ...
                        <asp:Panel ID="panNewRecord" runat="server">
                            ...
                            <table style="width: 100%; padding-left: 22px" cellpadding="1" cellspacing="0">
                                <tr>
                                    <td style="width: 200px; height: 25px; padding-top: 8px; vertical-align: top">
                                        <asp:label id="lblInputVaccineSchemeText" runat="server" text="<%$ resources:Text, Scheme %>" style="position: relative; top: 2px" />
                                    </td>
                                    <td style="height: 25px; padding-top: 8px; vertical-align: top">
                                        <table cellpadding="0" cellspacing="0">
                                            <tr>
                                                <td>
                                                    <%--<asp:label id="ddlInputVaccineScheme" runat="server" appenddatabounditems="true" style="height: 22px; width: 560px; position: relative; top: -1px" autopostback="true" onselectedindexchanged="ddlVaccineScheme_SelectedIndexChanged" />--%>
                                                    <asp:Label ID="ddlInputVaccineScheme" runat="server" Text="" Style="position: relative; top: 2px" CssClass="tableText" />
                                                </td>
                                               <%-- <td>
                           ...
                           <%--     <tr>
                                ...
                                <tr>
                                    <td style="width: 200px; height: 25px; padding-top: 8px; vertical-align: top">
                                        <asp:Label ID="lblResultVaccineBrandName" runat="server" Text="<%$ Resources:Text, VaccineName %>" Style="position: relative; top: 2px" />
                                    </td>
                                    <td style="height: 25px; padding-top: 8px; vertical-align: top">
                                        <table cellpadding="0" cellspacing="0">
                                            <tr>
                        ...
                        <asp:Panel ID="panEditRecord" runat="server">
                            <table style="width: 100%; padding-left: 22px" cellpadding="1" cellspacing="0">
                                <tr>
                                    <td style="width: 200px; height: 25px; padding-top: 8px; vertical-align: top">
                                        <asp:Label ID="Label20" runat="server" Text="<%$ Resources:Text, Scheme %>" Style="position: relative; top: 2px" />
                                    </td>
                                    <td style="height: 25px; padding-top: 8px; vertical-align: top">
                                        <table cellpadding="0" cellspacing="0">
                                            <tr>
                                                <td>
                                                    <asp:Label ID="lblPERConVaccineScheme" runat="server" Text="" Style="position: relative; top: 2px" CssClass="tableText" />
                                                </td>
                    ...
                    <asp:View ID="ViewEditLotRecordDetail" runat="server">
                        ...
                        <table style="width: 100%; padding-left: 22px" cellpadding="1" cellspacing="0">
                            ...
                            <tr>
                                ...
                                <td class="fontBold" style="height: 25px; padding-top: 8px; vertical-align: top">
                                    <asp:Label ID="lblEConVaccineScheme" runat="server" Text="" Style="position: relative; top: 2px" CssClass="tableText" />
