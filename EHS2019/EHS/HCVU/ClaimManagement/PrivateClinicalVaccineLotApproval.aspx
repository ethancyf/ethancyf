<%@ Page Language="vb" AutoEventWireup="false" MasterPageFile="~/MasterPage.Master"
    Codebehind="PrivateClinicalVaccineLotApproval.aspx.vb" Inherits="HCVU.PrivateClinicalVaccineLotApproval" Title="<%$ Resources:Title, VaccineLotApproval %>" %>
    ...
    <asp:UpdatePanel ID="UpdatePanel1" runat="server">
        <ContentTemplate>
            <table style="width: 100%">
                <tr>
                    <td>
                        <asp:Image ID="imgHeader" runat="server" AlternateText="<%$ Resources:AlternateText, PrivateClinicalVaccineLotApprovalBanner %>"
                            ImageUrl="<%$ Resources:ImageUrl, PrivateClinicalVaccineLotAprrovalBanner %>" /></td>
                </tr>
            </table>
                ...
                <asp:MultiView ID="MultiViewEnquiry" runat="server" ActiveViewIndex="0">
                        ...
                        <table >
                            <tr>
                                <td style="width: 130px">
                                    <asp:Label ID="lblVaccScheme" runat="server" Text="<%$ Resources:Text, Scheme %>"></asp:Label></td>
                                <td style="width: 350px">
                                    <asp:DropDownList ID="ddlVaccScheme" runat="server" AppendDataBoundItems="True" >
                                    </asp:DropDownList>
                            ...
                            <table >
                                <tr>
                                    <td valign="top" style="width: 130px">
                                        <asp:Label ID="lblResultVaccineSchemeText" runat="server" Text="<%$ Resources:Text, Scheme %>"></asp:Label></td>
                                    <td valign="top" style="width: 650px">
                                        <asp:Label ID="lblResultSchemeVaccNo" runat="server" CssClass="tableText" ></asp:Label></td>
                                    <td valign="top" style="width: 130px">
                        ...
                        <asp:GridView ID="gvResult" runat="server" AutoGenerateColumns="False" AllowPaging="True"
                            ...
                            <Columns>
                                ...
                                <asp:TemplateField SortExpression="Scheme_Code" HeaderText="<%$ Resources:Text, Scheme %>">
                                    <ItemTemplate>
                                        <asp:Label ID="lblVLScheme" runat="server" Text='<%# Eval("Scheme_Code")%>'></asp:Label>
                                    </ItemTemplate>
                    ...
                    <asp:View ID="ViewDetails" runat="server">
                        ...
                        <table  style="width: 100%; padding-left: 22px" cellpadding="1" cellspacing="0">
                            ...
                            <tr>
                               <td class="fieldCaption" style="width: 200px; height: 25px; padding-top: 8px; vertical-align: top">
                                    <asp:Label ID="lblDetailTitleScheme" runat="server" Text="<%$ Resources:Text, Scheme %>" Style="position: relative; top: 2px" ></asp:Label></td>
                               <td class="fontBold" style="height: 25px; padding-top: 8px; vertical-align: top">
                                    <asp:Label ID="lblDetailScheme" runat="server" CssClass="tableText"></asp:Label>
