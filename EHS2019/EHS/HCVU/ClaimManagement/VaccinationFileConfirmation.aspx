<%@ Page Language="vb" AutoEventWireup="false" MasterPageFile="~/MasterPage.Master"
    CodeBehind="VaccinationFileConfirmation.aspx.vb" Inherits="HCVU.VaccinationFileConfirmation"
    Title="<%$ Resources: Title, VaccinationFileConfirmation %>" EnableEventValidation="False" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    <asp:Image ID="imgHeader" runat="server" ImageUrl="<%$ Resources: ImageUrl, VaccinationFileConfirmationBanner %>"
        AlternateText="<%$ Resources: AlternateText, VaccinationFileConfirmationBanner %>"></asp:Image>
