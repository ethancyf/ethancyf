    ...
    Protected Sub ibtnAmendSave_Click(ByVal sender As System.Object, ByVal e As System.Web.UI.ImageClickEventArgs)
        ...
        Select Case Me.txtDocCode.Text.Trim
            ...
            Case DocTypeModel.DocTypeCode.OW
                ...
                blnProceed = Me.ValidateRectifyDetail_OW(udtEHSAccount_Amendment, udtAuditLogEntry, ucInputDocTypeBase.BuildMode.Modification)
            ...
            Case DocTypeModel.DocTypeCode.RFNo8
                'udtEHSAccount.EHSPersonalInformationList(0).DocCode = Me.txtDocCode.Text.Trim
                blnProceed = Me.ValidateRectifyDetail_RFNo8(udtEHSAccount_Amendment, udtAuditLogEntry, ucInputDocTypeBase.BuildMode.Modification)
            ...
            Case DocTypeModel.DocTypeCode.ISSHK, DocTypeModel.DocTypeCode.ET
                blnProceed = Me.ValidateRectifyDetail_ISSHK(udtEHSAccount_Amendment, udtAuditLogEntry, ucInputDocTypeBase.BuildMode.Modification, Me.txtDocCode.Text.Trim)
...
#Region "View 8 - Creation New Account"
    ...
    Protected Sub ibtnNewAccountSave_Click(ByVal sender As System.Object, ByVal e As System.Web.UI.ImageClickEventArgs)
        ...
        Select Case Me.txtDocCode.Text.Trim
            ...
            Case DocTypeModel.DocTypeCode.OW
                udtEHSAccount.EHSPersonalInformationList(0).DocCode = DocTypeModel.DocTypeCode.OW
                blnProceed = Me.ValidateRectifyDetail_OW(udtEHSAccount, udtAuditLogEntry, ucInputDocTypeBase.BuildMode.Creation)
            ...
            Case DocTypeModel.DocTypeCode.RFNo8
                udtEHSAccount.EHSPersonalInformationList(0).DocCode = DocTypeModel.DocTypeCode.RFNo8
                blnProceed = Me.ValidateRectifyDetail_RFNo8(udtEHSAccount, udtAuditLogEntry, ucInputDocTypeBase.BuildMode.Creation)
            ...
            Case DocTypeModel.DocTypeCode.ISSHK, DocTypeModel.DocTypeCode.ET
                udtEHSAccount.EHSPersonalInformationList(0).DocCode = Me.txtDocCode.Text.Trim
                blnProceed = Me.ValidateRectifyDetail_ISSHK(udtEHSAccount, udtAuditLogEntry, ucInputDocTypeBase.BuildMode.Creation, Me.txtDocCode.Text.Trim)
...
#Region "Enter Details Validation"
    ...
    Private Function ValidateRectifyDetail_EC(ByRef _udtEHSAccount As EHSAccountModel, ByRef _udtAuditLogEntry As AuditLogEntry, ByVal udcControlMode As ucInputDocTypeBase.BuildMode) As Boolean
        ...
        'Chinese Name
        Me.udtSM = Me.udtValidator.chkChiName(udcInputEC.CName, DocTypeModel.DocTypeCode.EC)
        If Not IsNothing(udtSM) Then
            isValid = False
    ...
    Private Function ValidateRectifyDetail_HKBC(ByRef _udtEHSAccount As EHSAccountModel, ByRef _udtAuditLogEntry As AuditLogEntry, ByVal udcControlMode As ucInputDocTypeBase.BuildMode) As Boolean
        ...
        'Chinese Name
        Me.udtSM = Me.udtValidator.chkChiName(udcInputHKBC.CName, DocTypeModel.DocTypeCode.HKBC)
        If Not IsNothing(udtSM) Then
            isValid = False
    ...
    Private Function ValidateRectifyDetail_Adopt(ByRef _udtEHSAccount As EHSAccountModel, ByRef _udtAuditLogEntry As AuditLogEntry, ByVal udcControlMode As ucInputDocTypeBase.BuildMode) As Boolean
        ...
        'English Name
        Me.udtSM = Me.udtValidator.chkEngName(udcInputAdopt.ENameSurName, udcInputAdopt.ENameFirstName, DocTypeModel.DocTypeCode.ADOPC)
        If Not IsNothing(udtSM) Then
            isvalid = False
        ...
        'Chinese Name
        Me.udtSM = Me.udtValidator.chkChiName(udcInputAdopt.CName, DocTypeModel.DocTypeCode.ADOPC)
        If Not IsNothing(udtSM) Then
            isvalid = False
    ...
    Private Function ValidateRectifyDetail_DI(ByRef _udtEHSAccount As EHSAccountModel, ByRef _udtAuditLogEntry As AuditLogEntry, ByVal udcControlMode As ucInputDocTypeBase.BuildMode) As Boolean
        ...
        'English Name
        Me.udtSM = Me.udtValidator.chkEngName(udcInputDI.ENameSurName, udcInputDI.ENameFirstName, DocTypeModel.DocTypeCode.DI)
        If Not IsNothing(udtSM) Then
            isvalid = False
        ...
        'Chinese Name
        Me.udtSM = Me.udtValidator.chkChiName(udcInputDI.CName, DocTypeModel.DocTypeCode.DI)
        If Not IsNothing(udtSM) Then
            isvalid = False
    ...
    Private Function ValidateRectifyDetail_ID235B(ByRef _udtEHSAccount As EHSAccountModel, ByRef _udtAuditLogEntry As AuditLogEntry, ByVal udcControlMode As ucInputDocTypeBase.BuildMode) As Boolean
        ...
        'English Name
        Me.udtSM = Me.udtValidator.chkEngName(udcInputID235B.ENameSurName, udcInputID235B.ENameFirstName, DocTypeModel.DocTypeCode.ID235B)
        If Not IsNothing(udtSM) Then
            isvalid = False
        ...
        'Chinese Name
        Me.udtSM = Me.udtValidator.chkChiName(udcInputID235B.CName, DocTypeModel.DocTypeCode.ID235B)
        If Not IsNothing(udtSM) Then
            isvalid = False
    ...
    Private Function ValidateRectifyDetail_ReEntryPermit(ByRef _udtEHSAccount As EHSAccountModel, ByRef _udtAuditLogEntry As AuditLogEntry, ByVal udcControlMode As ucInputDocTypeBase.BuildMode) As Boolean
        ...
        'English Name
        Me.udtSM = Me.udtValidator.chkEngName(udcInputReentryPermit.ENameSurName, udcInputReentryPermit.ENameFirstName, DocTypeModel.DocTypeCode.REPMT)
        If Not IsNothing(udtSM) Then
            isvalid = False
        ...
        'Chinese Name
        Me.udtSM = Me.udtValidator.chkChiName(udcInputReentryPermit.CName, DocTypeModel.DocTypeCode.REPMT)
        If Not IsNothing(udtSM) Then
            isvalid = False
    ...
    Private Function ValidateRectifyDetail_Visa(ByRef _udtEHSAccount As EHSAccountModel, ByRef _udtAuditLogEntry As AuditLogEntry, ByVal udcControlMode As ucInputDocTypeBase.BuildMode) As Boolean
        ...
        'English Name
        Me.udtSM = Me.udtValidator.chkEngName(udcInputVisa.ENameSurName, udcInputVisa.ENameFirstName, DocTypeModel.DocTypeCode.VISA)
        If Not IsNothing(udtSM) Then
            isValid = False
        ...
        'Chinese Name
        Me.udtSM = Me.udtValidator.chkChiName(udcInputVisa.CName, DocTypeModel.DocTypeCode.VISA)
        If Not IsNothing(udtSM) Then
            isValid = False
    ...
    'OW
    Private Function ValidateRectifyDetail_OW(ByRef _udtEHSAccount As EHSAccountModel, ByRef _udtAuditLogEntry As AuditLogEntry, ByVal udcControlMode As ucInputDocTypeBase.BuildMode) As Boolean
        Dim isValid As Boolean = True
        ...
        'English Name
        Me.udtSM = Me.udtValidator.chkEngName(udcInputOW.ENameSurName, udcInputOW.ENameFirstName, txtDocCode.Text.Trim)
        If Not IsNothing(udtSM) Then
            isValid = False
    ...
    'RFNo8
    Private Function ValidateRectifyDetail_RFNo8(ByRef _udtEHSAccount As EHSAccountModel, ByRef _udtAuditLogEntry As AuditLogEntry, ByVal udcControlMode As ucInputDocTypeBase.BuildMode) As Boolean
        Dim isValid As Boolean = True
        Dim udcInputRFNo8 As ucInputRFNo8

        If udcControlMode = ucInputDocTypeBase.BuildMode.Creation Then
            udcInputRFNo8 = Me.ucInputDocumentType_NewAcc.GetRFNo8Control
            Me.ucInputDocumentType_NewAcc.ActiveViewChanged = False
        Else
            udcInputRFNo8 = Me.ucInputDocumentType.GetRFNo8Control
        End If

        udcInputRFNo8.SetProperty(udcControlMode)
        udcInputRFNo8.SetErrorImage(udcControlMode, False)
        ...
        _udtAuditLogEntry.AddDescripton("ExactDOB", udcInputRFNo8.IsExactDOB)
        _udtAuditLogEntry.WriteStartLog(LogID.LOG00017, AuditLogDesc.ValidateAccountDetailInfo)

        'DocNo.
        Me.udtSM = Me.udtValidator.chkIdentityNumber(txtDocCode.Text.Trim, udcInputRFNo8.DocumentNo.Trim, String.Empty)
        If Not IsNothing(udtSM) Then
            isValid = False
            udcInputRFNo8.SetDocNoError(True)
            Me.udcMsgBox.AddMessage(udtSM)
        End If
        ...
        Select Case udcInputRFNo8.DOB.Trim
            Case String.Empty
                udtSM = New SystemMessage("990000", "E", "00003")
        ...
        'English Name
        Me.udtSM = Me.udtValidator.chkEngName(udcInputRFNo8.ENameSurName, udcInputRFNo8.ENameFirstName, txtDocCode.Text.Trim)
        If Not IsNothing(udtSM) Then
            isValid = False
        ...
        'Chinese Name
        Me.udtSM = Me.udtValidator.chkChiName(udcInputRFNo8.CName, DocTypeModel.DocTypeCode.RFNo8)
        If Not IsNothing(udtSM) Then
            isValid = False
        ...
        'Gender
        Me.udtSM = Me.udtValidator.chkGender(udcInputRFNo8.Gender)
        If Not IsNothing(udtSM) Then
            isValid = False
    ...
    Private Function ValidateRectifyDetail_ROP140(ByRef _udtEHSAccount As EHSAccountModel, ByRef _udtAuditLogEntry As AuditLogEntry, ByVal udcControlMode As ucInputDocTypeBase.BuildMode) As Boolean
        ...
        'English Name
        Me.udtSM = Me.udtValidator.chkEngName(udcInputROP140.ENameSurName, udcInputROP140.ENameFirstName, DocTypeModel.DocTypeCode.ROP140)
        If Not IsNothing(udtSM) Then
            isvalid = False
    ...
    'ISSHK 80 80
    Private Function ValidateRectifyDetail_ISSHK(ByRef _udtEHSAccount As EHSAccountModel, ByRef _udtAuditLogEntry As AuditLogEntry, ByVal udcControlMode As ucInputDocTypeBase.BuildMode, ByVal strDocTypeCode As String) As Boolean
        Dim isvalid As Boolean = True
        ...
        Dim udcInputISSHK As ucInputISSHK

        If udcControlMode = ucInputDocTypeBase.BuildMode.Creation Then
            udcInputISSHK = Me.ucInputDocumentType_NewAcc.GetISSHKControl
            Me.ucInputDocumentType_NewAcc.ActiveViewChanged = False
        Else
            udcInputISSHK = Me.ucInputDocumentType.GetISSHKControl()
        End If

        udcInputISSHK.SetProperty(udcControlMode)
        udcInputISSHK.SetErrorImage(udcControlMode, False)
        ...
        'TravelDocNo
        Me.udtSM = Me.udtValidator.chkIdentityNumber(strDocTypeCode, udcInputISSHK.TravelDocNo.Trim, String.Empty)
        If Not IsNothing(udtSM) Then
            isvalid = False
            udcInputISSHK.SetTDError(True)
            Me.udcMsgBox.AddMessage(udtSM)
        End If

        'English Name
        Me.udtSM = Me.udtValidator.chkEngName(udcInputISSHK.ENameSurName, udcInputISSHK.ENameFirstName, strDocTypeCode)
        If Not IsNothing(udtSM) Then
            isvalid = False
        ...
        Me.udtSM = Me.udtValidator.chkDOB(strDocTypeCode, strDOB, dtmDOB, strExactDOB)
        If Not IsNothing(udtSM) Then
            isvalid = False
        ...
        If isvalid Then
            If udcControlMode = ucInputDocTypeBase.BuildMode.Creation Then
                udtEHSAccountPersonalInfo.IdentityNum = udcInputISSHK.TravelDocNo
            End If
    ...
    'Common 40 40
    Private Function ValidateRectifyDetail_Common(ByRef _udtEHSAccount As EHSAccountModel, ByRef _udtAuditLogEntry As AuditLogEntry, ByVal udcControlMode As ucInputDocTypeBase.BuildMode, ByVal strDocTypeCode As String) As Boolean
        Dim isValid As Boolean = True
        Dim udcInputCommon As ucInputCommon

        If udcControlMode = ucInputDocTypeBase.BuildMode.Creation Then
            udcInputCommon = Me.ucInputDocumentType_NewAcc.GetCommonControl
            Me.ucInputDocumentType_NewAcc.ActiveViewChanged = False
        Else
            udcInputCommon = Me.ucInputDocumentType.GetCommonControl
        End If

        udcInputCommon.SetProperty(udcControlMode)
        udcInputCommon.SetErrorImage(udcControlMode, False)
        ...
        'DocNo.
        Me.udtSM = Me.udtValidator.chkIdentityNumber(strDocTypeCode, udcInputCommon.DocumentNo.Trim, String.Empty)
        If Not IsNothing(udtSM) Then
            isValid = False
        ...
        Select Case udcInputCommon.DOB.Trim
            ...
            Case Else
                udtSM = Me.udtValidator.chkDOB(strDocTypeCode, strDOB, dtmDOB, strExactDOB)
        ...
        'English Name
        Me.udtSM = Me.udtValidator.chkEngName(udcInputCommon.ENameSurName, udcInputCommon.ENameFirstName, strDocTypeCode)
        If Not IsNothing(udtSM) Then
            isValid = False
