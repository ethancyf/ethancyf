...
#End Region
    ...
    Protected Sub ibtnSearchAndHold_Click(ByVal sender As Object, ByVal e As System.Web.UI.ImageClickEventArgs)
        ...
        Try
            ...
            If dt.Rows.Count > 0 Then
                ...
                If Not (Me.hfSchemeCode.Value.Trim = SchemeClaimModel.HCVSCHN Or Me.hfSchemeCode.Value.Trim = SchemeClaimModel.HCVSDHC Or Me.hfSchemeCode.Value.Trim = SchemeClaimModel.SSSCMC) Then 'CRE20-015-02 (Special Support Scheme) [Martin]
                ...
                gvGroupByReimburseID.Columns(6).Visible = udtReimbursementBLL.IsHKDRMBAvailable(hfSchemeCode.Value) OrElse udtReimbursementBLL.IsRMBAvailable(hfSchemeCode.Value)
                gvGroupByReimburseID.Columns(5).Visible = udtReimbursementBLL.IsHKDRMBAvailable(hfSchemeCode.Value) OrElse udtReimbursementBLL.IsHKDAvailable(hfSchemeCode.Value)
    ...
    Protected Sub gvGroupByReimburseID_RowDataBound(sender As Object, e As GridViewRowEventArgs)
        If e.Row.RowType = DataControlRowType.DataRow Then
            ...
            ' CRE17-004 Generate a new DPAR on EHCP basis [Start][Dickson]
            If Session("VerificationCaseAvailable") = ReimbursementVerificationCaseAvailable.Available _
                And (New SchemeClaimBLL).getAllDistinctSchemeClaim.Filter(ddlScheme.SelectedValue).ReimbursementMode <> EnumReimbursementMode.HAFinance Then 'CRE20-015-02 (Special Support Scheme) [Martin]
        ...
        If Not (e.CommandName.ToUpper.Equals("PAGE") Or e.CommandName.ToUpper.Equals("SORT")) Then
            ...
            Else
                ...
                Try
                    ...
                    'CRE20-015-02 (Special Support Scheme) [Start][Martin]
                    gvGroupBySP.Columns(5).Visible = udtReimbursementBLL.IsHKDRMBAvailable(hfSchemeCode.Value) OrElse udtReimbursementBLL.IsRMBAvailable(hfSchemeCode.Value)
                    gvGroupBySP.Columns(4).Visible = udtReimbursementBLL.IsHKDRMBAvailable(hfSchemeCode.Value) OrElse udtReimbursementBLL.IsHKDAvailable(hfSchemeCode.Value)
                    'CRE20-015-02 (Special Support Scheme) [End][Martin]
    ...
    Protected Sub gvGroupBySP_RowCommand(ByVal sender As System.Object, ByVal e As System.Web.UI.WebControls.GridViewCommandEventArgs)
        ...
        If Not (e.CommandName.ToUpper.Equals("PAGE") Or e.CommandName.ToUpper.Equals("SORT")) Then
            ...
            Try
                ...
                'CRE20-015-02 (Special Support Scheme) [Start][Martin]
                gvGroupByBankAccount.Columns(5).Visible = udtReimbursementBLL.IsHKDRMBAvailable(hfSchemeCode.Value) OrElse udtReimbursementBLL.IsRMBAvailable(hfSchemeCode.Value)
                gvGroupByBankAccount.Columns(4).Visible = udtReimbursementBLL.IsHKDRMBAvailable(hfSchemeCode.Value) OrElse udtReimbursementBLL.IsHKDAvailable(hfSchemeCode.Value)
                'CRE20-015-02 (Special Support Scheme) [End][Martin]
