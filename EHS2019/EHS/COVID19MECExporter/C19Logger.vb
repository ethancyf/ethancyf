Public Class C19Logger
    ...
    Private Shared ScheduleJobLogEntryObj As New Common.ComObject.ScheduleJobLogEntry(Common.Component.ScheduleJobID.COVID19MECExporter)

#Region "Private Classes"
    Public Class ScheduleJobLogAction
        Public Const ProcessRegenerateCase As String = "ProcessRegenerateCase"
        Public Const ProcessFailCase As String = "ProcessFailCase"
        Public Const ProcessNormalCase As String = "ProcessNormalCase"
        Public Const AssignRecord As String = "AssignRecord"
        Public Const LoadQueue As String = "LoadQueue"
        Public Const ExportCSV As String = "ExportCSV"
        Public Const ExportZIP As String = "ExportZIP"
        Public Const ExportCTL As String = "ExportCTL"
        Public Const MoveFile As String = "MoveFile"
        Public Const ExportAndZipFile As String = "ExportAndZipFile"
        Public Const Alert As String = "Alert"
        Public Const COVID19MECExporterProcess As String = "COVID19MECExporterProcess"
...
#End Region
    ...
    Public Shared Function Log(ByVal strLogID As String, ByVal objLogStartKey As Common.ComObject.AuditLogStartKey, ByVal strDesc As String, ByVal strAction As String, ByVal strStatus As String) As Common.ComObject.AuditLogStartKey
        ...
        If IsNothing(objLogStartKey) Then
            Return ScheduleJobLogEntryObj.WriteStartLog(strLogID, strDesc, strAction, strStatus)
        Else
            ScheduleJobLogEntryObj.WriteEndLog(objLogStartKey, strLogID, strDesc, strAction, strStatus)
            Return Nothing
        End If
    ...
    Public Shared Function ChkEmailAndPagerAlert()
        If (AlertSwitch) Then
            ScheduleJobLogEntryObj.WriteStartLog(Common.Component.LogID.LOG00009, "<Alert>" & AlertFile & "", C19Logger.ScheduleJobLogAction.Alert, Common.Component.ScheduleJobLogStatus.Information)
