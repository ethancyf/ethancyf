IF EXISTS (SELECT * FROM dbo.sysobjects WHERE id = OBJECT_ID(N'[dbo].[proc_EHS_RVPPVTransaction_Stat]') AND OBJECTPROPERTY(id, N'IsProcedure') = 1)
	DROP PROCEDURE [dbo].[proc_EHS_RVPPVTransaction_Stat]
GO
...
-- Description:  Generate report for RVP-PV (23vPPV) Transactions        
-- =============================================

/*
CREATE PROCEDURE [dbo].[proc_EHS_RVPPVTransaction_Stat]         
 @Cutoff_Dtm datetime      
AS BEGIN        
...
VALUES (0, 'eHSD0004-04: Raw Data of 23vPPV transactions under RVP')
  ...
  @Account A INNER JOIN @Transaction T ON A.Transaction_id = T.Transaction_ID            
   ...
   INNER JOIN SubsidizeItemDetails SID        
    ON A.Dose = SID.Available_Item_Code        
     AND SID.Subsidize_Item_Code = 'PV'      
...
-- =============================================        
 ...
 DELETE FROM _RVPPVTransaction_Stat        
         
 INSERT INTO _RVPPVTransaction_Stat (        
  Result_Seq,        
  Result_Value1,        
  Result_Value2,        
  Result_Value3,        
...
GRANT EXECUTE ON [dbo].[proc_EHS_RVPPVTransaction_Stat] TO HCVU
GO
*/
