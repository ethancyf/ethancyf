   if exists (select * from dbo.sysobjects where id = object_id(N'[dbo].[proc_PersonalInformation_upd_fromSpecial]') and OBJECTPROPERTY(id, N'IsProcedure') = 1)
drop procedure [dbo].[proc_PersonalInformation_upd_fromSpecial]
GO
...
-- =============================================
CREATE PROCEDURE [dbo].[proc_PersonalInformation_upd_fromSpecial]
...
Grant execute on [dbo].[proc_PersonalInformation_upd_fromSpecial] to HCVU
GO       