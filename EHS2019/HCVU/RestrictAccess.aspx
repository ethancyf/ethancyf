...
<%@ Page Language="vb" AutoEventWireup="false" CodeBehind="RestrictAccess.aspx.vb" Inherits="HCVU.RestrictAccess" %>
...
<head id="Head1" runat="server">
    <title>eHealth System (Subsidies) - Access Denied</title>
...
<body>
    <form id="form1" runat="server">
        ...
        <br />
        <span style="font-size: 16pt; width: 950pt;">
            <asp:Label ID="lblAccessDenied" runat="server" Text="<%$ Resources:Text, AccessDenied %>"></asp:Label>
        </span>
    </form>
</body>
</html>
