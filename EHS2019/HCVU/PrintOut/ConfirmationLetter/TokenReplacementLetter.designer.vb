Namespace PrintOut.ConfirmationLetter
    ...
    Partial Public Class TokenReplacementLetter
        ...
        "o-char-set: 1"
            ...
            Me.txtDescriptionChi4.Left = 0.0!
            Me.txtDescriptionChi4.LineSpacing = 1.0!
        ...
        "e; vertical-align: top; ddo-char-set: 1"
            ...
            Me.txtSpecialFont01Eng.Left = 1.04!
        ...
        ""
            Me.txtSpecialFont01Eng.Text = "hcvu@dh.gov.hk"
            ...
            Me.txtSpecialFont02Eng.Left = 0.744!
        ...
        "ute; vertical-align: top; ddo-char-set: 1"
            Me.txtDescriptionChi5.Text = "如果你對上述安排有任何查詢，請向醫療券組 (電話：0000 0001；電郵：                           ) 或項目管理及疫苗計劃科 (電" & _
        "話：0000 0002；電郵：                          ) 查詢。再次多謝你對長者醫療券計劃及 / 或疫苗資助計劃的支持。"
            ...
            Me.txtSpecialFont01Chi.Left = 5.0!
        ...
        ": 1"
            Me.txtSpecialFont01Chi.Text = "hcvu@dh.gov.hk"
            ...
            Me.txtSpecialFont02Chi.Left = 3.255!
