...
#Region "Set Value"
    ...
    Public Sub FillClaimDetail()
        ...
        '    If Not _udtSessionHandler.DocumentaryProofForPIDGetFromSession(MyBase.FunctionCode) Is Nothing And _
        '        Not _udtSessionHandler.DocumentaryProofForPIDGetFromSession(MyBase.FunctionCode) = String.Empty Then

        '        Dim strDocumentaryProofValue As String = _udtSessionHandler.DocumentaryProofForPIDGetFromSession(MyBase.FunctionCode)

        '        If strDocumentaryProofValue = ucInputVSSPID.PID_DOCUMENTARYPROOF.PID_INSTITUTION_CERT Then
        If Not _udtSessionHandler.PIDInstitutionCodeGetFromSession(MyBase.FunctionCode) Is Nothing And _
            Not _udtSessionHandler.PIDInstitutionCodeGetFromSession(MyBase.FunctionCode) = String.Empty Then

            Dim strPIDInstitutionCode As String = _udtSessionHandler.PIDInstitutionCodeGetFromSession(MyBase.FunctionCode)
...
#End Region
    ...
    Private Sub txtRCHCodeText_TextChanged(ByVal sender As Object, ByVal e As System.EventArgs) Handles txtPIDInstitutionCode.TextChanged
        If Me.txtPIDInstitutionCode.Text.Trim() = String.Empty Then
            ...
            _udtSessionHandler.PIDInstitutionCodeRemoveFromSession(MyBase.FunctionCode)
        Else
            Me.lookUpRCHCode()
        End If
    End Sub
    ...
    Private Sub lookUpRCHCode()
        ...
        If dtResult.Rows.Count > 0 Then
            ...
            '_udtSessionHandler.PIDInstitutionCodeSaveToSession(dtResult.Rows(0)("RCH_Code").ToString().Trim().ToUpper(), MyBase.FunctionCode)
        Else
            Me.lblPIDInstitutionCode.Text = String.Empty
            Me.lblPIDInstitutionName.Text = String.Empty
            Me.lblPIDInstitutionNameChi.Text = String.Empty
    ...
    Public Sub Save(ByRef udtEHSTransaction As EHSTransactionModel, ByVal udtEHSClaimVaccine As EHSClaimVaccineModel)
        ...
        If Me.DocumentaryProof <> String.Empty Then
            ...
            If Not udtSubsidizeLatest Is Nothing Then
                ...
                '_udtSessionHandler.DocumentaryProofForPIDSaveToSession(Me.DocumentaryProof, MyBase.FunctionCode)
                ...
                If Me.DocumentaryProof = PID_DOCUMENTARYPROOF.PID_INSTITUTION_CERT And panPIDInstitutionCode.Visible = True Then
                    ...
                    '_udtSessionHandler.PIDInstitutionCodeSaveToSession(Me.PIDInstitutionCode, MyBase.FunctionCode)
                End If
            End If
