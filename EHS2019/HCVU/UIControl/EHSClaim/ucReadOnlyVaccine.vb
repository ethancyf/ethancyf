...
Public Class ucReadOnlyVaccine
...
#End Region
    ...
    Public Sub Build(ByVal udtEHSTransaction As EHSTransactionModel)
        ...
        tblHCell3.Text = HttpContext.GetGlobalResourceObject("Text", "Amount")
        ...
        tblFCell2.Text = HttpContext.GetGlobalResourceObject("Text", "TotalAmount")
