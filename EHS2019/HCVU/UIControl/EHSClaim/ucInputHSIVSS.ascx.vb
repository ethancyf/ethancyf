    ...
    Protected Overrides Sub Setup()
        ...
        If Not MyBase.ClaimCategorys Is Nothing AndAlso MyBase.ClaimCategorys.Count > 0 Then
            ...
            If Not MyBase.EHSClaimVaccine Is Nothing Then
                Me.udcClaimVaccineInputHSIVSS.ShowLegend = MyBase.ShowLegend
                Me.udcClaimVaccineInputHSIVSS.Build(MyBase.EHSClaimVaccine, MyBase.FunctionCode)
            End If
...
#Region "Other functions"
    ...
    Private Sub BindPreCondition(ByVal strLanguage As String)
        ...
        dataRow(StaticDataModel.Data_Value_Chi) = Me.GetGlobalResourceObject("Text", "ClaimPleaseSelect_Chi") '"½Ð¿ï¾Ü----" ''Should be replaced with GobalResource
