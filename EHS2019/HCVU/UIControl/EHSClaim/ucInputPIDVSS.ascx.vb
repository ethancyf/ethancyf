...
#Region "Must Override Function"
    ...
    Protected Overrides Sub Setup()
        ...
        Call BindDocumentaryProofDropDown()
        Me.udcClaimVaccineInputPIDVSS.ShowLegend = MyBase.ShowLegend
        Me.udcClaimVaccineInputPIDVSS.Build(MyBase.EHSClaimVaccine, MyBase.FunctionCode)
...
#Region "Document Proof"
    ...
    Private Sub BindDocumentaryProofDropDown()
        ...
        ddlDocumentaryProof.Items.Insert(0, New ListItem(Me.GetGlobalResourceObject("Text", "ClaimPleaseSelect"), String.Empty))
