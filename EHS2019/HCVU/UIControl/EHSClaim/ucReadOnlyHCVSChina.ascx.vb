...
Partial Public Class ucReadOnlyHCVSChina
    ...
    Private CoPaymentFeeRMB As String = Common.Component.EHSTransaction.TransactionAdditionalFieldModel.AdditionalFieldType.CoPaymentFeeRMB
    ...
    Public Sub Build(ByVal udtEHSTransaction As EHSTransactionModel, ByVal intWidth As Integer)
        ...
        If Not udtEHSTransaction Is Nothing AndAlso Not udtEHSTransaction.TransactionAdditionFields Is Nothing Then
            ...
            If udtEHSTransaction.ExchangeRate.HasValue Then
                decExchangeRate = udtEHSTransaction.ExchangeRate.Value
            End If
            ...
            blnCoPaymentFee = Transaction_AdditionFields_GetFieldValueCode(udtEHSTransaction.TransactionAdditionFields, CoPaymentFeeRMB, strCoPaymentFee)
            'CRE13-019-02 Extend HCVS to China [End][Winnie]
        ...
        If strVisitL1 <> String.Empty Then ' And strVisitL2 <> String.Empty Then
            ' CRE11-024-02 HCVS Pilot Extension Part 2 [End]
            ...
            ' CRE11-024-02 HCVS Pilot Extension Part 2 [Start]
            'ElseIf Not udtEHSTransaction Is Nothing AndAlso blnCoPaymentFeeStarted Then
            '    lblReasonVisitToBeProvided.Visible = True
        Else
        ...
        If Not udtEHSTransaction Is Nothing Then
            If blnCoPaymentFeeStarted Then
                If blnCoPaymentFee Then
                    ...
                    Me.Transaction_AdditionFields_GetFieldValueCode(udtEHSTransaction.TransactionAdditionFields, Me.CoPaymentFeeRMB, lblCoPaymentFee.Text)
                    'CRE13-019-02 Extend HCVS to China [End][Winnie]
                    ...
                    Me.lblCoPaymentFee.Text = String.Format("{0}",
                                        udtFormatter.formatMoneyRMB(lblCoPaymentFee.Text, True))
                    'CRE13-019-02 Extend HCVS to China [End][Winnie]
                    ' CRE13-018 - Change Voucher Amount to 1 Dollar [End][Tommy L]
                Else
                    lblCoPaymentFee.Visible = True
        ...
        If String.IsNullOrEmpty(udtEHSTransaction.TransactionAdditionFields.PaymentType) = False Then
            ...
            udtStaticDataModel = udtStaticDataBLL.GetStaticDataByColumnNameItemNo("HCVSCHN_PAYMENTTYPE", udtEHSTransaction.TransactionAdditionFields.PaymentType)
        ...
        If strVisitL1_2 <> String.Empty Then 'AndAlso strVisitL2_2 <> String.Empty Then
            ...
            'lblReasonVisitL2_2.Style.Add("padding-left", "15px")
        ...
        If strVisitL1_3 <> String.Empty Then ' AndAlso strVisitL2_3 <> String.Empty Then
            Me.trSecondary.Visible = True
            ...
            'lblReasonVisitL2_3.Style.Add("padding-left", "15px")
            Me.PlaceHolder1.Controls.Add(New LiteralControl("           <table cellpadding=""1"" cellspacing=""1"" border=""0"">"))
            Me.PlaceHolder1.Controls.Add(New LiteralControl("               <tr>"))
            Me.PlaceHolder1.Controls.Add(New LiteralControl("                   <td>"))
        ...
        If strVisitL1_4 <> String.Empty Then ' AndAlso strVisitL2_4 <> String.Empty Then
            Me.trSecondary.Visible = True
            ...
            'lblReasonVisitL2_4.Style.Add("padding-left", "15px")
            Me.PlaceHolder1.Controls.Add(New LiteralControl("           <table cellpadding=""1"" cellspacing=""1"" border=""0"">"))
            Me.PlaceHolder1.Controls.Add(New LiteralControl("               <tr>"))
            Me.PlaceHolder1.Controls.Add(New LiteralControl("                   <td>"))
        ...
        lblRedeemAmount.Text = String.Format("{0} ({1})",
                                     udtFormatter.formatMoneyRMB(CStr(udtEHSTransaction.TransactionDetails(0).TotalAmountRMB.Value), True),
                                     udtFormatter.formatMoney(CStr(CInt(udtEHSTransaction.TransactionDetails(0).TotalAmount.Value)), True))
        ...
        tblHCVSChina.Rows(0).Cells(0).Width = intWidth
