...
Partial Public Class ucInputOTHER
    ...
    Protected Overrides Sub RenderLanguage(ByVal strErrorImageURL As String, ByVal strErrorImageALT As String)
        ...
        If Session("Language").ToString().ToUpper.Equals(Common.Component.CultureLanguage.TradChinese) Then
            strDocumentTypeFullName = udtDocTypeModelList.Filter(DocTypeCode.OTHER).DocNameChi
        Else
            strDocumentTypeFullName = udtDocTypeModelList.Filter(DocTypeCode.OTHER).DocName
        End If
        ...
        ' -------------------------- Creation ------------------------------
        If Session("Language").ToString().ToUpper.Equals(Common.Component.CultureLanguage.TradChinese) Then
            Me.lblNewDocNoText.Text = udtDocTypeModelList.Filter(DocTypeCode.OTHER).DocIdentityDescChi
        Else
            Me.lblNewDocNoText.Text = udtDocTypeModelList.Filter(DocTypeCode.OTHER).DocIdentityDesc
        End If
    ...
    Protected Overrides Sub Setup(ByVal modeType As ucInputDocTypeBase.BuildMode)
        ...
        If Me.Mode = BuildMode.Creation Then
            ...
            If Not IsNothing(MyBase.EHSPersonalInfoAmend) Then
                ...
                Me._strDocumentNo = MyBase.EHSPersonalInfoAmend.IdentityNum 'MyBase.Formatter.formatHKID(MyBase.EHSPersonalInfoAmend.IdentityNum, False)
        ...
        ElseIf Me.Mode = BuildMode.Modification_OneSide Then
            ...
            '--------------------------------------------------------
            Me.pnlNew.Visible = True
            Me.lblNewDocNo_ModifyOneSide.Visible = False
            Me.txtNewDocNo.Visible = True

            Me._strDocumentNo = MyBase.EHSPersonalInfoAmend.IdentityNum 'Formatter.formatHKID(MyBase.EHSPersonalInfoAmend.IdentityNum, False)
            Me._strENameFirstName = MyBase.EHSPersonalInfoAmend.ENameFirstName
            Me._strENameSurName = MyBase.EHSPersonalInfoAmend.ENameSurName
            Me._strCName = MyBase.EHSPersonalInfoAmend.CName
...
#Region "Set Up Text Box Value"
    ...
    Public Sub SetDocNo()
        If Mode = BuildMode.Creation Then
            ...
            Me.lblNewDocNo_ModifyOneSide.Text = String.Empty

        ElseIf Mode = BuildMode.Modification_OneSide Then
            Me.txtNewDocNo.Text = Me._strDocumentNo
            Me.lblNewDocNo_ModifyOneSide.Text = String.Empty 'MyBase.Formatter.FormatDocIdentityNoForDisplay(DocTypeCode.HKBC, MyBase.EHSPersonalInfoOriginal.IdentityNum, False, Nothing)

        Else
            'Amend
            Me.txtRegistrationNo.Text = Me._strDocumentNo
            'Orginal
...
#Region "Property"
    ...
    Public Overrides Sub SetProperty(ByVal mode As BuildMode)
        ...
        Else
            Me._strDocumentNo = Me.txtRegistrationNo.Text.Trim
