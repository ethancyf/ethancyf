...
<%@ Page Language="vb" AutoEventWireup="false" CodeBehind="ImproperAccess.aspx.vb" Inherits="HCVU.ImproperAccess" %>
...
<body>
    <form id="form1" runat="server">
        ...
        <br />
        <span style="font-size: 16pt; width: 950pt;">Concurrent access or improper access detected, the action of this browser window is aborted. 
            <br />
