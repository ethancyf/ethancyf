<%@ Page Language="vb" AutoEventWireup="false" MasterPageFile="~/MasterPage.Master"
    CodeBehind="StudentFileRectification.aspx.vb" Inherits="HCVU.StudentFileRectification"
    Title="<%$ Resources: Title, StudentFileRectification %>" EnableEventValidation="False" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    <asp:Image ID="imgHeader" runat="server" ImageUrl="<%$ Resources: ImageUrl, StudentFileRectificationBanner %>"
        AlternateText="<%$ Resources: AlternateText, StudentFileRectificationBanner %>"></asp:Image>
                ...
                <asp:View ID="vImport" runat="server">
                    ...
                    <table class="tblSF">
                        ...
                        <tr>
                            ...
                            <td>
                                <asp:TextBox ID="txtIVaccinationReportGenerateDate" runat="server" Width="100" MaxLength="10"></asp:TextBox>
                                <asp:ImageButton ID="ibtnIVaccinationReportGenerateDate" runat="server" ImageUrl="<%$ Resources:ImageUrl, CalenderBtn %>"
                                    AlternateText="<%$ Resources:AlternateText, CalenderBtn %>" Style="position: relative; top: 3px" />
                                <asp:Image ID="imgErrorIVaccinationReportGenerationDate" runat="server" ImageUrl="<%$ Resources: ImageUrl, ErrorBtn %>"
                                    AlternateText="<%$ Resources: AlternateText, ErrorBtn %>" ImageAlign="Top" />
                                <cc1:CalendarExtender ID="calIVaccinationReportGenerateDate" CssClass="ajax_cal" runat="server" PopupButtonID="ibtnIVaccinationReportGenerateDate"
                                    TargetControlID="txtIVaccinationReportGenerateDate" Format="dd-MM-yyyy" TodaysDateFormat="d MMMM, yyyy">
                                </cc1:CalendarExtender>
                                <cc1:FilteredTextBoxExtender ID="fteIVaccinationReportGenerateDate" runat="server" FilterType="Custom, Numbers"
                                    TargetControlID="txtIVaccinationReportGenerateDate" ValidChars="-">
                                </cc1:FilteredTextBoxExtender>
                            </td>
                        </tr>
                                    ...
                                    <tr>
                                        <td>
                                            <table cellpadding="0" cellspacing="0">
                                                <tr>
                                                    <td>
                                                        <asp:RadioButtonList ID="rblIStudentFile" runat="server" RepeatDirection="Vertical">
                ...
                <asp:View ID="vErrorWarning" runat="server">
                    <asp:Panel ID="panE" runat="server">
                        ...
                        <asp:GridView ID="gvE" runat="server" CssClass="gvTable" Width="1200px" AutoGenerateColumns="False" AllowPaging="True"
                            ...
                            <Columns>
                                <asp:TemplateField HeaderText="<%$ Resources: Text, SeqNo %>" ItemStyle-Width="50">
                                    <ItemTemplate>
                                ...
                                <asp:TemplateField HeaderText="<%$ Resources: Text, ContactNo2 %>">
                                    <ItemTemplate>
                                        <asp:Label ID="lblGContactNo" runat="server" Text='<%# Eval("Contact_No") %>'></asp:Label>
                                    </ItemTemplate>
                                </asp:TemplateField>
                                <asp:TemplateField HeaderText="<%$ Resources: Text, ChineseName %>">
                                    <ItemTemplate>
                                        <asp:Label ID="lblGChineseName" runat="server" Text='<%# Eval("Name_CH") %>'></asp:Label>
                                    </ItemTemplate>
                                </asp:TemplateField>
                                <asp:TemplateField HeaderText="<%$ Resources: Text, EnglishSurname %>">
                                    <ItemTemplate>
                                ...
                                <asp:TemplateField HeaderText="<%$ Resources: Text, Sex %>">
                                    <ItemTemplate>
                                        <asp:Label ID="lblGSex" runat="server" Text='<%# Eval("Sex") %>'></asp:Label>
                                    </ItemTemplate>
                                </asp:TemplateField>
                                <asp:TemplateField HeaderText="<%$ Resources: Text, DOB %>">
                                    <ItemTemplate>
                                        <asp:Label ID="lblGDOB" runat="server"></asp:Label>
                                    </ItemTemplate>
                                </asp:TemplateField>
                                <asp:TemplateField HeaderText="<%$ Resources: Text, DocumentType %>">
                                    <ItemTemplate>
                                        <asp:Label ID="lblGDocType" runat="server" Text='<%# Eval("Doc_Code") %>'></asp:Label>
                                    </ItemTemplate>
                                </asp:TemplateField>
                                <asp:TemplateField HeaderText="<%$ Resources: Text, DocumentNo %>">
                                    <ItemTemplate>
                                        <asp:Label ID="lblGDocNo" runat="server" Text='<%# Eval("Doc_No") %>'></asp:Label>
                                    </ItemTemplate>
                                </asp:TemplateField>
                                <asp:TemplateField HeaderText="<%$ Resources: Text, DateOfIssue %>">
                                    <ItemTemplate>
                                        <asp:Label ID="lblGDateOfIssue" runat="server"></asp:Label>
                                    </ItemTemplate>
                                </asp:TemplateField>
                                <asp:TemplateField HeaderText="<%$ Resources: Text, PermittedToRemainUntilID235B %>">
                                    <ItemTemplate>
                                        <asp:Label ID="lblGPermitToRemainUntil" runat="server"></asp:Label>
                                    </ItemTemplate>
                                </asp:TemplateField>
                                <asp:TemplateField HeaderText="<%$ Resources: Text, PassportNoVISA %>">
                                    <ItemTemplate>
                                        <asp:Label ID="lblGPassportNo" runat="server" Text='<%# Eval("Foreign_Passport_No")%>'></asp:Label>
                                    </ItemTemplate>
                                </asp:TemplateField>
                                <asp:TemplateField HeaderText="<%$ Resources: Text, SerialNoEC %>">
                                    <ItemTemplate>
                                        <asp:Label ID="lblGSerialNo" runat="server" Text='<%# Eval("EC_Serial_No")%>'></asp:Label>
                                    </ItemTemplate>
                                </asp:TemplateField>
                                <asp:TemplateField HeaderText="<%$ Resources: Text, ReferenceNoEC %>">
                                    <ItemTemplate>
                                        <asp:Label ID="lblGReferenceNo" runat="server" Text='<%# Eval("EC_Reference_No") %>'></asp:Label>
                                    </ItemTemplate>
                                </asp:TemplateField>
                                <asp:TemplateField HeaderText="<%$ Resources: Text, ConfirmNotToInject %>">
                                    <ItemTemplate>
                                        <asp:Label ID="lblGConfirmNotToInject" runat="server" Text='<%# Eval("Reject_Injection")%>'></asp:Label>
                                    </ItemTemplate>
                                </asp:TemplateField>
                                <asp:TemplateField HeaderText="<%$ Resources: Text, ErrorMessage %>">
                                    <ItemTemplate>
                                        <asp:Label ID="lblGErrorMessage" runat="server" Text='<%# Eval("Upload_Error") %>'></asp:Label>
                                    </ItemTemplate>
                                </asp:TemplateField>
                                <asp:TemplateField HeaderText="<%$ Resources: Text, WarningMessage %>">
                                    <ItemTemplate>
