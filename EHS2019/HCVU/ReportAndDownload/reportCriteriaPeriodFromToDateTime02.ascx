<%@ Control Language="vb" AutoEventWireup="false" CodeBehind="reportCriteriaPeriodFromToDateTime02.ascx.vb" Inherits="HCVU.reportCriteriaPeriodFromToDateTime02" %>
<%@ Register Assembly="AjaxControlToolkit" Namespace="AjaxControlToolkit" TagPrefix="cc1" %>
<table style="width: 100%" cellpadding="0" cellspacing="0" border="0">
    <tr>
        <td style="width: 200px" align="left">
            <asp:Label ID="lblInput01" runat="server" CssClass="tableTitle" Text="<%$ Resources:Text, TransactionTimeFrom %>"></asp:Label></td>
        ...
        <td style="width: 200px" align="left">
            <asp:Label ID="lblInput02" runat="server" CssClass="tableTitle" Text="<%$ Resources:Text, TransactionTimeTo %>"></asp:Label></td>
        <td style="width: 250px" align="left">
