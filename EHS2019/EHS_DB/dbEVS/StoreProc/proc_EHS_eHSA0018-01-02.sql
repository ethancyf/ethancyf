IF EXISTS (SELECT * FROM dbo.sysobjects WHERE id = OBJECT_ID(N'[dbo].[proc_EHS_eHSA0018-01-02]') AND OBJECTPROPERTY(id, N'IsProcedure') = 1)
	DROP PROCEDURE [dbo].[proc_EHS_eHSA0018-01-02]
GO
...
CREATE PROCEDURE [dbo].[proc_EHS_eHSA0018-01-02]
	@Year	int
AS BEGIN
...
-- =============================================
	...
	(0, 'eHSA0018-01: Monthly statistics of validated HCVS-eligible eHealth accounts created in 2010, broken down by professions')
...
-- =============================================
	...
	(0, 'eHSA0018-02: Validated HCVS-eligible eHealth accounts as at 31 Dec 2010, broken down by ages')
...
GRANT EXECUTE ON [dbo].[proc_EHS_eHSA0018-01-02] TO HCVU
GO
