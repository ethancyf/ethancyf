...
(
    SELECT *
    FROM dbo.sysobjects
    WHERE id = OBJECT_ID(N'[dbo].[proc_COVID19VaccineLotMapping_getAll_ForScheme]')
          AND OBJECTPROPERTY(id, N'IsProcedure') = 1
)
    BEGIN
        DROP PROCEDURE [dbo].[proc_COVID19VaccineLotMapping_getAll_ForScheme]
    END;
GO
...
-- CR No.:			CRE20-0023-90
-- Description:		Immu Record - Get all Vaccine Lot Mapping by scheme code
-- =============================================  
  
-- For Scheme (RVP)  
CREATE PROCEDURE [dbo].[proc_COVID19VaccineLotMapping_getAll_ForScheme]  
	@SP_ID CHAR(8)  = NULL,  
...
GRANT EXECUTE ON [dbo].[proc_COVID19VaccineLotMapping_getAll_ForScheme] TO HCSP;
GO

GRANT EXECUTE ON [dbo].[proc_COVID19VaccineLotMapping_getAll_ForScheme] TO HCVU;
GO
