IF EXISTS (SELECT * FROM dbo.sysobjects WHERE id = OBJECT_ID(N'[dbo].[proc_ServiceProviderOriginal_get_byERN]') AND OBJECTPROPERTY(id, N'IsProcedure') = 1)
	DROP PROCEDURE [dbo].[proc_ServiceProviderOriginal_get_byERN]
GO
...
-- =============================================
CREATE PROCEDURE [dbo].[proc_ServiceProviderOriginal_get_byERN]
...
GRANT EXECUTE ON [dbo].[proc_ServiceProviderOriginal_get_byERN] TO HCVU
GO
