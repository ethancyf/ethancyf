IF EXISTS (SELECT * FROM dbo.sysobjects WHERE id = OBJECT_ID(N'[dbo].[proc_PracticeSchemeInfoEnrolment_get_byERN]') AND OBJECTPROPERTY(id, N'IsProcedure') = 1)
	DROP PROCEDURE [dbo].[proc_PracticeSchemeInfoEnrolment_get_byERN]
GO
...
-- Description:		Get the practice scheme infromation in enrolment
-- =============================================
-- =============================================
-- Modification History
...
-- Description:	
-- =============================================
CREATE Procedure [dbo].[proc_PracticeSchemeInfoEnrolment_get_byERN]
...
GRANT EXECUTE ON [dbo].[proc_PracticeSchemeInfoEnrolment_get_byERN] TO HCPUBLIC
GO
