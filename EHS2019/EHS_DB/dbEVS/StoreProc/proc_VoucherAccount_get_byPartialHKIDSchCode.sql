IF EXISTS (SELECT * FROM dbo.sysobjects WHERE id = OBJECT_ID(N'[dbo].[proc_VoucherAccount_get_byPartialHKIDSchCode]') AND OBJECTPROPERTY(id, N'IsProcedure') = 1)
	DROP PROCEDURE [dbo].[proc_VoucherAccount_get_byPartialHKIDSchCode]
GO
...
--			    Account information by Partial HKID and Scheme Code
-- =============================================
-- =============================================
-- Modification History
-- Modified by:
...
--CREATE PROCEDURE [dbo].[proc_VoucherAccount_get_byPartialHKIDSchCode]
--	@HKID char(7),
...
--GRANT EXECUTE ON [dbo].[proc_VoucherAccount_get_byPartialHKIDSchCode] TO HCPUBLIC
--GO

--GRANT EXECUTE ON [dbo].[proc_VoucherAccount_get_byPartialHKIDSchCode] TO HCSP
--GO

--GRANT EXECUTE ON [dbo].[proc_VoucherAccount_get_byPartialHKIDSchCode] TO HCVU
--GO
