IF EXISTS (SELECT * FROM dbo.sysobjects WHERE id = OBJECT_ID(N'[dbo].[proc_StudentFileEntryStaging_get]') AND OBJECTPROPERTY(id, N'IsProcedure') = 1)
	DROP PROCEDURE [dbo].[proc_StudentFileEntryStaging_get]
GO
...
CREATE PROCEDURE [dbo].[proc_StudentFileEntryStaging_get]
...
GRANT EXECUTE ON [dbo].[proc_StudentFileEntryStaging_get] TO HCSP
GO

GRANT EXECUTE ON [dbo].[proc_StudentFileEntryStaging_get] TO HCVU
GO
