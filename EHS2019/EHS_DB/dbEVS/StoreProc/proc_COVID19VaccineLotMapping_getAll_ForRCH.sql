...
(
    SELECT *
    FROM dbo.sysobjects
    WHERE id = OBJECT_ID(N'[dbo].[proc_COVID19VaccineLotMapping_getAll_ForRCH]')
          AND OBJECTPROPERTY(id, N'IsProcedure') = 1
)
    BEGIN
        DROP PROCEDURE [dbo].[proc_COVID19VaccineLotMapping_getAll_ForRCH]
    END;
GO
...
-- For Scheme (RVP)  
CREATE PROCEDURE [dbo].[proc_COVID19VaccineLotMapping_getAll_ForRCH]  
 @SP_ID CHAR(8)  = NULL,  
...
GRANT EXECUTE ON [dbo].[proc_COVID19VaccineLotMapping_getAll_ForRCH] TO HCSP;
GO
GRANT EXECUTE ON [dbo].[proc_COVID19VaccineLotMapping_getAll_ForRCH] TO HCVU;
