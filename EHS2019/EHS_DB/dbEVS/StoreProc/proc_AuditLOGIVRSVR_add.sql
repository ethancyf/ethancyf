IF EXISTS (SELECT * FROM dbo.sysobjects WHERE id = OBJECT_ID(N'[dbo].[proc_AuditLOGIVRSVR_add]') AND OBJECTPROPERTY(id, N'IsProcedure') = 1)
	DROP PROCEDURE [dbo].[proc_AuditLOGIVRSVR_add]
GO
...
CREATE procedure [dbo].[proc_AuditLOGIVRSVR_add]
...
-- =============================================
	...
	INSERT INTO [dbo].[ViewAuditLogIVRSVR]
	(
		System_Dtm,
		E_System_Dtm,
		E_Action_Dtm,
...
GRANT EXECUTE ON [dbo].[proc_AuditLOGIVRSVR_add] TO HCPUBLIC
GO
