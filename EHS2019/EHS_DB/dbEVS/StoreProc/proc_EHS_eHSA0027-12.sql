IF EXISTS (SELECT * FROM dbo.sysobjects WHERE id = OBJECT_ID(N'[dbo].[proc_EHS_eHSA0027-12]') AND OBJECTPROPERTY(id, N'IsProcedure') = 1)
	DROP PROCEDURE [dbo].[proc_EHS_eHSA0027-12]
GO
...
CREATE PROCEDURE [dbo].[proc_EHS_eHSA0027-12]
	@Year	int
AS BEGIN
...
-- ---------------------------------------------
	...
	(0, 'eHSA0027-12: Statistics of EHCPs with claimed vouchers in '+@strYear+', broken down by professions')
...
GRANT EXECUTE ON [dbo].[proc_EHS_eHSA0027-12] TO HCVU
GO
