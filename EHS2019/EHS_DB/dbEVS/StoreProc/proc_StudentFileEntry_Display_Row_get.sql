IF EXISTS (SELECT * FROM dbo.sysobjects WHERE id = OBJECT_ID(N'[dbo].[proc_StudentFileEntry_Display_Row_get]') AND OBJECTPROPERTY(id, N'IsProcedure') = 1)
	DROP PROCEDURE [dbo].[proc_StudentFileEntry_Display_Row_get]
GO
...
-- CR No.			CRE20-003
-- Description:		For display vaccination file entry
-- =============================================

CREATE PROCEDURE [dbo].[proc_StudentFileEntry_Display_Row_get]
...
GRANT EXECUTE ON [dbo].[proc_StudentFileEntry_Display_Row_get] TO HCSP
GO

GRANT EXECUTE ON [dbo].[proc_StudentFileEntry_Display_Row_get] TO HCVU
GO
