IF EXISTS (SELECT * FROM dbo.sysobjects WHERE id = OBJECT_ID(N'[dbo].[proc_PracticeSchemeInfoEnrolment_get_byERN_HCVU]') AND OBJECTPROPERTY(id, N'IsProcedure') = 1)
	DROP PROCEDURE [dbo].[proc_PracticeSchemeInfoEnrolment_get_byERN_HCVU]
GO
...
-- =============================================
-- Author:			Kathy LEE
-- Create date:		06 August 2009
-- Description:		Get the practice scheme infromation in enrolment from
--					PracticeSchemeInfoEnrolment, SchemeBackOffice and SubsidizeGroupBackOffice
-- =============================================
-- =============================================
-- Modification History
-- Modified by:		Kathy LEE
-- Modified date:	10 August 2009
-- Description:		Get the setting (Y/N) from systemparameters whether carry the service fee
--					(23vPV + ESIV) to HCVU
-- =============================================
-- =============================================
-- Modification History
...
-- Description:	
-- =============================================
CREATE Procedure [dbo].[proc_PracticeSchemeInfoEnrolment_get_byERN_HCVU]
...
GRANT EXECUTE ON [dbo].[proc_PracticeSchemeInfoEnrolment_get_byERN_HCVU] TO HCVU
GO
