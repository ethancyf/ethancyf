IF EXISTS (SELECT * FROM dbo.sysobjects WHERE id = OBJECT_ID(N'[dbo].[proc_TSWPatientMappingTransition_add]') AND OBJECTPROPERTY(id, N'IsProcedure') = 1)
	DROP PROCEDURE [dbo].[proc_TSWPatientMappingTransition_add]
GO
...
-- Description:		Add the content in TSWPatientMappingTransition
-- =============================================
-- =============================================
-- Modification History
...
-- =============================================
CREATE PROCEDURE [dbo].[proc_TSWPatientMappingTransition_add]
...
-- =============================================
	...
	INSERT INTO [TSWPatientMappingTransition] 
...
GRANT EXECUTE ON [dbo].[proc_TSWPatientMappingTransition_add] TO HCVU
GO
