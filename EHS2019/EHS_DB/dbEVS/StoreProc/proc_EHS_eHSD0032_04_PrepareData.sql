IF EXISTS (SELECT * FROM dbo.sysobjects WHERE id = OBJECT_ID(N'[dbo].[proc_EHS_eHSD0032_04_PrepareData]') AND OBJECTPROPERTY(id, N'IsProcedure') = 1)
	DROP PROCEDURE [dbo].[proc_EHS_eHSD0032_04_PrepareData]
GO
...
-- Description:		PPP daily report - Sub report 04 Raw data
-- =============================================    
    
CREATE Procedure [proc_EHS_eHSD0032_04_PrepareData]    
...
-- ---------------------------------------------          
	...
	VALUES (0, 'eHS(S)D0032-04: Raw Data of PPP-PS claim transactions')    
	...
	-- Return result          
	-- =============================================          
	DELETE FROM [RpteHSD0032_04_PPP_Tx_Raw]
	INSERT INTO [RpteHSD0032_04_PPP_Tx_Raw] (
		Display_Seq,
		Col1,
		Col2,
		Col3,
...
GRANT EXECUTE ON [dbo].[proc_EHS_eHSD0032_04_PrepareData] TO HCVU
GO
