IF EXISTS (SELECT * FROM dbo.sysobjects WHERE id = OBJECT_ID(N'[dbo].[proc_StudentFileEntry_upd_VaccineRefStatus]') AND OBJECTPROPERTY(id, N'IsProcedure') = 1)
	DROP PROCEDURE [dbo].[proc_StudentFileEntry_upd_VaccineRefStatus]
GO
...
-- Description:		Update DH, HA vaccine ref status in StudentFileEntryVaccine
-- =============================================

CREATE PROCEDURE [dbo].[proc_StudentFileEntry_upd_VaccineRefStatus]
...
-- =============================================
	...
	IF @Provider = 'HA'
		UPDATE StudentFileEntry SET Ext_Ref_Status = @Vaccine_Ref_Status, 
	...
	ELSE IF @Provider = 'DH'
		UPDATE StudentFileEntry SET DH_Vaccine_Ref_Status = @Vaccine_Ref_Status, 
...
GRANT EXECUTE ON [dbo].[proc_StudentFileEntry_upd_VaccineRefStatus] TO HCVU
GO
