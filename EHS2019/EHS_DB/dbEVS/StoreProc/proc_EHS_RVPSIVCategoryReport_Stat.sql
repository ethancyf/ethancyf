IF EXISTS (SELECT * FROM dbo.sysobjects WHERE id = OBJECT_ID(N'[dbo].[proc_EHS_RVPSIVCategoryReport_Stat]') AND OBJECTPROPERTY(id, N'IsProcedure') = 1)
	DROP PROCEDURE [dbo].[proc_EHS_RVPSIVCategoryReport_Stat]
GO
...
-- Description:  Modify from [proc_EHS_RVPHSIVCategoryReport_Stat], get SIV instead of HSIV from 2010 season     
-- =============================================    
   
/*    
CREATE PROCEDURE [dbo].[proc_EHS_RVPSIVCategoryReport_Stat]     
 @Cutoff_Dtm datetime    
AS BEGIN    
-- =============================================    
-- Constant    
...
GRANT EXECUTE ON [dbo].[proc_EHS_RVPSIVCategoryReport_Stat] TO HCVU
GO
*/