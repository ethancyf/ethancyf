IF EXISTS (SELECT * FROM dbo.sysobjects WHERE id = OBJECT_ID(N'[dbo].[proc_PracticeSchemeInformation_get_bySPID_ServiceDate]') AND OBJECTPROPERTY(id, N'IsProcedure') = 1)
	DROP PROCEDURE [dbo].[proc_PracticeSchemeInformation_get_bySPID_ServiceDate]
GO
...
CREATE PROCEDURE [dbo].[proc_PracticeSchemeInformation_get_bySPID_ServiceDate]
	@sp_id			CHAR(8),
...
GRANT EXECUTE ON [dbo].[proc_PracticeSchemeInformation_get_bySPID_ServiceDate] TO HCVU
GO

GRANT EXECUTE ON [dbo].[proc_PracticeSchemeInformation_get_bySPID_ServiceDate] TO WSEXT
Go

GRANT EXECUTE ON [dbo].[proc_PracticeSchemeInformation_get_bySPID_ServiceDate] TO WSINT
GO
