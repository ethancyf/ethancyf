IF EXISTS (SELECT * FROM dbo.sysobjects WHERE id = OBJECT_ID(N'[dbo].[proc_COVID19VaccineLotMapping_get_byRCHCode]') AND OBJECTPROPERTY(id, N'IsProcedure') = 1)
	DROP PROCEDURE [dbo].[proc_COVID19VaccineLotMapping_get_byRCHCode]
GO
...
CREATE PROCEDURE [dbo].[proc_COVID19VaccineLotMapping_get_byRCHCode]
	@RCHCode CHAR(10)
AS
BEGIN
-- =============================================
...
-- =============================================
	...
	WHERE
		VLM.[Service_Type] = 'RCH'
		AND VLM.[Record_Status] = 'A'
		AND VLM.[Lot_Status] = 'A'
		AND VLM.[RCH_Code] = @RCHCode
	ORDER BY 
		VBD.[Brand_Name],
		VLM.[Vaccine_Lot_ID]
END
...
GRANT EXECUTE ON [dbo].[proc_COVID19VaccineLotMapping_get_byRCHCode] TO HCSP

GRANT EXECUTE ON [dbo].[proc_COVID19VaccineLotMapping_get_byRCHCode] TO HCVU
