IF EXISTS (SELECT * FROM dbo.sysobjects WHERE id = OBJECT_ID(N'[dbo].[proc_CMS_AuditLog_GetVaccinationEnd_ByDtm]') AND OBJECTPROPERTY(id, N'IsProcedure') = 1)
	DROP PROCEDURE [dbo].[proc_CMS_AuditLog_GetVaccinationEnd_ByDtm]
GO
...
CREATE PROCEDURE [dbo].[proc_CMS_AuditLog_GetVaccinationEnd_ByDtm]
	@Start_Dtm		datetime,
	@End_Dtm		datetime,
...
-- =============================================
	...
	BEGIN
		INSERT INTO @Log_ID_Master (Log_ID) VALUES ('01004')	-- Get CMS Vaccination complete
		INSERT INTO @Log_ID_Master (Log_ID) VALUES ('01005')	-- Get CMS Vaccination complete: No record found
		INSERT INTO @Log_ID_Master (Log_ID) VALUES ('01007')	-- Get CMS Vaccination fail: Patient not found
		INSERT INTO @Log_ID_Master (Log_ID) VALUES ('01008')	-- Get CMS Vaccination fail: Patient not match
	...
	BEGIN
		INSERT INTO @Log_ID_Master (Log_ID) VALUES ('01104')	-- Get CIMS Vaccination complete
		INSERT INTO @Log_ID_Master (Log_ID) VALUES ('01105')	-- Get CIMS Vaccination complete: No record found
		INSERT INTO @Log_ID_Master (Log_ID) VALUES ('01107')	-- Get CIMS Vaccination fail: Client not found
		INSERT INTO @Log_ID_Master (Log_ID) VALUES ('01108')	-- Get CIMS Vaccination fail: Client not match
...
GRANT EXECUTE ON [dbo].[proc_CMS_AuditLog_GetVaccinationEnd_ByDtm] TO HCVU
GO
