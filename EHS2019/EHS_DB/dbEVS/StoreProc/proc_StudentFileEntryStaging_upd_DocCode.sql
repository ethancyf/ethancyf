IF EXISTS (SELECT * FROM dbo.sysobjects WHERE id = OBJECT_ID(N'[dbo].[proc_StudentFileEntryStaging_upd_DocCode]') AND OBJECTPROPERTY(id, N'IsProcedure') = 1)
	DROP PROCEDURE [dbo].[proc_StudentFileEntryStaging_upd_DocCode]
GO
...
GRANT EXECUTE ON [dbo].[proc_StudentFileEntryStaging_upd_DocCode] TO HCVU
GRANT EXECUTE ON [dbo].[proc_StudentFileEntryStaging_upd_DocCode] TO HCSP
GO
