IF EXISTS (SELECT * FROM dbo.sysobjects WHERE id = OBJECT_ID(N'[dbo].[proc_StudentFileEntry_upd_TempVoucherAcc]') AND OBJECTPROPERTY(id, N'IsProcedure') = 1)
	DROP PROCEDURE [dbo].[proc_StudentFileEntry_upd_TempVoucherAcc]
GO
...
-- CR No.			CRE19-001
-- Description:		Update TempVoucherAcc in SP platform
-- =============================================

CREATE PROCEDURE [dbo].[proc_StudentFileEntry_upd_TempVoucherAcc]
...
GRANT EXECUTE ON [dbo].[proc_StudentFileEntry_upd_TempVoucherAcc] TO HCSP

GRANT EXECUTE ON [dbo].[proc_StudentFileEntry_upd_TempVoucherAcc] TO HCVU
