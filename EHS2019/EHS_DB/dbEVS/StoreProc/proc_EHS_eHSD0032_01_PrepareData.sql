IF EXISTS (SELECT * FROM dbo.sysobjects WHERE id = OBJECT_ID(N'[dbo].[proc_EHS_eHSD0032_01_PrepareData]') AND OBJECTPROPERTY(id, N'IsProcedure') = 1)
	DROP PROCEDURE [dbo].[proc_EHS_eHSD0032_01_PrepareData]
GO
...
-- Description:		New Doc Type [RFNo8]
-- =============================================
-- =============================================    
-- CR No.:			CRE17-018-07
-- Author:			Winnie SUEN
-- Create date:		28 Sep 2018
-- Description:		PPP daily report - eHS(S)D0032-01: Report on eHealth (Subsidies) accounts created (by document type)
-- =============================================  


CREATE PROCEDURE [proc_EHS_eHSD0032_01_PrepareData] 
...
BEGIN
	...
	VALUES (0, 'eHS(S)D0032-01: Report on eHealth (Subsidies) accounts created (by document type)')
	...
	--=======================================
	-- (ii) eHealth (Subsidies) accounts with PPP claim transactions
	--=======================================
	...
	--===================================
	DELETE FROM RpteHSD0032_01_PPP_eHA_ByDocType
	
	INSERT INTO RpteHSD0032_01_PPP_eHA_ByDocType (
		Display_Seq,
		Col1,
		Col2,
		Col3,
...
GRANT EXECUTE ON [dbo].[proc_EHS_eHSD0032_01_PrepareData] TO HCVU
GO
