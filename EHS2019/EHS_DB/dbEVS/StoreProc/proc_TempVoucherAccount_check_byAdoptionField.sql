IF EXISTS (SELECT * FROM dbo.sysobjects WHERE id = OBJECT_ID(N'[dbo].[proc_TempVoucherAccount_check_byAdoptionField]') AND OBJECTPROPERTY(id, N'IsProcedure') = 1)
	DROP PROCEDURE [dbo].[proc_TempVoucherAccount_check_byAdoptionField]
GO
...
CREATE PROCEDURE [dbo].[proc_TempVoucherAccount_check_byAdoptionField]
	@Doc_Code char(20),
	@identity varchar(20),
...
GRANT EXECUTE ON [dbo].[proc_TempVoucherAccount_check_byAdoptionField] TO HCSP
GO

GRANT EXECUTE ON [dbo].[proc_TempVoucherAccount_check_byAdoptionField] TO HCVU
GO

GRANT EXECUTE ON [dbo].[proc_TempVoucherAccount_check_byAdoptionField] TO WSEXT
Go
