IF EXISTS (SELECT * FROM sysobjects WHERE type = 'TR' AND name = 'tri_PersonalInformation_after_del')
	DROP TRIGGER [dbo].[tri_PersonalInformation_after_del]
GO
...
-- Modified date:   05 Jan 2011
-- Description:	    insert record for delete acion
-- =============================================
-- =============================================
-- Modification History
...
--				when a row is deleted from PersonalInformation
-- =============================================
-- =============================================
-- Modification History
-- Modified by:		Kathy LEE
...
-- =============================================
Create TRIGGER [dbo].[tri_PersonalInformation_after_del]
