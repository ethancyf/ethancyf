IF EXISTS (SELECT * FROM sysobjects WHERE type = 'TR' AND name = 'tri_SpecialPersonalInformation_after_upd')
	DROP TRIGGER [dbo].[tri_SpecialPersonalInformation_after_upd]
GO
...
-- Description:		Trigger an insert statement into SpecialPersonalInformationLOG when a row is inserted / updated into SpecialPersonalInformation
-- =============================================


CREATE TRIGGER [dbo].[tri_SpecialPersonalInformation_after_upd]
