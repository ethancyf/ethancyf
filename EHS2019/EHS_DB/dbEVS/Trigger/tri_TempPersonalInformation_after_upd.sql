IF EXISTS (SELECT * FROM sysobjects WHERE type = 'TR' AND name = 'tri_TempPersonalInformation_after_upd')
	DROP TRIGGER [dbo].[tri_TempPersonalInformation_after_upd]
GO
...
--				when a row is updated / inserted into TempPersonalInformation
-- =============================================
-- =============================================
-- Modification History
...
-- =============================================
Create TRIGGER [dbo].[tri_TempPersonalInformation_after_upd]
