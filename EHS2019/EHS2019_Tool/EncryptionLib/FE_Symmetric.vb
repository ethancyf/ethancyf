...
Public Class FE_Symmetric
    ...
    Public Function GetOriginalKey(decryptKey As String) As String
        Try
            Dim keyToDecrypt() As Byte = Convert.FromBase64String(decryptKey)
    ...
    Public Function DecryptString(ByVal _strSource As String, ByVal _strKey As String) As String
        Dim gstrSource As String = _strSource
        Dim strResult As String
        _strKey = GetOriginalKey(_strKey)
        strResult = DecryptData(_strKey, gstrSource)
        Return strResult
    End Function

    Public Function ScrambleKey(ByVal iKey As String) As String
