<%@ Control Language="vb" AutoEventWireup="false" CodeBehind="ucInputENHVSSO.ascx.vb" Inherits="HCSP.ucInputENHVSSO" %>
<%@ Register Assembly="HCSP" Namespace="HCSP" TagPrefix="cc1" %>

    <asp:Panel ID="panENHVSSOCategory" runat="server">
        <table border="0" style="padding:0px;border-collapse:collapse;border-spacing:0">
            <tr>
        ...
        <asp:MultiView ID="mvCategory" runat="server" ActiveViewIndex="0" >
            ...
            <asp:View ID="vwChildren" runat="server">
                <asp:Panel ID="panReminder" runat="server" Visible="false">
                    <table border="0"  style="padding:0px;border-collapse:collapse;border-spacing:0;width:800px">
                        <tr>
        ...
        <table style="border-collapse: collapse; border-spacing:0px">
            <tr id="trPlaceOfVaccination" runat="server">
                ...
                <td style="vertical-align:top;padding: 0px 0px 0px 0px;">
                    <asp:DropDownList ID="ddlPlaceOfVaccination" runat="server" Width="460px" AutoPostBack="false"></asp:DropDownList>
                </td>   
