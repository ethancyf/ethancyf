<%@ Control Language="vb" AutoEventWireup="false" Codebehind="ucReadOnlyHKBC.ascx.vb" Inherits="HCSP.UIControl.DocTypeText.ucReadOnlyHKBC" %>
<asp:Panel ID="panReadonlyVerticalHKBC" runat="server">
    ...
    <table id="tblHKBC" runat="server" cellpadding="0" cellspacing="0" class="textVersionTable">
        <tbody>
            <tr>
                <td valign="top">
