<%@ Control Language="vb" AutoEventWireup="false" Codebehind="ucReadOnlyVISA.ascx.vb" Inherits="HCSP.UIControl.DocTypeText.ucReadOnlyVISA" %>
<asp:Panel ID="panReadonlyVerticalVISA" runat="server">
    ...
    <table id="tblVISA" runat="server" cellpadding="0" cellspacing="0" class="textVersionTable">
        <tbody>
            <tr>
                <td valign="top">
            ...
            <tr>
                <td valign="top">
                    <asp:Label ID="lblReadonlyVISANoText" runat="server" CssClass="tableTitle" ></asp:Label></td>
            </tr>
            <tr>
                <td valign="top">
            ...
            <tr>
                <td valign="top">
                    <asp:Label ID="lblReadonlyPassportNoText" runat="server" CssClass="tableTitle" ></asp:Label></td>
            </tr>
            <tr>
                <td valign="top">
            ...
            <tr>
                <td valign="top">
                    <asp:Label ID="lblReadonlyGenderText" runat="server" CssClass="tableTitle" ></asp:Label>
                </td>
            </tr>
            <tr>
                <td valign="top">
