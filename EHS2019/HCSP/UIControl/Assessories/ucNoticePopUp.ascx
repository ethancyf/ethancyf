...
<table id="tblPopup" runat="server" border="0" cellpadding="0" cellspacing="0" width="100%">
    ...
    <tr>
        ...
        <td style="background-color: #ffffff">
            <table cellpadding="0" cellspacing="0" style="width:100%;padding-top:5px; padding-bottom:5px; padding-left:5px; padding-right:5px;">
                <tr>
                    <td>
                        <%------------------- Notification -----------------%>
                        <%---------------------------------------------%>
                        <table>
                            ...
                            <%-- Display message --%>
                            <tr>
                                <td align="right" style="width: 5%; height: 42px; padding-right:10px;" valign="top">
                                    <asp:Image ID="imgIcon" runat="server" ImageUrl="" /></td>
                                <td colspan="2" align="left" style="width: 85%; height: 42px">
