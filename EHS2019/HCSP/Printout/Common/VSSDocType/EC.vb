...
Namespace PrintOut.Common.VSSDocType
    Public Class EC
        ...
        Private Sub LoadReport()
            ...
            If strECNo = String.Empty Then strECNo = HttpContext.GetGlobalResourceObject("Text", "NotProvided", New System.Globalization.CultureInfo(CultureLanguage.English))
