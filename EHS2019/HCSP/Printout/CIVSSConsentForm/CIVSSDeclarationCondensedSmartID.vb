...
Namespace PrintOut.CIVSSConsentForm
    Public Class CIVSSDeclarationCondensedSmartID
...
#End Region
        ...
        Private Sub LoadReport()
            ...
            If strSPName.Length <= 20 Then
                srDeclaration.Report = New CIVSSDeclarationCondensedSmartIDSPName20(_udtSP)

            ElseIf strSPName.Length <= 30 Then
                srDeclaration.Report = New CIVSSDeclarationCondensedSmartIDSPName30(_udtSP)

            Else
                srDeclaration.Report = New CIVSSDeclarationCondensedSmartIDSPName40(_udtSP)
            End If
