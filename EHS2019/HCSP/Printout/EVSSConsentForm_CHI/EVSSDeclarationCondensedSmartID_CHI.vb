        ...
        Private Sub FillSPName()
            ...
            If String.IsNullOrEmpty(strSPChineseName) Then
                ...
                If strSPEnglishName.Length <= 20 Then
                    srDeclaration.Report = New EVSSDeclarationCondensedSmartIDSPName20_CHI(_udtSP)
                ElseIf strSPEnglishName.Length <= 30 Then
                    srDeclaration.Report = New EVSSDeclarationCondensedSmartIDSPName30_CHI(_udtSP)
                Else
                    srDeclaration.Report = New EVSSDeclarationCondensedSmartIDSPName40_CHI(_udtSP)
                End If
            Else
                ' Show Chinese Name
                srDeclaration.Report = New EVSSDeclarationCondensedSmartIDSPName6_CHI(_udtSP)
            End If
        End Sub
