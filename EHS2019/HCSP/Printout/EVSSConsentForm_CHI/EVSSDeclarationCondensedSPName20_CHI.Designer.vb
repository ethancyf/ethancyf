Namespace PrintOut.EVSSConsentForm_CHI
    ...
    Partial Public Class EVSSDeclarationCondensedSPName20_CHI
        ...
        Private Sub InitializeComponent()
            Dim resources As System.Resources.ResourceManager = New System.Resources.ResourceManager(GetType(EVSSDeclarationCondensedSPName20_CHI))
            ...
            'Detail
            '
            Me.Detail.Controls.AddRange(New GrapeCity.ActiveReports.SectionReportModel.ARControl() {Me.TextBox48, Me.txtDeclaration4Value, Me.txtDocumentExplainedBy, Me.TextBox1, Me.TextBox13})
            ...
            Me.txtDocumentExplainedBy.Width = 1.9!
            '
            'TextBox1
            '
        ...
        "; ddo-char-set: 136"
            ...
            Me.TextBox13.Text = "資料」內所載的承諾及聲明。本人明白和同意該等承諾及聲明的內容。"
            Me.TextBox13.Top = 0.23!
            Me.TextBox13.Width = 7.375!
            '
            'EVSSDeclarationCondensedSPName20_CHI
            '
