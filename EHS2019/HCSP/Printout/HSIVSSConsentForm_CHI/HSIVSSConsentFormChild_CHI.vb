...
Namespace PrintOut.HSIVSSConsentForm_CHI
    Public Class HSIVSSConsentFormChild_CHI
...
#End Region
        ...
        Private Sub LoadReport()
            ...
            If Not _udtSmartIDContent Is Nothing AndAlso _udtSmartIDContent.IsReadSmartID Then
                srDeclaration.Report = New HSIVSSDeclarationSmartID_CHI(False, _udtSP, _udtEHSAccount, _udtEHSTransaction, _udtSchemeClaim)
            ...
            Else
                srDeclaration.Report = New HSIVSSDeclaration_CHI(False, _udtSP, _udtEHSAccount, _udtEHSTransaction, _udtSchemeClaim)
