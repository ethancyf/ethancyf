...
Namespace PrintOut.HSIVSSConsentForm_CHI
    Public Class HSIVSSConsentCondensedFormAdult_CHI
...
#End Region
        ...
        Private Sub LoadReport()
            ...
            ' Declaration
            srDeclaration.Report = New HSIVSSDeclarationCondensed_CHI(True, _udtSP, _udtEHSAccount, _udtEHSTransaction, _udtSchemeClaim)

            ' Document Explained By
            If Not _udtSmartIDContent Is Nothing AndAlso _udtSmartIDContent.IsReadSmartID Then
                srDeclarationExplainedBy.Report = New HSIVSSDeclarationCondensedDeclarationSmartID_CHI(True)
