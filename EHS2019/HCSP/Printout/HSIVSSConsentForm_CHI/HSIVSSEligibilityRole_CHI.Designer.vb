Namespace PrintOut.HSIVSSConsentForm_CHI
    ...
    Partial Public Class HSIVSSEligibilityRole_CHI
        ...
        Private Sub InitializeComponent()
            Dim resources As System.Resources.ResourceManager = New System.Resources.ResourceManager(GetType(HSIVSSEligibilityRole_CHI))
            ...
            Me.txtDescription.Style = "ddo-char-set: 1; text-align: justify; font-style: normal; font-size: 10.5pt; font" & _
                "-family: HA_MingLiu; white-space: inherit; "
            Me.txtDescription.Text = Nothing
            Me.txtDescription.Top = 0.0!
            Me.txtDescription.Width = 6.688!
            '
            'HSIVSSEligibilityRoleStudent_CHI
            '
