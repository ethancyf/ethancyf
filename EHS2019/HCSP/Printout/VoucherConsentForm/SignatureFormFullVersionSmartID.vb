    ...
    Public Class SignatureFormFullVersionSmartID
        ...
        Private Sub SetControlPosition(ByVal strSPName As String, ByVal strDocCode As String)
            If strSPName.Length <= 20 Then
                ...
                Me.sreDeclaration3.Report = New PrintOut.VoucherConsentForm.ClaimConsentDecaraDeclaration3FullVersionSPName20(strSPName)
            ElseIf strSPName.Length <= 30 Then
                ...
                Me.sreDeclaration3.Report = New PrintOut.VoucherConsentForm.ClaimConsentDecaraDeclaration3FullVersionSPName30(strSPName)
            ElseIf strSPName.Length <= 40 Then
                ...
                Me.sreDeclaration3.Report = New PrintOut.VoucherConsentForm.ClaimConsentDecaraDeclaration3FullVersionSPName40(strSPName)
            End If
        End Sub
