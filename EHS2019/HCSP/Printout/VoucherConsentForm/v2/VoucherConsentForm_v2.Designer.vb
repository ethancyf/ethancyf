Namespace PrintOut.VoucherConsentForm
    ...
    Partial Public Class VoucherConsentForm_v2
        ...
        Private Sub InitializeComponent()
            Dim resources As System.ComponentModel.ComponentResourceManager = New System.ComponentModel.ComponentResourceManager(GetType(VoucherConsentForm_v2))
            Me.detConsentForm = New GrapeCity.ActiveReports.SectionReportModel.Detail()
            Me.txtAppendix = New GrapeCity.ActiveReports.SectionReportModel.TextBox()
            ...
            Me.txtConsentTitle = New GrapeCity.ActiveReports.SectionReportModel.TextBox()
            Me.pbkAppendix = New GrapeCity.ActiveReports.SectionReportModel.PageBreak()
            ...
            'detConsentForm
            '
            Me.detConsentForm.Controls.AddRange(New GrapeCity.ActiveReports.SectionReportModel.ARControl() {Me.txtAppendix, Me.txtTransactionNumberText, Me.txtVoidTransactionNumberText, Me.txtTransactionNumber, Me.txtVoidTransactionNumber, Me.txtTransactionToText, Me.txtConsentTitle, Me.pbkAppendix, Me.txtPurpose, Me.txtPurposeCollection, Me.txtClassesTransferees, Me.txtPurposeCollection1, Me.txtPurposeCollection1Number, Me.txtPurposeCollection1a, Me.txtPurposeCollection1aText, Me.txtPurposeCollection1b, Me.txtPurposeCollection1bText, Me.txtPurposeCollection1c, Me.txtPurposeCollection1cText, Me.TextBox67, Me.TextBox68, Me.txtClassesTransferees1, Me.txtClassesTransferees1Number, Me.txtPersonalData, Me.txtPersonalData1Number, Me.txtPersonalData1, Me.txtEnquiries, Me.txtEnquiries1Number, Me.txtEnquiries1, Me.txtTransactionTo, Me.txtHCVUInfo, Me.TextBox1, Me.sreSPConsent1, Me.sreDeclaration, Me.sreVoucherNotice})
            Me.detConsentForm.Height = 8.59375!
            ...
            Me.txtAppendix.Style = "font-size: 11.25pt; font-weight: bold; text-align: right; text-decoration: underl" & _
        "ine"
            ...
            Me.txtConsentTitle.Style = "font-size: 11.25pt; font-weight: bold; text-align: justify"
            Me.txtConsentTitle.Text = "Undertaking and Declaration"
        ...
        "0"
            Me.TextBox68.Text = "The provision of personal data is voluntary. If the voucher recipient/witness/gua" & _
        "rdian do not provide sufficient information, the voucher recipient may not be ab" & _
        "le to use the voucher(s)."
        ...
        Friend WithEvents txtConsentTitle As GrapeCity.ActiveReports.SectionReportModel.TextBox
        Friend WithEvents pbkAppendix As GrapeCity.ActiveReports.SectionReportModel.PageBreak
        Friend WithEvents txtAppendix As GrapeCity.ActiveReports.SectionReportModel.TextBox
        ...
        Friend WithEvents sreSPConsent1 As GrapeCity.ActiveReports.SectionReportModel.SubReport
        Friend WithEvents sreDeclaration As GrapeCity.ActiveReports.SectionReportModel.SubReport
