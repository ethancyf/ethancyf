...
#End Region
        ...
        Private Sub LoadReport()
            ...
            If Not Me._udtSmartIDContent Is Nothing AndAlso Me._udtSmartIDContent.IsReadSmartID Then
                srDeclaration.Report = New EVSSDeclarationCondensedSmartID(_udtSP)
                ' Me.txtPageName.Text = "DH_EVSS(02/10)"
                Me.txtPageName.Text = _udtPrintoutHelper.GetPrintoutVersionCode(Scheme.SchemeClaimModel.EVSS, Common.PrintoutHelper.PrintoutVersion.CondensedEnglishSmartID)
            Else
                srDeclaration.Report = New EVSSDeclarationCondensed(_udtSP)
                ' Me.txtPageName.Text = "DH_EVSS(06/09)"
                Me.txtPageName.Text = _udtPrintoutHelper.GetPrintoutVersionCode(Scheme.SchemeClaimModel.EVSS, Common.PrintoutHelper.PrintoutVersion.CondensedEnglish)
            End If
