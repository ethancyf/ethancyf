            ...
            For Each udtSubsidizeGroupClaim As SubsidizeGroupClaimModel In udtServiceSchemeClaimModel.SubsidizeGroupClaimList
                ...
                If udtTransactionDetails.Count > 0 Then
                    For Each udtTransactionDetail As TransactionDetailModel In udtTransactionDetails
                        Dim strDescription As String = udtPrintoutHelper.GetDoseDescription(udtSubsidizeGroupClaim.SchemeCode, udtSubsidizeGroupClaim.SchemeSeq, udtSubsidizeGroupClaim.SubsidizeCode, udtTransactionDetail.AvailableItemCode, CultureLanguage.TradChinese)
                    ...
                    If _udtEHSTransaction.CategoryCode = CategoryCode.VSS_CHILD OrElse _udtEHSTransaction.CategoryCode = CategoryCode.EVSSO_CHILD Then
                        ...
                        If _udtEHSTransaction.PreSchool = "Y" Then
                            txtSubsidyInformation.Text = HttpContext.GetGlobalResourceObject("PrintoutText", "VSS_PreSchool", New System.Globalization.CultureInfo(CultureLanguage.TradChinese))
                        Else
                            txtSubsidyInformation.Text = HttpContext.GetGlobalResourceObject("PrintoutText", "VSS_NonPreSchool", New System.Globalization.CultureInfo(CultureLanguage.TradChinese))
                        End If
