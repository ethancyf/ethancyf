...
Namespace PrintOut.VSSConsentForm_CHI
    Public Class VSSConsentForm_C_CHI
...
#End Region
        ...
        Private Sub LoadReport()
            ...
            If Not Me._udtSmartIDContent Is Nothing AndAlso Me._udtSmartIDContent.IsReadSmartID Then
                ...
                txtPageName.Text = _udtPrintoutHelper.GetPrintoutVersionCode(Scheme.SchemeClaimModel.VSS, Common.PrintoutHelper.PrintoutVersion.FullChineseSmartID)
            Else
                srDeclaration.Report = New VSSDeclaration_CHI(_udtEHSTransaction)
                txtPageName.Text = _udtPrintoutHelper.GetPrintoutVersionCode(Scheme.SchemeClaimModel.VSS, Common.PrintoutHelper.PrintoutVersion.FullChinese)
            End If
