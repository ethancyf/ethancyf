Namespace PrintOut.VoucherConsentForm_CHI
    ...
    Partial Public Class ClaimConsent3SPName40UnknownSmartID_v2
        ...
        Private Sub InitializeComponent()
            ...
            '
            Me.dtlClaimConsedtlntDecaraDeclaration3SPName20.Controls.AddRange(New GrapeCity.ActiveReports.SectionReportModel.ARControl() {Me.txtConfirmDeclaration1, Me.TextBox1, Me.TextBox2, Me.txtConfirmDeclaration2, Me.txtDeclaration5, Me.TextBox3, Me.TextBox4, Me.TextBox5})
        ...
        "fy; ddo-char-set: 136"
            ...
            Me.txtConfirmDeclaration2.Text = "授權上文第一段所述的已登記醫療服務提供者取得本人智能身份證晶片所儲存的"
            ...
            Me.txtDeclaration5.Text = "，以供政府作「醫療券使用者同意轉交個人資料」文件的附錄「收集個人資料的目的」所述"
