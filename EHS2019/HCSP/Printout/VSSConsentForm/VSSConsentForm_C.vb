...
#End Region
        ...
        Private Sub LoadReport()
            ...
            ' Personal Info
            srPersonalInfo.Report = New Common.VSSPersonalInfo(udtEHSPersonalInformation)
            ...
            If Not Me._udtSmartIDContent Is Nothing AndAlso Me._udtSmartIDContent.IsReadSmartID Then
                ...
                txtPageName.Text = _udtPrintoutHelper.GetPrintoutVersionCode(Scheme.SchemeClaimModel.VSS, Common.PrintoutHelper.PrintoutVersion.FullEnglishSmartID)
            Else
                srDeclaration.Report = New VSSDeclaration(_udtEHSTransaction)
                txtPageName.Text = _udtPrintoutHelper.GetPrintoutVersionCode(Scheme.SchemeClaimModel.VSS, Common.PrintoutHelper.PrintoutVersion.FullEnglish)
            End If
