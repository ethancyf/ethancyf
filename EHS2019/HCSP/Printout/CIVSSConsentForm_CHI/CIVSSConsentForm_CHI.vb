...
#End Region
        ...
        Private Sub LoadReport()
            ...
            If Not Me._udtSmartIDContent Is Nothing AndAlso Me._udtSmartIDContent.IsReadSmartID Then
                ...
                txtPageName.Text = _udtPrintoutHelper.GetPrintoutVersionCode(Scheme.SchemeClaimModel.CIVSS, Common.PrintoutHelper.PrintoutVersion.FullChineseSmartID)
            Else
                srDeclaration.Report = New CIVSSDeclaration_CHI()
                ' txtPageName.Text = "DH_CIVSS(06/09)"
                txtPageName.Text = _udtPrintoutHelper.GetPrintoutVersionCode(Scheme.SchemeClaimModel.CIVSS, Common.PrintoutHelper.PrintoutVersion.FullChinese)
            End If
