<%@ Page Language="vb" AutoEventWireup="false" CodeBehind="error.aspx.vb" Inherits="ServiceDirectory._error1" %>
...
<body>
    <form id="form1" runat="server">
        ...
        <br />
        <span style="font-size: 16pt;">&nbsp;System error. Please click <a href="../main.aspx">here</a> to restart the search.</span>
    </form>
</body>
</html>
