<%@ Page Language="vb" AutoEventWireup="false" CodeBehind="InvalidOS.aspx.vb" Inherits="ServiceDirectory.ZH.InvalidOS" %>
    ...
    <form id="form1" runat="server">
        ...
        <table>
            <tr>
                ...
                <td><span style="font-size: 16pt; color:#666666">醫健通（資助）系統已不支援微軟視窗XP。如你希望繼續使用醫健通（資助）系統，你必須使用可支援的操作系統（例如：微軟視窗7或以上版本）。</span></td>
            </tr>
        </table>
    </form>
</body>
