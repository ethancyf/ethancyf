Public Class GeneratorLogger
    ...
    Public Shared Sub Log(ByVal strAction As String, ByVal strStatus As String, ByVal strReturn As String, ByVal strDesc As String)
        ...
        Common.ComObject.ScheduleJobLogEntry.WriteLog(DateTime.Now, GeneratorUtil.GetIPAddress(), Common.Component.ScheduleJobID.TextGenerator, strAction, strStatus, strReturn, strDesc)
