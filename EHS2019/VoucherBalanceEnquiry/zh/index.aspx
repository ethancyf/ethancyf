<%@ Page Language="vb" AutoEventWireup="false" CodeBehind="index.aspx.vb" Inherits="VoucherBalanceEnquiry.zh.index"
                                                ...
                                                <tr>
                                                    <td colspan="2" align="center">
                                                        <a href="javascript:void(0)" onclick="openNewWin('../main.aspx?lang=zh')">
                                                            <img src="../Images/others/voucherbalanceenquiry_tw.png" alt="" border="0" /></a>
                                                    </td>
                                                </tr>
                                                <tr>
                                                    <td align="center">
                                                        <a href="javascript:void(0)" onclick="openNewWin('../../Documents/FAQs_c.pdf#Public')">
                                                            <img src="../Images/others/button_FAQs_tw.png" alt="" border="0" /></a></td>
                                                    <td align="center">
                                                        <a href="javascript:void(0)" onclick="openNewWin('../../zh/ContactUs_SP.htm')">
