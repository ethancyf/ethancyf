<%@ Page Language="vb" AutoEventWireup="false" CodeBehind="error.aspx.vb" Inherits="VoucherBalanceEnquiry.zh._error" ContentType="text/html; charset=UTF-8" %>
...
<body>
    <form id="form1" runat="server">
        ...
        <br />
        <span style="font-size: 16pt;">&nbsp;系統發生錯誤，請按 <a href="../main.aspx">此處</a> 重新登入。</span>
    </form>
</body>
</html>
