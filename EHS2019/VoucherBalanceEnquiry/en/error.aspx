<%@ Page Language="vb" AutoEventWireup="false" CodeBehind="error.aspx.vb" Inherits="VoucherBalanceEnquiry.en._error" %>
...
<body>
    <form id="form1" runat="server">
        ...
        <br />
        <span style="font-size: 16pt;">&nbsp;System error. Please click <a href="../main.aspx">here</a> to back to login again.</span>
    </form>
</body>
</html>
