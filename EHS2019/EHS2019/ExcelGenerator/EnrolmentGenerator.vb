...
Public Class EnrolmentGenerator
    ...
    Sub New(ByVal udtQueue As Common.Component.FileGeneration.FileGenerationQueueModel, ByVal udtFileGenerationModel As Common.Component.FileGeneration.FileGenerationModel)
        ...
        udtCommonGenFunction.getSystemParameter("EnrolmentDownloadStoragePath", strPath, String.Empty)
        If strPath.Trim() = "" Then
            Throw New ArgumentException("EnrolmentDownloadStoragePath Empty!")
        End If
    ...
    Public Overrides Function GetDataSet() As System.Data.DataSet
        ...
        'Dim udtDB As New Common.DataAccess.Database(Common.Component.DBFlagStr.ReadDBFlag)
        ...
        If dsData.Tables.Count > 0 Then dsData.Tables(0).TableName = "Data"
        If dsData.Tables.Count > 1 Then dsData.Tables(1).TableName = "Parameter"
