...
Public Class CaptchaControl
    ...
    Private _cacheStrategy As CacheType = CacheType.Session
...
#Region "  Public Properties"
    ...
    Public Property IsIntegerOnly() As Boolean
        Get
            Return _captcha.IsIntegerOnly
        End Get
        Set(ByVal value As Boolean)
            _captcha.IsIntegerOnly = value
        End Set
    End Property
    ...
    Protected Overrides Sub Render(ByVal Output As HtmlTextWriter)
        With Output
            ...
            If _text.Length > 0 Then
                ...
                .Write("<br>")
            End If
            .Write("<input class='captchaTextBox' name=" & UniqueID & " type=text size=")
