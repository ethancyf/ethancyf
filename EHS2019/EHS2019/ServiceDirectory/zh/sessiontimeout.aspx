<%@ Page Language="vb" AutoEventWireup="false" CodeBehind="sessiontimeout.aspx.vb" Inherits="ServiceDirectory.sessiontimeout2" %>
...
<body>
    <form id="form1" runat="server">
        ...
        <br />
        <span style="font-size: 16pt;">&nbsp;系統逾時，請按 <a href="../main.aspx?lang=zh">此處</a> 重新搜尋。</span>
    </form>
</body>
</html>
