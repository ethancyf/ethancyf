...
Namespace PrintOut.HSIVSSConsentForm
    Public Class HSIVSSConsentFormChild
...
#End Region
        ...
        Private Sub LoadReport()
            ...
            If Not _udtSmartIDContent Is Nothing AndAlso _udtSmartIDContent.IsReadSmartID Then
                srDeclaration.Report = New HSIVSSDeclarationSmartID(False, _udtSP, _udtEHSAccount, _udtEHSTransaction, _udtSchemeClaim)
            ...
            Else
                srDeclaration.Report = New HSIVSSDeclaration(False, _udtSP, _udtEHSAccount, _udtEHSTransaction, _udtSchemeClaim)
