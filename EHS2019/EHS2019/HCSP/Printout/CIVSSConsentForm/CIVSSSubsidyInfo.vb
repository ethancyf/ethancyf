        ...
        Private Sub FillDoseInfo()
            ...
            For Each udtSubsidizeGroupClaim As SubsidizeGroupClaimModel In udtServiceSchemeClaimModel.SubsidizeGroupClaimList
                ...
                If udtTransactionDetails.Count > 0 Then
                    ...
                    Dim strDescription As String = udtPrintoutHelper.GetDoseDescription(udtSubsidizeGroupClaim.SchemeCode, udtSubsidizeGroupClaim.SchemeSeq, udtSubsidizeGroupClaim.SubsidizeCode, strVaccineCode, CultureLanguage.English)
                    ...
                    Select Case strVaccineCode
                        Case "1STDOSE", "ONLYDOSE"
                            If _udtEHSTransaction.PreSchool = "Y" Then
                                txtSubsidyInformatin.Text = HttpContext.GetGlobalResourceObject("PrintoutText", "CIVSS_PreSchool", New System.Globalization.CultureInfo(CultureLanguage.English))
                            Else
                                txtSubsidyInformatin.Text = HttpContext.GetGlobalResourceObject("PrintoutText", "CIVSS_NonPreSchool", New System.Globalization.CultureInfo(CultureLanguage.English))
                            End If
