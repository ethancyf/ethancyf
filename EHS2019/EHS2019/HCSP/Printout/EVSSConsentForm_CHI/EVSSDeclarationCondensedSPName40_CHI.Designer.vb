Namespace PrintOut.EVSSConsentForm_CHI
    ...
    Partial Public Class EVSSDeclarationCondensedSPName40_CHI
        ...
        Private Sub InitializeComponent()
            Dim resources As System.Resources.ResourceManager = New System.Resources.ResourceManager(GetType(EVSSDeclarationCondensedSPName40_CHI))
            ...
            'Detail
            '
            Me.Detail.Controls.AddRange(New GrapeCity.ActiveReports.SectionReportModel.ARControl() {Me.txtDeclaration4Value, Me.TextBox13, Me.TextBox48, Me.TextBox1, Me.txtDocumentExplainedBy})
            ...
            Me.TextBox13.Text = "助計劃之「同意轉交個人資料」內所載的承諾及聲明。本人明白和同意該等承諾及聲明的內容。"
        ...
        "; ddo-char-set: 136"
            ...
            Me.txtDocumentExplainedBy.Width = 3.7!
            '
            'EVSSDeclarationCondensedSPName40_CHI
            '
