...
#End Region
        ...
        Private Sub LoadReport()
            ...
            If Not Me._udtSmartIDContent Is Nothing AndAlso Me._udtSmartIDContent.IsReadSmartID Then
                ...
                Me.txtPageName.Text = _udtPrintoutHelper.GetPrintoutVersionCode(Scheme.SchemeClaimModel.EVSS, Common.PrintoutHelper.PrintoutVersion.FullChineseSmartID)
            Else
                srDeclaration.Report = New EVSSDeclaration_CHI()
                ' Me.txtPageName.Text = "DH_EVSS(10/09)"
                Me.txtPageName.Text = _udtPrintoutHelper.GetPrintoutVersionCode(Scheme.SchemeClaimModel.EVSS, Common.PrintoutHelper.PrintoutVersion.FullChinese)
            End If
