<%@ Control Language="vb" AutoEventWireup="false" Codebehind="ucReadOnlyID235B.ascx.vb" Inherits="HCSP.UIControl.DocTypeText.ucReadOnlyID235B" %>
<asp:Panel ID="panReadonlyVerticalID235B" runat="server">
    ...
    <table id="tblID235B" runat="server" cellpadding="0" cellspacing="0" class="textVersionTable">
        <tbody>
            <tr>
                <td valign="top">
            ...
            <tr>
                <td valign="top">
                    <asp:Label ID="lblReadonlyBENoText" runat="server" CssClass="tableTitle"></asp:Label></td>
            </tr>
            <tr>
                <td valign="top">
