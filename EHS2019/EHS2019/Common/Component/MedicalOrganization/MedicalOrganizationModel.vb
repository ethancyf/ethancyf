...
Namespace Component.MedicalOrganization
    <Serializable()> Public Class MedicalOrganizationModel
        ...
        Public Const MOEngNameDataType As SqlDbType = SqlDbType.NVarChar
        ...
        Public ReadOnly Property DisplaySeqMOName() As String
            Get
                Return _strMOEngName + " (" + _intDisplaySeq.ToString + ")"
            End Get
