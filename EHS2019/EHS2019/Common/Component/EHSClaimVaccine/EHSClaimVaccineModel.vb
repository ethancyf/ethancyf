...
Namespace Component.EHSClaimVaccine
...
#Region "Class EHSClaimSubsidzeModel & Collection"
        ...
        <Serializable()> Public Class EHSClaimSubsidizeModel
            ...
            Public Sub New(ByVal SchemeCode As String, ByVal SchemeSeq As Integer, ByVal SubsidizeCode As String, _
                ...
                ByVal dblInjectionFee As Nullable(Of Double), ByVal blnInjectionFeeEnabled As Double, _
...
#Region "Class EHSClaimSubsidizeDetailModel & Collection"
        ...
        <Serializable()> Public Class EHSClaimSubidizeDetailModel
            ...
            Private _blnInternalUse As Boolean
            ' CRE12-008-02 Allowing different subsidy level for each scheme at different date period [End][Twinsen]
...
#Region "Property"
            ...
            Property InternalUse() As Boolean
                Get
                    Return Me._blnInternalUse
                End Get
                Set(ByVal value As Boolean)
                    Me._blnInternalUse = value
                End Set
            End Property
            ' CRE12-008-02 Allowing different subsidy level for each scheme at different date period [End][Twinsen]
...
#End Region
            ...
            ' CRE12-008-02 Allowing different subsidy level for each scheme at different date period [Start][Twinsen]
            ' Add new parameter - intAvailableItemNum
            ''' <summary>
            ''' Constructor
            ''' </summary>
            ...
            Public Sub New(ByVal strSubsidizeItemCode As String, ByVal strAvailableItemCode As String, ByVal intDisplaySeq As Integer, _
                ByVal strAvailableItemDesc As String, ByVal strAvailableItemDescChi As String, ByVal intAvailableItemNum As Integer, _
                ByVal blnInternalUse As Boolean, ByVal blnAvailable As Boolean, ByVal blnReceived As Boolean, ByVal blnSelected As Boolean)
                ...
                Me._blnInternalUse = blnInternalUse
...
#Region "Vaccine Validation"
        ...
        Public Function chkVaccineSelection(ByVal udtEHSClaimVaccine As EHSClaimVaccineModel, ByRef systemMessages As Dictionary(Of ComObject.SystemMessage, List(Of String()))) As Boolean
            Dim noVaccineSelected As Boolean = True
            Dim noAvailableVaccine As Boolean = True
            Dim noDoseSelected As Boolean = True
            Dim isValid As Boolean = True

            systemMessages = New Dictionary(Of ComObject.SystemMessage, List(Of String()))
            ...
            For Each udtEHSClaimSubsidize As EHSClaimVaccineModel.EHSClaimSubsidizeModel In udtEHSClaimVaccine.SubsidizeList
                ...
                If Not udtEHSClaimSubsidize.Available Then
                    ...
                    If udtEHSClaimSubsidize.Selected Then
                        systemMessages.Add(New SystemMessage("990000", "E", "00234"), Nothing)
                        Return False
                    Else
                        ...
                        If udtEHSClaimSubsidize.SubsidizeDetailList.Count > 1 Then
                            ...
                            For Each udtSubsidizeDetail As EHSClaimVaccineModel.EHSClaimSubidizeDetailModel In udtEHSClaimSubsidize.SubsidizeDetailList
                                If udtSubsidizeDetail.Selected Then
                                    systemMessages.Add(New SystemMessage("990000", "E", "00233"), Nothing)
                                    Return False
                                End If
                            Next
                    ...
                    If udtEHSClaimSubsidize.Selected Then
                        ...
                        If udtEHSClaimSubsidize.SubsidizeDetailList.Count > 1 Then
                            ...
                            If noDoseSelected Then
                                ...
                                Dim udtSM As New SystemMessage("990000", "E", "00190")
                                Dim ls As New List(Of String())
                                ls.Add(New String() {"%s", "%r"})
                                ls.Add(New String() {udtEHSClaimSubsidize.SubsidizeItemDesc, udtEHSClaimSubsidize.SubsidizeItemDescChi})

                                systemMessages.Add(udtSM, ls)
                            End If
                            '-------------------------------------------------------------------------------------------------------------------------
                        End If
            ...
            If Not noAvailableVaccine AndAlso noVaccineSelected Then
                isValid = False
                systemMessages.Add(New SystemMessage("990000", "E", "00189"), Nothing)
            End If
