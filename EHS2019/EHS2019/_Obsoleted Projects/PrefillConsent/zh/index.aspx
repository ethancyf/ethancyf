<%@ Page Language="vb" AutoEventWireup="false" CodeBehind="index.aspx.vb" Inherits="PrefillConsent.zh.index"
                                                ...
                                                <tr>
                                                    <td colspan="2" align="center">
                                                        <a href="javascript:void(0)" onclick="openNewWin('../main.aspx?lang=ZH')">
                                                            <img src="../Images/others/onlineprefillconsentform_tw.png" alt="" border="0" /></a>
                                                    </td>
                                                </tr>
                                                <tr>
                                                    <td align="center">
                                                        <a href="javascript:void(0)" onclick="openNewWin('../../zh/FAQs.asp?view=Public')">
                                                            <img src="../Images/others/button_FAQs_tw.png" alt="" border="0" /></a></td>
                                                    <td align="center">
                                                        <a href="javascript:void(0)" onclick="openNewWin('../../zh/ContactUs_VO.htm')">
