...
#End Region
    ...
    ''' <remarks></remarks>
    Private Shared Sub LogToConsole(ByVal strText As String)
    ...
    ''' <remarks></remarks>
    Public Shared Sub Log(ByVal strText As String, Optional ByVal eLogAction As EnumLogAction = EnumLogAction.Initialization, Optional ByVal eLogStatus As EnumLogStatus = EnumLogStatus.Information)
        LogToConsole(strText)

        ScheduleJobLogEntry.WriteLog(DateTime.Now, GetIPAddress(), "ConfigDispatcher", eLogAction.ToString, eLogStatus.ToString, Nothing, strText)
