...
Namespace PrintOut.DH_VSS
    ...
    Partial Public Class AvailPracticeMasterScheme
        ...
        Private Sub InitializeComponent()
            ...
            Me.txtMasterSchemeText.Style = "ddo-char-set: 1; text-decoration: none; text-align: justify; font-weight: normal;" & _
                " font-size: 10pt; font-family: Arial; "
            Me.txtMasterSchemeText.Text = "For application for enrolment in {0} only:"
