<%@ Page Language="vb" AutoEventWireup="false" CodeBehind="sessiontimeout.aspx.vb" Inherits="eForm.sessiontimeout" %>
...
<body>
    <form id="form1" runat="server">
        ...
        <br />
        <span style="font-size: 16pt;">&nbsp;System timeout. Please click <a href="../main.aspx">here</a> to restart the enrolment process.</span>
    </form>
</body>
</html>
