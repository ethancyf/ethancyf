<%@ Page Language="vb" AutoEventWireup="false" CodeBehind="index.aspx.vb" Inherits="eForm.index2"
                                ...
                                <%-- <table style="border-right: #0000ff 1px solid; border-top: #0000ff 1px solid; border-left: #0000ff 1px solid;
                                            ...
                                            <tr>
                                                <td class="tableText" style="font-size: large; color: #0000ff;">
                                                    重要消息:<br />
                                                    系統將於2008年10月12日(星期日)上午一時至上午五時進行維修。<br />
                                                    不便之處，敬請原諒。</td>
                                            </tr>
                                        </table>
                                        <br />--%>
                                    ...
                                    <tr align="center">
                                        <td>
                                            <table width="75%">
                                                ...
                                                <tr>
                                                    <td colspan="3" align="center">
                                                        <a href="javascript:void(0)" onclick="openNewWin('../main.aspx?lang=zh')">
                                                            <img src="../Images/others/enrolment_tw.png" alt="" border="0" /></a>
                                                    </td>
                                                </tr>
                                                <tr>
                                                    <td align="center">
                                                        <a href="javascript:void(0)" onclick="openNewWin('../../Documents/FAQs_c.pdf#Enrolment')">
                                                            <img src="../Images/others/button_FAQs_tw.png" alt="" border="0" /></a></td>
                                                    <td align="center">
                                                        <a href="javascript:void(0)" onclick="openNewWin('../../zh/ContactUs.htm')">
                                                    ...
                                                    <%-- <td align="center">
                                                        <a href="http://www.chp.gov.hk/view_content.asp?lang=en&info_id=16615" target="_blank">
                                                            <img src="../Images/others/btn_swine.jpg" alt="" border="0" /></a>
                                                    --%>
                                                </tr>
                                            </table>
                                        </td>
