<%@ Page Language="vb" AutoEventWireup="false" CodeBehind="sessiontimeout.aspx.vb" Inherits="eForm.sessiontimeout1" %>
...
<body>
    <form id="form1" runat="server">
        ...
        <br />
        <span style="font-size: 16pt;">&nbsp;系統逾時，請按 <a href="../main.aspx">此處</a> 重新開始登記程序。</span>
    </form>
</body>
</html>
