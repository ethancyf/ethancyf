...
Public Class PCDUploadEnrolInfoRequest
    ...
    Public Function GenerateXML(ByVal udtSP As ServiceProviderModel, ByVal strPlatFormCode As String, Optional ByVal blnNoMessageID As Boolean = False) As String
        Const WS_METHOD_NAME As String = "UploadEnrolInfo"
        ...
        _objRequest.GenerateXMLRequestAttributes(_objXmlGenerator.XML, nodeROOT, _strMessageID, WS_METHOD_NAME, blnNoMessageID, strPlatFormCode, _strPCD_ERN, True, _strEnrolmentSubmissionTime)
        _objRequest.GenerateXMLServiceProvider(_objXmlGenerator.XML, nodeROOT, udtSP, True, True, True)


        _objRequest.GenerateXMLRequestMessageDateTime(_objXmlGenerator.XML, nodeROOT, blnNoMessageID)
