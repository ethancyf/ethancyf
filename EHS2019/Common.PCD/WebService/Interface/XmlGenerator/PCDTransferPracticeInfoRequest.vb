...
Public Class PCDTransferPracticeInfoRequest
    ...
    Public Function GenerateXML(ByVal udtSP As ServiceProviderModel) As String
        Const WS_METHOD_NAME As String = "TransferPracticeInfo"
        ...
        _objRequest.GenerateXMLServiceProvider(_objXmlGenerator.XML, nodeROOT, udtSP, False, True, True)
    ...
    Public Function Validate(ByVal udtSP As ServiceProviderModel) As Boolean
        ...
        If Not udtSP Is Nothing AndAlso Not udtSP.ThirdPartyAdditionalFieldEnrolmentList Is Nothing AndAlso udtSP.ThirdPartyAdditionalFieldEnrolmentList.GetListBySysCode(Common.Component.ThirdParty.ThirdPartyAdditionalFieldEnrolmentModel.EnumSysCode.PCD).Count > 0 Then
        Else
