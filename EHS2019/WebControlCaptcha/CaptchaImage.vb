...
''' </remarks>
<Serializable()> Public Class CaptchaImage
    ...
    Private _IsIntegerOnly As Boolean
...
#Region "  Public Properties"
    ...
    Public Property IsIntegerOnly() As Boolean
        Get
            Return _IsIntegerOnly
        End Get
        Set(ByVal value As Boolean)
            _IsIntegerOnly = value
        End Set
    End Property
...
#End Region
    ...
    ''' Amended to input a random string rather than using user input from the control
    ''' </summary>
    Private Function GenerateRandomText() As String
        Dim randomString As New RandomInputString(30)
        '_randomTextChars = randomString.GetRandomString

        If Not _IsIntegerOnly Then
            _randomTextChars = randomString.GetRandomString
        Else
            _randomTextChars = randomString.GetRandomIntegerString
        End If
