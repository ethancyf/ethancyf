...
#End Region
    ...
    ''' <remarks></remarks>
    Public Shared Sub Log(ByVal strScheduleJobID As String, ByVal strText As String, ByVal eLogAction As EnumLogAction, ByVal eLogStatus As EnumLogStatus)
        ' CRE11-029 Add CMS health check log [Start][Koala]
        ' -----------------------------------------------------------------------------------------
        'Log(strText)
        ' CRE11-029 Add CMS health check log [End][Koala]
        ScheduleJobLogEntry.WriteLog(DateTime.Now, GetIPAddress(), strScheduleJobID, eLogAction.ToString, eLogStatus.ToString, Nothing, strText)
