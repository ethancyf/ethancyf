IF EXISTS (SELECT * FROM dbo.sysobjects WHERE id = OBJECT_ID(N'[dbo].[proc_MedicalOrganizationOriginal_get_byERN]') AND OBJECTPROPERTY(id, N'IsProcedure') = 1)
	DROP PROCEDURE [dbo].[proc_MedicalOrganizationOriginal_get_byERN]
GO
...
--				MedicalOrganizationOriginal
-- =============================================
CREATE PROCEDURE [dbo].[proc_MedicalOrganizationOriginal_get_byERN] 
...
-- =============================================
	...
	SELECT  Enrolment_Ref_No,
			...
			Relationship,
			Relationship_Remark
	FROM    MedicalOrganizationOriginal
...
GRANT EXECUTE ON [dbo].[proc_MedicalOrganizationOriginal_get_byERN] TO HCVU
GO
