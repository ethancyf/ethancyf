IF EXISTS (SELECT * FROM dbo.sysobjects WHERE id = OBJECT_ID(N'[dbo].[proc_PracticeSchemeInformation_get_bySPIDDisplySeq_all]') AND OBJECTPROPERTY(id, N'IsProcedure') = 1)
	DROP PROCEDURE [dbo].[proc_PracticeSchemeInformation_get_bySPIDDisplySeq_all]
GO
...
--				 copy from [proc_PracticeSchemeInformation_get_bySPIDDisplySeq], All  
-- =============================================  
  
  
CREATE PROCEDURE [dbo].[proc_PracticeSchemeInformation_get_bySPIDDisplySeq_all]  
 @sp_id   char(8),  
...
insert into @temp_practice  
 ...
 FROM PracticeSchemeInfo P  
    ...
    Inner join @EffectiveScheme e  
     on p.Scheme_Code = e.Scheme_Code  
    Inner join schemebackoffice s  
     on  p.scheme_code = s.scheme_code and e.Scheme_Seq = s.Scheme_Seq  
...
GRANT EXECUTE ON [dbo].[proc_PracticeSchemeInformation_get_bySPIDDisplySeq_all] TO HCSP
GO
