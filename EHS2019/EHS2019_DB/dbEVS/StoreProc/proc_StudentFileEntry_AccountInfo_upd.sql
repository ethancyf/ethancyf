IF EXISTS (SELECT * FROM dbo.sysobjects WHERE id = OBJECT_ID(N'[dbo].[proc_StudentFileEntry_AccountInfo_upd]') AND OBJECTPROPERTY(id, N'IsProcedure') = 1)
	DROP PROCEDURE [dbo].[proc_StudentFileEntry_AccountInfo_upd]
GO
...
-- Description:		Update StudentFileEntry Account matching result
-- =============================================

CREATE PROCEDURE [dbo].[proc_StudentFileEntry_AccountInfo_upd]
...
GRANT EXECUTE ON [dbo].[proc_StudentFileEntry_AccountInfo_upd] TO HCVU
GO
