...
Public Class AuditLogBase
    ...
    Private _strCallSystem As String = ""

    Public Sub SetCallSystem(ByVal strCallSystem As String)
        Me._strCallSystem = strCallSystem
    End Sub

    Public Overrides ReadOnly Property Platform() As String
        Get
            Return EVSPlatform.InterfaceInternal
        End Get
    End Property
    ...
    Private Function GetMessages(ByVal strLogID As String)
        ...
        ' Format audit log description with call system name
        Return String.Format(_hashMessage(strLogID), _strCallSystem)
    End Function
