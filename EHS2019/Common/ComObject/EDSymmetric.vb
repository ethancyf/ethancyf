...
Namespace EDSymmetricNamespace
    Public Class EDSymmetric
        ...
        ' 1. Use SHA512 instead of SHA1 to hash [Key]
        ' 2. Use AES256 instrad of DES to encrypt [ConnectionString]
        ...
        Public Function EncryptData(ByVal strKey As String, ByVal strData As String) As String
            ...
            Try
                ...
                Dim cryptoProvider As AesCryptoServiceProvider = New AesCryptoServiceProvider
                ' I-CRE16-007-02 (Refine system from CheckMarx findings) [End][Winnie]
        ...
        Private Function InitKey(ByVal strKey As String) As Boolean
            ...
            Try
                ...
                ' Old Method: Hash the key using SHA1
                ...
                '' New Method: Hash the key using SHA512
