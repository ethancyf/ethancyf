...
Namespace Component.SchemeDetails
    <Serializable()> Public Class EqvSubsidizePrevSeasonMapModel
...
#Region "Constructor"
        ...
        Public Sub New(ByVal udtEqvSubsidizePrevSeasonMapModel As EqvSubsidizePrevSeasonMapModel)
            Me._strScheme_Code = udtEqvSubsidizePrevSeasonMapModel._strScheme_Code
            Me._intScheme_Seq = udtEqvSubsidizePrevSeasonMapModel._intScheme_Seq
            Me._strSubsidize_Item_Code = udtEqvSubsidizePrevSeasonMapModel._strSubsidize_Item_Code

            Me._strEqv_Scheme_Code = udtEqvSubsidizePrevSeasonMapModel._strEqv_Scheme_Code
            Me._intEqv_Scheme_Seq = udtEqvSubsidizePrevSeasonMapModel._intEqv_Scheme_Seq
            Me._strEqv_Subsidize_Item_Code = udtEqvSubsidizePrevSeasonMapModel._strEqv_Subsidize_Item_Code
        End Sub
