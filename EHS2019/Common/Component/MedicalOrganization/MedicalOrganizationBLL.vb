...
Namespace Component.MedicalOrganization
    Public Class MedicalOrganizationBLL
        ...
        Public Function GetMOListFromEnrolmentByERN(ByVal strERN As String, ByVal udtDB As Database) As MedicalOrganizationModelCollection
            Return GetMOListFromCopyByERN(strERN, EnumEnrolCopy.Enrolment, udtDB)
        End Function
        ' CRE12-001 eHS and PCD integration [End][Koala]

        Public Function GetMOListFromCopyByERN(ByVal strERN As String, ByVal enumEnrolCopy As EnumEnrolCopy, ByVal udtDB As Database) As MedicalOrganizationModelCollection
            ...
            Try
                ...
                Select Case enumEnrolCopy
                    ...
                    Case enumEnrolCopy.Original
                        udtDB.RunProc("proc_MedicalOrganizationOriginal_get_byERN", prams, dtRaw)
                End Select
                ' CRE12-001 eHS and PCD integration [End][Koala]
                ...
                If Not IsNothing(udtMedicalOrganizationModelCollection) Then
                    udtMedicalOrganizationModelCollection.DuplicateMOEName()
                End If
        ...
        Public Function GetMOListFromStagingByERN_FromIVSS(ByVal strERN As String, ByVal udtDB As Database, ByVal strUserID As String) As MedicalOrganizationModelCollection
            Dim udtMedicalOrganizationModelCollection As MedicalOrganizationModelCollection = New MedicalOrganizationModelCollection
            Dim udtMedicalOrganizationModel As MedicalOrganizationModel
            ...
            Try
                ...
                udtDB.RunProc("proc_MedicalOrganizationStaging_get_byERN_FromIVSS", prams, dtRaw)
        ...
        Public Function GetMOSchemeEnrolmentByERNScheme(ByVal strERN As String, ByVal strSchemeCode As String, ByRef udtDB As Database) As DataTable
            ...
            Try
                Dim prams() As SqlParameter = { _
                                udtDB.MakeInParam("@enrolment_ref_no", ServiceProviderModel.EnrolRefNoDataType, ServiceProviderModel.EnrolRefNoDataSize, strERN), _
                                udtDB.MakeInParam("@scheme_code", SchemeBackOfficeModel.SchemeCode_DataType, SchemeBackOfficeModel.SchemeCode_DataSize, strSchemeCode)}
        ...
        Public Function GetMOListPermanentTSMP(ByVal strSPID As String, ByVal udtDB As Database) As Hashtable
            ...
            Try
                ...
                udtDB.RunProc("proc_MedicalOrganizationTSMP_get_bySPID", prams, dt)
        ...
        Public Function UpdateMOPermanentDetails(ByVal udtMOModel As MedicalOrganizationModel, ByVal udtDB As Database) As Boolean
            ...
            Try
                Dim prams() As SqlParameter = { _
                                                ...
                                                udtDB.MakeInParam("@tsmp", MedicalOrganizationModel.TSMPDataType, MedicalOrganizationModel.TSMPDataSize, udtMOModel.TSMP), _
                                                udtDB.MakeInParam("@phone_daytime", MedicalOrganizationModel.PhoneDaytimeDataType, MedicalOrganizationModel.PhoneDaytimeDataSize, udtMOModel.PhoneDaytime), _
                                                udtDB.MakeInParam("@email", MedicalOrganizationModel.EmailDataType, MedicalOrganizationModel.EmailDataSize, IIf(IsNothing(udtMOModel.Email), DBNull.Value, udtMOModel.Email)), _
                                                udtDB.MakeInParam("@fax", MedicalOrganizationModel.FaxDataType, MedicalOrganizationModel.FaxDataSize, IIf(IsNothing(udtMOModel.Fax), DBNull.Value, udtMOModel.Fax))}
        ...
        Public Function DeleteAllMOStaging(ByVal strERN As String, ByRef udtDB As Database) As Boolean
            Dim blnRes As Boolean = False
            ...
            Try
                ...
                udtDB.RunProc("proc_MedicalOrganizationStaging_del_All", prams)
                blnRes = True
            Catch ex As Exception
                Throw ex
            End Try
