<%@ Page Language="vb" AutoEventWireup="false" CodeBehind="thankyou.aspx.vb" Inherits="PrefillConsent.thankyou" %>
            ...
            <tr style="height: 220px; width: 95%;">
                <td style="background-color: #fcfcfc">
                    <table cellpadding="2" cellspacing="2" style="height: 100%; width: 95%;">
                        ...
                        <tr>
                            <td style="border-left-color: goldenrod; border-right-color: goldenrod; border-top-color: goldenrod; border-bottom-color: goldenrod; border-top-style: solid; border-right-style: solid; border-left-style: solid; border-bottom-style: solid" align="center">
