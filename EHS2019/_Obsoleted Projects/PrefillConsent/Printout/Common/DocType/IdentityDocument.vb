    ...
    Public Class IdentityDocument
        ...
        Private Sub LoadReport()
            ...
            Select Case _udtEHSPersonalInformation.DocCode.Trim()
                ...
                Case DocTypeCode.EC
                    srDocType.Report = New EC(_udtEHSPersonalInformation.ECSerialNo, _udtEHSPersonalInformation.ECReferenceNo, _udtEHSPersonalInformation.IdentityNum, _udtEHSPersonalInformation.DateofIssue)
