...
Partial Public Class ucReadOnlyDI
    ...
    Public Sub Setup()
        ...
        If Me._isVertical Then
            ...
            Me.lblReadonlyTravelDocNo.Text = formatter.FormatDocIdentityNoForDisplay(DocTypeCode.DI, Me._udtEHSAccountPersonalInfo.IdentityNum, _maskTravelDocNumber)
            ...
            Me.lblReadonlyIssueDate.Text = formatter.formatDOI(DocTypeCode.DI, Me._udtEHSAccountPersonalInfo.DateofIssue)
        ...
        Else
            ...
            Me.lblReadonlyHorizontalTravelDocNo.Text = formatter.FormatDocIdentityNoForDisplay(DocTypeCode.DI, Me._udtEHSAccountPersonalInfo.IdentityNum, _maskTravelDocNumber)
            ...
            Me.lblReadonlyHorizontalIssueDate.Text = formatter.formatDOI(DocTypeCode.DI, Me._udtEHSAccountPersonalInfo.DateofIssue)
        End If

        ' Control the width of the table
        tblDI.Rows(0).Cells(0).Width = _intWidth
