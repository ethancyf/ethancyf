...
Partial Public Class ucReadOnlyHKBC
    ...
    Public Sub Setup()
        ...
        If Me._isVertical Then
            ...
            Me.lblReadonlyRegNo.Text = formatter.formatHKID(Me._udtEHSAccountPersonalInfo.IdentityNum, Me._maskHKIDNumber)
        ...
        Else
            ...
            Me.lblReadonlyHorizontalRegNo.Text = formatter.formatHKID(Me._udtEHSAccountPersonalInfo.IdentityNum, Me._maskHKIDNumber)
        ...
        tblHKBC.Rows(0).Cells(0).Width = _intWidth
    ...
    Private Sub RenderLanguage()
        ...
        Else
            ...
            Me.lblReadonlyHorizontalRegNoText.Text = Me.GetGlobalResourceObject("Text", "BCRegNo")
