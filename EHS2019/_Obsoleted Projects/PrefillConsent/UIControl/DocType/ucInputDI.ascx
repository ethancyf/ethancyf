<%@ Control Language="vb" AutoEventWireup="false" Codebehind="ucInputDI.ascx.vb"
    Inherits="PrefillConsent.ucInputDI" %>
    ...
    <table cellpadding="0" cellspacing="0">
        ...
        <tr>
            <td style="width: 100px" valign="top">
                <asp:Label ID="lblTDNoText" runat="server" CssClass="tableTitle" Height="28px" Width="150px"></asp:Label></td>
            <td style="width: 320px" valign="top">
                <asp:TextBox ID="txtTDNo" runat="server" MaxLength="9" onChange="convertToUpper(this);"
            ...
            <td valign="top">
                <asp:Label ID="lblTDNoTip" runat="server" CssClass="tableTip"></asp:Label>
            </td>
        </tr>
        <tr>
            <td valign="top">
        ...
        <tr>
            <td valign="top">
                <asp:Label ID="lblDOI" runat="server" CssClass="tableTitle" Height="28px" Width="150px"></asp:Label></td>
            <td valign="top" style="width: 320px">
