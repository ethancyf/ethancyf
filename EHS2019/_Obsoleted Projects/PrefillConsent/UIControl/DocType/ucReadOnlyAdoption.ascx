<%@ Control Language="vb" AutoEventWireup="false" CodeBehind="ucReadOnlyAdoption.ascx.vb" Inherits="PrefillConsent.ucReadOnlyAdoption" %>
    ...
    <table id="tblADOPC" runat="server" cellpadding="0" cellspacing="0">
        <tbody>
            <tr>
                ...
                <td valign="top">
                    <asp:Label ID="lblReadonlyDocumentType" runat="server" CssClass="tableText" Width="550px"></asp:Label></td>
            </tr>
            <tr>
                <td valign="top">
                    <asp:Label ID="lblReadonlyEntryNoText" runat="server" CssClass="tableTitle" Height="25px"
                        Width="150px"></asp:Label></td>
                <td valign="top">
            ...
            <tr>
                <td valign="top">
                    <asp:Label ID="lblReadonlyDOBText" runat="server" CssClass="tableTitle" Height="25px" Width="150px"></asp:Label></td>
                <td valign="top">
