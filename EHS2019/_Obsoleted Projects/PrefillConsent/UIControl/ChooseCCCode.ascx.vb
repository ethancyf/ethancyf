...
Partial Public Class ChooseCCCode
    ...
    Protected Sub Page_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Load
        ...
        If LCase(Session("language")) = Common.Component.CultureLanguage.TradChinese Then
            ...
            'Me.lnkHere.OnClientClick = String.Format("javascript:openNewWin('{0}'); return false;", "DownloadArea/ZH/chkCCC.htm")
        Else
            ...
            'Me.lnkHere.OnClientClick = String.Format("javascript:openNewWin('{0}'); return false;", "DownloadArea/EN/chkCCC.htm")
        End If
    End Sub
