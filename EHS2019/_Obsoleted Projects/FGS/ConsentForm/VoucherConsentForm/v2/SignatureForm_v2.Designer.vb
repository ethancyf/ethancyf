Namespace PrintOut.VoucherConsentForm
    ...
    Partial Public Class SignatureForm_v2
        ...
        Private Sub InitializeComponent()
            ...
            Me.txtRecipientIlliterateComplete.Style = "text-decoration: none; ddo-char-set: 0; text-align: justify; font-style: italic; " & _
                "font-size: 11.25pt; "
            Me.txtRecipientIlliterateComplete.Text = "This document has been read and explained to the voucher recipient in my presence" & _
                "."
            Me.txtRecipientIlliterateComplete.Top = 2.0625!
            ...
            Me.txtWitnessSignatureText.Top = 2.3125!
            ...
            Me.txtWitnessNameText.Top = 2.5625!
            ...
            Me.txtWitnessHKIDText.Top = 2.875!
            ...
            Me.txtWitnessDateText.Top = 2.875!
            ...
            Me.txtWitnessSignature.Top = 2.3125!
            ...
            Me.TextBox38.Top = 2.5625!
            Me.TextBox38.Width = 2.9!
            '
            'txtWitnessHKID
            '
            ...
            Me.TextBox15.Top = 3.6875!
            Me.TextBox15.Width = 2.9!
            '
            'TextBox16
            '
