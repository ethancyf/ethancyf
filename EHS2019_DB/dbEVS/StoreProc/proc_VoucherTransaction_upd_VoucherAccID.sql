IF EXISTS (SELECT * FROM dbo.sysobjects WHERE id = OBJECT_ID(N'[dbo].[proc_VoucherTransaction_upd_VoucherAccID]') AND OBJECTPROPERTY(id, N'IsProcedure') = 1)
	DROP PROCEDURE [dbo].[proc_VoucherTransaction_upd_VoucherAccID]
GO
...
-- =============================================
CREATE PROCEDURE [dbo].[proc_VoucherTransaction_upd_VoucherAccID]
...
GRANT EXECUTE ON [dbo].[proc_VoucherTransaction_upd_VoucherAccID] TO HCVU
GO
