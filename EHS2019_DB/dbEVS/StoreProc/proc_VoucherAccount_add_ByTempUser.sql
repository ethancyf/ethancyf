IF EXISTS (SELECT * FROM dbo.sysobjects WHERE id = OBJECT_ID(N'[dbo].[proc_VoucherAccount_add_ByTempUser]') AND OBJECTPROPERTY(id, N'IsProcedure') = 1)
	DROP PROCEDURE [dbo].[proc_VoucherAccount_add_ByTempUser]
GO
...
-- =============================================
CREATE PROCEDURE [dbo].[proc_VoucherAccount_add_ByTempUser]
...
GRANT EXECUTE ON [dbo].[proc_VoucherAccount_add_ByTempUser] TO HCVU
GO
