IF EXISTS (SELECT * FROM dbo.sysobjects WHERE id = OBJECT_ID(N'[dbo].[proc_TempVoucherAccountBackOfficePendingImmD_get]') AND OBJECTPROPERTY(id, N'IsProcedure') = 1)
	DROP PROCEDURE [dbo].[proc_TempVoucherAccountBackOfficePendingImmD_get]
GO
...
-- Modified date:	7 Apr 2010
-- Description:		Retrieve temp account based on the
--					TempVoucherAccManualSubLog & TempVoucherAccManualMatchLog
-- =============================================
-- =============================================
-- Author:		Kathy LEE
-- Create date: 14 Sep 2009
-- Description:	Retrieve TempVoucherAccount which 				
--				pending Immd Result
-- =============================================

--exec proc_TempVoucherAccountBackOfficePendingImmD_get null,null,null,'T',1,1,1


CREATE PROCEDURE [dbo].[proc_TempVoucherAccountBackOfficePendingImmD_get]
...
update #tempAccount
set sub_cnt = tmp.cnt
from #tempAccount t, (select s.voucher_acc_id, count(s.voucher_acc_id) as cnt
from #tempAccount t, TempVoucherAccManualSubLog s
...
from #tempAccount t, (select m.voucher_acc_id, count(m.voucher_acc_id) as cnt
from #tempAccount t, TempVoucherAccManualMatchLog m
...
GRANT EXECUTE ON [dbo].[proc_TempVoucherAccountBackOfficePendingImmD_get] TO HCVU
GO
