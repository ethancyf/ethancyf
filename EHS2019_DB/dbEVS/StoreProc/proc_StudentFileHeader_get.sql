IF EXISTS (SELECT * FROM dbo.sysobjects WHERE id = OBJECT_ID(N'[dbo].[proc_StudentFileHeader_get]') AND OBJECTPROPERTY(id, N'IsProcedure') = 1)
	DROP PROCEDURE [dbo].[proc_StudentFileHeader_get]
GO
...
-- Description:		Get StudentFileHeader
-- =============================================    

CREATE PROCEDURE [dbo].[proc_StudentFileHeader_get]
...
GRANT EXECUTE ON [dbo].[proc_StudentFileHeader_get] TO HCSP
GO

GRANT EXECUTE ON [dbo].[proc_StudentFileHeader_get] TO HCVU
GO
