IF EXISTS (SELECT * FROM dbo.sysobjects WHERE id = OBJECT_ID(N'[dbo].[proc_VoucherTransactionVoid_get_byECAgeECDOR_IVRS]') AND OBJECTPROPERTY(id, N'IsProcedure') = 1)
	DROP PROCEDURE [dbo].[proc_VoucherTransactionVoid_get_byECAgeECDOR_IVRS]
GO
...
-- Description: Retrieve Voidable Transaction By EC Case  & IdentityNum for IVRS 
-- =============================================  
-- =============================================  
-- Modification History  
-- Modified by:  
...
CREATE PROCEDURE [dbo].[proc_VoucherTransactionVoid_get_byECAgeECDOR_IVRS]   
	@Doc_Code char(20),
	@identity varchar(20),  
	@EC_Age int,  
	@DOR datetime,  
...
GRANT EXECUTE ON [dbo].[proc_VoucherTransactionVoid_get_byECAgeECDOR_IVRS] TO HCSP
GO
