IF EXISTS (SELECT * FROM dbo.sysobjects WHERE id = OBJECT_ID(N'[dbo].[proc_PracticeSchemeInfo_get_bySPID]') AND OBJECTPROPERTY(id, N'IsProcedure') = 1)
	DROP PROCEDURE [dbo].[proc_PracticeSchemeInfo_get_bySPID]
GO
...
-- Modification History
-- Modified by:		Lawrence TSANG
-- Modified date:	1 November 2010
-- Description:		While finding the scheme sequence of the scheme, use GETDATE() rather than
--					the Effective_Dtm of the practice scheme
-- =============================================
-- =============================================
-- Modification History
...
-- Description:		Get the practice scheme information in permanemnt
-- =============================================
-- =============================================
-- Modification History
-- Modified by:		Kathy LEE
...
-- Description:	
-- =============================================
CREATE Procedure [dbo].[proc_PracticeSchemeInfo_get_bySPID]
	@sp_id char(15)
as
BEGIN
...
GRANT EXECUTE ON [dbo].[proc_PracticeSchemeInfo_get_bySPID] TO HCSP
GO

GRANT EXECUTE ON [dbo].[proc_PracticeSchemeInfo_get_bySPID] TO HCVU
GO
