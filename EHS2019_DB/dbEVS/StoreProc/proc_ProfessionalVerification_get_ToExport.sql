IF EXISTS (SELECT * FROM dbo.sysobjects WHERE id = OBJECT_ID(N'[dbo].[proc_ProfessionalVerification_get_ToExport]') AND OBJECTPROPERTY(id, N'IsProcedure') = 1)
	DROP PROCEDURE [dbo].[proc_ProfessionalVerification_get_ToExport]
GO
...
-- Description:	
-- =============================================
CREATE PROCEDURE [dbo].[proc_ProfessionalVerification_get_ToExport]
AS
BEGIN
	SET NOCOUNT ON;
-- =============================================
...
GRANT EXECUTE ON [dbo].[proc_ProfessionalVerification_get_ToExport] TO HCVU
GO
