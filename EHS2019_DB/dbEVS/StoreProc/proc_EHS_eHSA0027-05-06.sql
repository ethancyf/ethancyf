IF EXISTS (SELECT * FROM dbo.sysobjects WHERE id = OBJECT_ID(N'[dbo].[proc_EHS_eHSA0027-05-06]') AND OBJECTPROPERTY(id, N'IsProcedure') = 1)
	DROP PROCEDURE [dbo].[proc_EHS_eHSA0027-05-06]
GO
...
CREATE PROCEDURE [dbo].[proc_EHS_eHSA0027-05-06]
	@Year	int
AS BEGIN
...
-- ---------------------------------------------
	...
	(0, 'eHSA0027-05: Monthly statistics of transactions claimed in ' +@strYear+', broken down by 18 districts')
...
-- ---------------------------------------------
	...
	(0, 'eHSA0027-06: Monthly statistics of vouchers claimed in '+@strYear+', broken down by 18 districts')
...
GRANT EXECUTE ON [dbo].[proc_EHS_eHSA0027-05-06] TO HCVU
GO
