IF EXISTS (SELECT * FROM dbo.sysobjects WHERE id = OBJECT_ID(N'[dbo].[proc_EHS_eHSD0025_CVSSPCV13_Stat_Write]') AND OBJECTPROPERTY(id, N'IsProcedure') = 1)
	DROP PROCEDURE [dbo].[proc_EHS_eHSD0025_CVSSPCV13_Stat_Write]
GO
...
-- CR No.:			CRE15-006
-- Description:		Prepare data for eHSD0025 CVSSPCV13 Claim Report
-- =============================================  
/*  
CREATE PROCEDURE [dbo].[proc_EHS_eHSD0025_CVSSPCV13_Stat_Write]   
...
GRANT EXECUTE ON [dbo].[proc_EHS_eHSD0025_CVSSPCV13_Stat_Write] TO HCVU
GO
*/
