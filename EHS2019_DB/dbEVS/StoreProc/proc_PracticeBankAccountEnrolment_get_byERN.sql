IF EXISTS (SELECT * FROM dbo.sysobjects WHERE id = OBJECT_ID(N'[dbo].[proc_PracticeBankAccountEnrolment_get_byERN]') AND OBJECTPROPERTY(id, N'IsProcedure') = 1)
	DROP PROCEDURE [dbo].[proc_PracticeBankAccountEnrolment_get_byERN]
GO
...
-- =============================================
-- Author:		Kathy LEE
-- Create date: 28 Apr 2008
-- Description:	Retrieve the Bank Account with 
--				Practice Information by enrolment
--				reference number
-- =============================================
...
-- Modified date: 06 April 2009
-- Description:	1. Two practice information will be also retrieved
--				2. Remove 'Practice_type' in 'PracticeEnrolment' table and
--				   Remove 'BR_Code' in 'BankAccountEnrolment' table
-- =============================================

CREATE PROCEDURE [dbo].[proc_PracticeBankAccountEnrolment_get_byERN]
...
GRANT EXECUTE ON [dbo].[proc_PracticeBankAccountEnrolment_get_byERN] TO HCPUBLIC
GO

GRANT EXECUTE ON [dbo].[proc_PracticeBankAccountEnrolment_get_byERN] TO HCVU
GO
