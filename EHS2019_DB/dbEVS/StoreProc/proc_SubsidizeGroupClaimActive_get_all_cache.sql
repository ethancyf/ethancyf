IF EXISTS (SELECT * FROM dbo.sysobjects WHERE id = OBJECT_ID(N'[dbo].[proc_SubsidizeGroupClaimActive_get_all_cache]') AND OBJECTPROPERTY(id, N'IsProcedure') = 1)
	DROP PROCEDURE [dbo].[proc_SubsidizeGroupClaimActive_get_all_cache]
GO
...
-- Modification History
-- Modified by:		Lawrence TSANG
-- Modified date:	11 September 2009
...
-- Modified by:		Lawrence TSANG
-- Modified date:	11 September 2009
-- Description:		Grant execute to HCVU
-- =============================================
-- =============================================
-- Modification History
-- Modified by:	  Paul Yip	
-- Modified date: 07 Aug 2009
-- Description:	  Add "Subsidize_Item_Code"
-- =============================================
-- =============================================
-- Author:		Pak Ho LEE
-- Create date: 05 Aug 2009
-- Description:	Retrieve the active SubsidizeGroupClaim information
--				(Join with Subsidize & SubsidizeItem)
--				Filter will be done on middle tier
-- =============================================
CREATE PROCEDURE [dbo].[proc_SubsidizeGroupClaimActive_get_all_cache] 
AS
BEGIN
...
GRANT EXECUTE ON [dbo].[proc_SubsidizeGroupClaimActive_get_all_cache] TO HCPUBLIC
GO

GRANT EXECUTE ON [dbo].[proc_SubsidizeGroupClaimActive_get_all_cache] TO HCSP
GO

GRANT EXECUTE ON [dbo].[proc_SubsidizeGroupClaimActive_get_all_cache] TO HCVU
GO

GRANT EXECUTE ON [dbo].[proc_SubsidizeGroupClaimActive_get_all_cache] TO WSEXT
Go
