IF EXISTS (SELECT * FROM dbo.sysobjects WHERE id = OBJECT_ID(N'[dbo].[proc_EHS_eHSA0018-07]') AND OBJECTPROPERTY(id, N'IsProcedure') = 1)
	DROP PROCEDURE [dbo].[proc_EHS_eHSA0018-07]
GO
...
CREATE PROCEDURE [dbo].[proc_EHS_eHSA0018-07]
	@Year	int
AS BEGIN
...
-- ---------------------------------------------
	...
	(0, 'eHSA0018-07: Monthly statistics of transactions and vouchers claimed in 2010, broken down by professions and reasons of visit')
...
GRANT EXECUTE ON [dbo].[proc_EHS_eHSA0018-07] TO HCVU
GO
